...
* Following development environment setups are used to build aTalk.apk<br/>
  a. Android Studio Quail 3 | 2026.1.3 Patch 1<br/>
  b. distributionUrl=https://services.gradle.org/distributions/gradle-9.7.1-bin.zip
  c. classpath 'com.android.tools.build:gradle:9.3.2'
