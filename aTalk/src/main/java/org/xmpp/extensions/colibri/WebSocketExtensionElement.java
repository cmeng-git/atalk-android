 ...
 */
public class WebSocketExtensionElement extends AbstractExtensionElement
{
    /**
    ...
    /**
     * Creates a new {@link WebSocketExtensionElement}
     */
    public WebSocketExtensionElement()
    {
     ...
     * Creates a new {@link WebSocketExtensionElement}
     */
    public WebSocketExtensionElement(String url)
    {
        super(ELEMENT, NAMESPACE);
        setUrl(url);
    }
