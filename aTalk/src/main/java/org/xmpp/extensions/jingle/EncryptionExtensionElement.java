 ...
 */
public class EncryptionExtensionElement extends AbstractExtensionElement
{
    /**
     ...
     */
    private List<CryptoExtensionElement> cryptoList = new ArrayList<CryptoExtensionElement>();
     ...
     */
    public void addCrypto(CryptoExtensionElement crypto)
    {
     ...
     * with this encryption element so far.
     */
    public List<CryptoExtensionElement> getCryptoList()
    {
        return cryptoList;
    }
    ...
    public void addChildExtension(ExtensionElement childExtension)
    {
        ...
        if (childExtension instanceof CryptoExtensionElement) {
            this.addCrypto(((CryptoExtensionElement) childExtension));
        }
    }
}
