 ...
 */
public class CandidateExtensionElement extends AbstractExtensionElement implements Comparable<CandidateExtensionElement>
{
    /**
    ...
    /**
     * Creates a new {@link CandidateExtensionElement} with the specified <tt>elementName</tt> so
     * that this class would be usable as a <tt>RemoteCandidateExtensionElement</tt> parent.
     *
     * @param elementName the element name that this instance should be using.
     */
    protected CandidateExtensionElement(String elementName)
    {
    ...
    /**
     * Returns a Candidate Type as defined in ICE-CORE. The allowable values are "host" for host
     * candidates, "prflx" for peer reflexive candidates, "relay" for relayed candidates, and
     * "srflx" for server reflexive candidates. All allowable values are enumerated in the
     * {@link CandidateType} enum.
     *
    ...
    /**
     * Compares this instance with another CandidateExtensionElement by preference of type: host <
     * local < prflx < srflx < stun < relay.
     *
     * @return 0 if the type are equal. -1 if this instance type is preferred. Otherwise 1.
     */
    public int compareTo(CandidateExtensionElement candidatePacketExtension)
    {
    ...
    /**
     * Gets the TCP type for this <tt>CandidateExtensionElement</tt>.
     */
    ...
    /**
     * Sets the TCP type for this <tt>CandidateExtensionElement</tt>.
     *
     * @param tcpType
     */
