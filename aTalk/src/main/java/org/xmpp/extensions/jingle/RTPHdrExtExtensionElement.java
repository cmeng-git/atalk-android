 ...
 */
public class RTPHdrExtExtensionElement extends AbstractExtensionElement
{
    /**
     * The namespace.
     */
     ...
     * @return the copy.
     */
    public static RTPHdrExtExtensionElement clone(RTPHdrExtExtensionElement source)
    {
        RTPHdrExtExtensionElement destination = AbstractExtensionElement.clone(source);
    ...
    public RTPHdrExtExtensionElement(RTPHdrExtExtensionElement ext)
    {
        this();
    ...
    {
        ParameterExtensionElement paramExt = new ParameterExtensionElement();
    ...
    public String getAttributes()
    {
        for (ExtensionElement ext : getChildExtensions()) {
            if (ext instanceof ParameterExtensionElement) {
                ParameterExtensionElement p = (ParameterExtensionElement) ext;
