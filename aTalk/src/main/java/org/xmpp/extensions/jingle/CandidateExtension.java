 ...
 */
public class CandidateExtension extends AbstractExtensionElement implements Comparable<CandidateExtension>
{
    /**
    ...
    /**
     * Creates a new {@link CandidateExtension} with the specified <tt>elementName</tt> so
     ...
     */
    protected CandidateExtension(String elementName)
    {
     ...
     */
    public int compareTo(CandidateExtension candidatePacketExtension)
    {
