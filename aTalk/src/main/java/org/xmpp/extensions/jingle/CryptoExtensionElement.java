...
public class CryptoExtensionElement extends AbstractExtensionElement
{
    ...
    /**
     * Creates a new {@link CryptoExtensionElement} instance with the proper element name and namespace.
     */
     ...
     */
    public CryptoExtensionElement(int tag, String cryptoSuite, String keyParams, String sessionParams)
    {
        this();
