 ...
 */
public class PayloadTypeExtensionElement extends AbstractExtensionElement
{
    /**
    ...
    /**
     * Creates a deep copy of a {@link PayloadTypeExtensionElement}.
     *
     * @param source the {@link PayloadTypeExtensionElement} to copy.
     * @return the copy.
     */
    public static PayloadTypeExtensionElement clone(PayloadTypeExtensionElement source)
    {
        PayloadTypeExtensionElement destination = AbstractExtensionElement.clone(source);
        for (RtcpFbExtensionElement rtcpFb : source.getRtcpFeedbackTypeList()) {
            destination.addRtcpFeedbackType(RtcpFbExtensionElement.clone(rtcpFb));
        }

        for (ParameterExtensionElement parameter : source.getParameters()) {
            destination.addParameter(ParameterExtensionElement.clone(parameter));
        }
        return destination;
    }

    /**
     * Creates a new {@link PayloadTypeExtensionElement} instance.
     */
    public PayloadTypeExtensionElement()
    {
     ...
     */
    public void addRtcpFeedbackType(RtcpFbExtensionElement rtcpFbPacketExtension)
    {
     ...
     */
    public List<RtcpFbExtensionElement> getRtcpFeedbackTypeList()
    {
        return getChildExtensionsOfType(RtcpFbExtensionElement.class);
    }
}
