 ...
 * @author Boris Grozev
 */
public class CallIdExtensionElement extends AbstractExtensionElement
{
    /**
     * The namespace for the XML element.
     */
    public static final String NAMESPACE = ConferenceDescriptionExtensionElement.NAMESPACE;
     ...
     * @param callid
     */
    public CallIdExtensionElement(String callid)
    {
        this();
        setText(callid);
    }
