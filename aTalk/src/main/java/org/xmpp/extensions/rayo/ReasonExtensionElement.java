 ...
 * @author Pawel Domas
 */
public class ReasonExtensionElement extends AbstractExtensionElement
{
    /**
    ...
    /**
     * Creates an {@link ReasonExtensionElement} instance for the specified <tt>namespace</tt> and <tt>elementName</tt>.
     *
     * @param elementName the name of the element
     */
    public ReasonExtensionElement(String elementName)
    {
