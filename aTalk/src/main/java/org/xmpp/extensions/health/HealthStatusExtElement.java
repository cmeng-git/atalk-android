 ...
 */
public class HealthStatusExtElement extends AbstractExtensionElement
{
    /**
    ...
    static public void registerExtensionProvider()
    {
        ProviderManager.addExtensionProvider(
                ELEMENT_NAME,
                NAMESPACE,
                new DefaultExtensionElementProvider<>(HealthStatusExtElement.class)
        );
    }
