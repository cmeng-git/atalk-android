 ...
 */
public class JsonMessageExtensionElement extends AbstractExtensionElement
{
    /**
    ...
    /**
     * Creates a {@link JsonMessageExtensionElement} instance.
     */
    public JsonMessageExtensionElement()
    {
        super(ELEMENT_NAME, NAMESPACE);
    }

    /**
     * Initializes a {@link JsonMessageExtensionElement} instance with a given
     * string value for its json content.
     *
     * @param json the string value of the json content.
     */
    public JsonMessageExtensionElement(String json)
    {
        super(ELEMENT_NAME, NAMESPACE);
        setText(json);
    }
