 ...
 */
public class ComponentVersionsExtensionElement extends AbstractExtensionElement
{
    /**
     * The XML element name of {@link ComponentVersionsExtensionElement}.
     */
    ...
    /**
     * The XML element namespace of {@link ComponentVersionsExtensionElement}.
     */
     ...
     */
    public ComponentVersionsExtensionElement()
    {
    ...
    /**
     * Component child element of {@link ComponentVersionsExtensionElement}. The name of the component is
    ...
    public class Component extends AbstractExtensionElement
    {
        ...
        public Component()
        {
            super(COMPONENT_ELEMENT_NAME, NAMESPACE);
        }
