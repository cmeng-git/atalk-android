 ...
 */
public class MediaPresenceExtension extends AbstractExtensionElement
{
    /**
    ...
    {
        // <media>
        ProviderManager.addExtensionProvider(MediaPresenceExtension.ELEMENT, MediaPresenceExtension.NAMESPACE,
                new DefaultExtensionElementProvider<>(MediaPresenceExtension.class));

        // <source>
        ProviderManager.addExtensionProvider(MediaPresenceExtension.Source.ELEMENT, MediaPresenceExtension.Source.NAMESPACE,
    ...
    public static class Source extends AbstractExtensionElement
    {
         ...
         */
        public final static String ELEMENT = "source";
