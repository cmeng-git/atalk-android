 ...
 */
public class MediaPresenceExtensionElement extends AbstractExtensionElement
{
    /**
     ...
     */
    public MediaPresenceExtensionElement()
    {
    ...
    {
        // <media>
        ProviderManager.addExtensionProvider(MediaPresenceExtensionElement.ELEMENT_NAME, MediaPresenceExtensionElement.NAMESPACE,
                new DefaultExtensionElementProvider<>(MediaPresenceExtensionElement.class));

        // <source>
        ProviderManager.addExtensionProvider(MediaPresenceExtensionElement.Source.ELEMENT_NAME, MediaPresenceExtensionElement.Source.NAMESPACE,
                new DefaultExtensionElementProvider<>(Source.class));
    }
     ...
     */
    public static class Source extends AbstractExtensionElement
    {
        /**
