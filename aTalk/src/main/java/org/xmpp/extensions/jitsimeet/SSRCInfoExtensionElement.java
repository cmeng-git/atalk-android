 ...
 * JID of the user to whom it belongs. This extension is inserted as a child of {@link SourceExtensionElement}
 * in 'session-initiate', 'source-add' and 'source-remove' Jingle IQs sent by the focus(Jicofo).
 *
 * @author Pawel Domas
 * @author Eng Chong Meng
 */
public class SSRCInfoExtensionElement extends AbstractExtensionElement
{
    /**
    ...
    /**
     * Attribute stores owner JID of parent {@link SourceExtensionElement}.
     */
     ...
     */
    public SSRCInfoExtensionElement()
    {
