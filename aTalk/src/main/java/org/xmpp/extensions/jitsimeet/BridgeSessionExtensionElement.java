 ...
 */
public class BridgeSessionExtensionElement extends AbstractExtensionElement
{
    /**
     ...
     */
    public BridgeSessionExtensionElement()
    {
        super(ELEMENT_NAME, NAMESPACE);
    }

    public BridgeSessionExtensionElement(String id, String region)
    {
        this();
        setId(id);
        setRegion(region);
