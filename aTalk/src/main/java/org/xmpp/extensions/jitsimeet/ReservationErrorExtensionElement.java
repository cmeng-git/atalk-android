 ...
 */
public class ReservationErrorExtensionElement extends AbstractExtensionElement
{
    /**
     ...
     */
    public ReservationErrorExtensionElement()
    {
     ...
     * Creates new instance of <tt>ReservationErrorExtensionElement</tt>.
     */
    public ReservationErrorExtensionElement(int code)
    {
        super(ELEMENT_NAME, NAMESPACE);
        setErrorCode(code);
    }
