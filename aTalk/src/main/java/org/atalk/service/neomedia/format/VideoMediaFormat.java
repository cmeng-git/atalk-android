 ...
 * <tt>VideoMediaFormat</tt> interface gives access to some of their properties such as encoding and
 * clock rate.
 *
 * @author Emil Ivov
 */
public interface VideoMediaFormat extends MediaFormat
{
	 ...
	 *
	 * @return a <tt>java.awt.Dimension</tt> instance indicating the image size (in pixels) of this
