...
/**
 * The <tt>MediaStreamTarget</tt> contains a pair of host:port couples indicating data (RTP) and
 * control (RTCP) locations.
 *
 * @author Emil Ivov
...
public class MediaStreamTarget
{
	 ...
	 *
	 * @param rtpTarget
	 *        the <tt>InetSocketAddress</tt> that the new instance is to indicate as a data/RTP
	 *        address.
	 * @param rtcpTarget
	 *        the <tt>InetSocketAddress</tt> that the new instance is to indicate as a control/RTCP
	 *        address.
	 */
	 ...
	 *
	 * @param rtpAddr
	 *        the <tt>InetAddress</tt> that the new instance is to indicate as the IP address of a
	 *        data/RTP address
	 * @param rtpPort
	 *        the port that the new instance is to indicate as the port of a data/RTP address
	 * @param rtcpAddr
	 *        the <tt>InetAddress</tt> that the new instance is to indicate as the IP address of a
	 *        control/RTCP address
	 * @param rtcpPort
	 *        the port that the new instance is to indicate as the port of a control/RTCP address
	 */
	 ...
	 *
	 * @param obj
	 *        the <tt>Object</tt> to be compared to this <tt>MediaStreamTarget</tt>
	...
	/**
	 * Returns a hash code for this <tt>MediaStreamTarget</tt> instance which is suitable for use in
	 * hash tables.
	 *
	 * @return a hash code for this <tt>MediaStreamTarget</tt> instance which is suitable for use in
	 *         hash tables
	 */
	@Override
	public int hashCode()
