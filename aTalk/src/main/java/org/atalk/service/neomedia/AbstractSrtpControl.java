...
public abstract class AbstractSrtpControl<T extends SrtpControl.TransformEngine> implements SrtpControl
{
	...
	/**
	 * The <tt>SrtpListener</tt> listening to security events (to be) fired by this
	 * <tt>SrtpControl</tt> instance.
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * The implementation of <tt>AbstractSrtpControl</tt> cleans up its associated
	 * <tt>TransformEngine</tt> (if any).
	 */
	@Override
