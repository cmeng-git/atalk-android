...
public interface SrtpControl
{
	...
	/**
	 * Indicates if the key exchange method is dependent on secure transport of the signaling
	 * channel.
	 *
	 * @return <tt>true</tt> when secure signaling is required to make the encryption secure;
	 ...
	 *
	 * @param connector
	 *        the <tt>RTPConnector</tt> which is to use or uses this SRTP engine
	 */
