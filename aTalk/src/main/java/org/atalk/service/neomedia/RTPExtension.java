...
public class RTPExtension
{
	...
	/**
	 * Creates an <tt>RTPExtension</tt> instance for the specified <tt>extensionURI</tt> using a
	 * default <tt>SENDRECV</tt> direction and no extension attributes.
	 *
	 * @param extensionURI
	 *        the <tt>URI</tt> (possibly a URN) of the RTP extension that we'd like to create.
	 */
	...
	/**
	 * Creates an <tt>RTPExtension</tt> instance for the specified <tt>extensionURI</tt> and
	 * <tt>direction</tt>.
	 *
	 * @param extensionURI
	 *        the <tt>URI</tt> (possibly a URN) of the RTP extension that we'd like to create.
	 * @param direction
	 *        a <tt>MediaDirection</tt> instance indication how this extension will be transmitted.
	 */
	...
	/**
	 * Creates an <tt>RTPExtension</tt> instance for the specified <tt>extensionURI</tt> using a
	 * default <tt>SENDRECV</tt> direction and <tt>extensionAttributes</tt>.
	 *
	 * @param extensionURI
	 *        the <tt>URI</tt> (possibly a URN) of the RTP extension that we'd like to create.
	...
	/**
	 * Creates an <tt>RTPExtension</tt> instance for the specified <tt>extensionURI</tt> and
	 * <tt>direction</tt> and sets the specified <tt>extensionAttributes</tt>.
	 *
	 * @param extensionURI
	 *        the <tt>URI</tt> (possibly a URN) of the RTP extension that we'd like to create.
	 * @param direction
	...
	/**
	 * Returns the direction that the corresponding <tt>MediaDevice</tt> supports for this
	 * extension. By default RTP extension headers inherit the direction of a stream. When
	 * explicitly specified <tt>SENDONLY</tt> direction indicates an ability to attach the extension
	 * in outgoing RTP packets; a <tt>RECVONLY</tt> direction indicates a desire to receive the
	 * extension in incoming packets; a <tt>SENDRECV</tt> direction indicates both. An
	 * <tt>INACTIVE</tt> direction indicates neither, but later re-negotiation may make an extension
	 * active.
	 *
	 * @return the direction that the corresponding <tt>MediaDevice</tt> supports for this
	 *         extension.
	 */
	...
	/**
	 * Returns the <tt>URI</tt> that identifies the format and meaning of this extension.
	 *
	 * @return the <tt>URI</tt> (possibly a URN) that identifies the format and meaning of this
	 *         extension.
	 */
	public URI getURI()
	{
	...
	/**
	 * Returns the extension attributes associated with this <tt>RTPExtension</tt> or <tt>null</tt>
	 * if this extension does not have any.
	 *
	 * @return A <tt>String</tt> containing the extension attributes associated with this
	 *         <tt>RTPExtension</tt> or <tt>null</tt> if this extension does not have any.
	 */
	...
	/**
	 * Returns a <tt>String</tt> representation of this <tt>RTPExtension</tt>'s <tt>URI</tt>.
	 *
	 * @return a <tt>String</tt> representation of this <tt>RTPExtension</tt>'s <tt>URI</tt>.
	 */
	@Override
	...
	/**
	 * Returns <tt>true</tt> if and only if <tt>o</tt> is an instance of <tt>RTPExtension</tt> and
	 * <tt>o</tt>'s <tt>URI</tt> is equal to this extension's <tt>URI</tt>. The method returns
	 * <tt>false</tt> otherwise.
	 *
	 * @param o
	 *        the <tt>Object</tt> that we'd like to compare to this <tt>RTPExtension</tt>.
	 *
	 * @return <tt>true</tt> when <tt>o</tt>'s <tt>URI</tt> is equal to this extension's
	 *         <tt>URI</tt> and <tt>false</tt> otherwise.
	 */
	@Override
	 ...
	 * <tt>URI</tt> that this extension is encapsulating.
	 *
