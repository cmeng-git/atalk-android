...
public class RecorderEvent
{
	...
	/**
	 * A textual description of the participant associated with this <tt>RecorderEvent</tt>. (human
	 * readable)
	 */
	 ...
	 * 
	 * @param json
	 *        a JSON object, containing fields with which to initialize the fields of this
	 *        <tt>RecorderEvent</tt>.
	 */
	public RecorderEvent(JSONObject json)
	{
		...
		o = json.get("instant");
		if (o != null && (o instanceof Long || o instanceof Integer))
			instant = (Long) o;
