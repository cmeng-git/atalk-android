 ...
 * read/write capabilities of different entities in this <tt>MediaService</tt> such as for example
 * devices.
 *
 * @author Emil Ivov
 */
public enum MediaDirection {
	 ...
	 *
	 * @param direction
	 *        that direction constraint that we'd like to apply to this <tt>MediaDirection</tt>
	 *
	 ...
	 *
	 * @param direction
	 *        the direction that we'd like to enable (i.e. add) to this <tt>MediaDirection</tt>
	 *
	 ...
	 *        the remote party <tt>MediaDirection</tt> constraint that we'd have to consider when
	 ...
	 * <tt>RECVONLY</tt> for "recvonly", <tt>SENDRECV</tt> for "sendrecv", and <tt>INACTIVE</tt> for
	 * "inactive".
	 *
