 ...
 * {@link #addActiveSpeakerChangedListener(ActiveSpeakerChangedListener)} are notified.
 * </p>
 *
 * @author Boris Grozev
...
public interface ActiveSpeakerDetector
{
	 ...
	 *
	 * @param listener
	 *        the listener to register with this instance for notifications about changes of the
	 *        active speaker
	 */
	 ...
	 * @param level
	 *        the latest/current audio level of the stream/speaker with the specified <tt>ssrc</tt>
	 */
	 ...
	 *
	 * @param listener
	 *        the listener to unregister with this instance for notifications about changes of the
	 *        active speaker
	 */
