...
public interface MediaStream
{
     ...
     *
     * @param rtpPayloadType the RTP payload type to be associated in this <tt>MediaStream</tt>
     * with the specified <tt>MediaFormat</tt>
     ...
     *
     * @param listener the listener that we'd like to register for <tt>PropertyChangeEvent</tt>s
     */
     ...
     *
     * @param extensionID the ID that is mapped to <tt>rtpExtension</tt> for the lifetime of this <tt>MediaStream</tt>.
     * @param rtpExtension the <tt>RTPExtension</tt> that we are mapping to <tt>extensionID</tt>.
     */
    ...
    /**
     * Returns the <tt>MediaFormat</tt> that is associated to the payload type passed in as a parameter.
     *
     * @param payloadType the payload type of the <tt>MediaFormat</tt> to get.
     * @return the <tt>MediaFormat</tt> that is associated to the payload type passed in as a parameter.
     */
    ...
    /**
     * Returns a <tt>MediaStreamStats</tt> object used to get statistics about this <tt>MediaStream</tt>.
     *
     * @return the <tt>MediaStreamStats</tt> object used to get statistics about this <tt>MediaStream</tt>.
     */
     ...
     *
     * @param propertyName the name of the opaque property of this <tt>MediaStream</tt>
     * the value of which is to be returned
     * @return the value of the opaque property of this <tt>MediaStream</tt> specified by <tt>propertyName</tt>
     */
     ...
     *
     * @return an <tt>InetSocketAddress</tt> instance indicating the address that we are sending RTCP packets to.
     */
     ...
     *
     * @return an <tt>InetSocketAddress</tt> instance indicating the address that we are sending RTP packets to.
     */
    ...
    /**
     * Sets the <tt>StreamConnector</tt> to be used by this <tt>MediaStream</tt> for sending and receiving media.
     *
     * @param connector the <tt>StreamConnector</tt> to be used by this <tt>MediaStream</tt> for sending and
     * receiving media
     */
     ...
     *
     * @param direction the <tt>MediaDirection</tt> in which this <tt>MediaStream</tt>
     ...
     *
     * @param mute <tt>true</tt> if we are to start transmitting "silence" and <tt>false</tt> if we are
     ...
     *
     * @param propertyName the name of the opaque property of this <tt>MediaStream</tt> the value of which is to
     * be set to the specified <tt>value</tt>
     * @param value the value of the opaque property of this <tt>MediaStream</tt> specified by
     ...
     *
     * @param rtpTranslator the <tt>RTPTranslator</tt> which is to forward RTP and RTCP traffic between this and
     * other <tt>MediaStream</tt>s
     */
    ...
    /**
     * Sets the <tt>SSRCFactory</tt> which is to generate new synchronization source (SSRC) identifiers.
     *
    ...
    /**
     * Sets the external (application-provided) <tt>TransformEngine</tt> of this <tt>MediaStream</tt>.
     *
