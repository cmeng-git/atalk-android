...
public abstract class AbstractActiveSpeakerDetector implements ActiveSpeakerDetector
{
	 ...
	 *
	 * @param ssrc
	 *        the synchronization source identifier/SSRC of the active speaker in the multipoint
	 *        conference
	 */
	 ...
	 *         changes. If no such listeners are registered with this instance, an empty array is
	 *         returned.
	 */
