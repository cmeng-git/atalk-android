...
public interface VideoMediaStream extends MediaStream
{
	 ...
	 *             {@link #getVisualComponent(long)} and {@link #getVisualComponents()} are to be
	 *             used instead.
	 */
	@Deprecated
	 ...
	 *
	 * @param ssrc
	 *        the SSRC of the <tt>ReceiveStream</tt> to get the associated rendering visual
	 *        <tt>Component</tt> of
	 ...
	 * have to no longer receive notifications when visual/video <tt>Component</tt>s are being added
	 * and removed.
	 *
	 * @param listener
