...
public interface MediaService
{
	 ...
	 *
	 * @param listener
	 *        the <tt>PropertyChangeListener</tt> to be notified about changes in the values of the
	 *        properties of this instance
	 */
	 ...
	 *
	 * @param device
	 *        the <tt>MediaDevice</tt> to be used by the new instance for capture and playback of media
	 ...
	 *
	 * @param connector
	 *        the <tt>StreamConnector</tt> the stream should use for sending and receiving media or
	 ...
	 * @param device
	 *        the device to be used for both capture and playback of media exchanged via the
	 ...
	 *        initialization time and a <tt>StreamConnector</tt> is to be specified later on
	 * @param mediaType
	 *        the <tt>MediaType</tt> of the media to be exchanged by the new instance via the
	 ...
	 *        specified <tt>StreamConnector</tt>
	 * @param srtpControl
	 *        a control which is already created, used to control the ZRTP operations.
	 *
	 * @return the newly created <tt>MediaStream</tt>.
	 */
	public MediaStream createMediaStream(StreamConnector connector, MediaDevice device,
	 ...
	 *        specified <tt>connector</tt>
	 * @param srtpControl
	 *        the <tt>SrtpControl</tt> to control the security of the media exchange
	 * @return a new <tt>MediaStream</tt> instance which is to exchange media of the specified
	 *         <tt>mediaType</tt> via the specified <tt>connector</tt>
	 */
	public MediaStream createMediaStream(StreamConnector connector, MediaType mediaType,
	 ...
	 * 
	 * @param translator
	 *        the <tt>RTPTranslator</tt> for which to create a <tt>Recorder</tt>
	 ...
	 *
	 * @param mediaType
	 *        a <tt>MediaType</tt> value indicating the kind of device that we are trying to obtain.
	 * @param useCase
	 *        <tt>MediaUseCase</tt> value indicating for the use-case of device that we are trying
	 *        to obtain.
	 *
	 ...
	 *
	 * @param mediaType
	 *        the media type (i.e. AUDIO or VIDEO) that we'd like to obtain the device list for.
	 * @param useCase
	 *        <tt>MediaUseCase</tt> value indicating for the use-case of device that we are trying
	 *        to obtain.
	 *
	 ...
	 *
	 * @param listener
	 *        the <tt>PropertyChangeListener</tt> to no longer be notified about changes in the
	 *        values of the properties of this instance
	 */
	 ...
	 * 
	 * @param filename
	 *        the filename into which the created <tt>RecorderEventHandler</tt> will save received
	 *        events.
	 * @return a <tt>RecorderEventHandler</tt> instance that saves received events in JSON format.
	 * @throws IOException
	 *         if a <tt>RecorderEventHandler</tt> could not be created for <tt>filename</tt>.
	 */
