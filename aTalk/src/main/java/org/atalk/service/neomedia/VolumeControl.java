...
public interface VolumeControl
{
	 ...
	 *
	 * @param listener
	 *        the <tt>VolumeChangeListener</tt> to be informed about changes in the volume level of
	 *        this instance
	 */
	 ...
	 *
	 * @param listener
	 *        the <tt>VolumeChangeListener</tt> to no longer be notified about changes in the volume
	 *        level of this instance
	 */
