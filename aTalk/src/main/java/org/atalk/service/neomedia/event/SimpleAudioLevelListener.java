...
/**
 * A very simple listener that delivers <tt>int</tt> values every time the audio level of an audio
 * source changes.
 *
 * @author Emil Ivov
 */
public interface SimpleAudioLevelListener
{
	 ...
	 * be distributed between <tt>MAX_LEVEL</tt> and {@link #MIN_LEVEL} in a way that would appear
	 * uniform to users.
	 * <p>
	 * <b>Note</b>: The value of <tt>127</tt> is specifically chosen as the value of
	 * <tt>MAX_LEVEL</tt> because (1) we transport the levels within RTP and it gives us a signed
	 * <tt>byte</tt> for it, and (2) the range of
	 ...
	 * should be distributed among {@link #MAX_LEVEL} and <tt>MIN_LEVEL</tt> in a way that would
	 * appear uniform to users.
	 * <p>
	 * <b>Note</b>: The value of <tt>0</tt> is specifically chosen as the value of
	 * <tt>MIN_LEVEL</tt> because (1) we transport the levels within RTP and it gives us a signed
	 * <tt>byte</tt> for it, and (2) the range of
	 * <code>[0, 127]</tt> is pretty good to directly express the sound pressure
	 * level decibels as heard by humans in Earth's atmosphere.
	 * </p>
