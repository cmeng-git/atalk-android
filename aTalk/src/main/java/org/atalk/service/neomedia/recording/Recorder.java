...
public interface Recorder
{
	 ...
	 * directory with media recorded by <tt>Recorder</tt> (e.g. the media being sent and received in
	 * a <tt>Call</tt>).
	 */
	 ...
	 * is to be recorded by <tt>Recorder</tt> (e.g. the media being sent and received in a
	 * <tt>Call</tt>).
	 */
	public static final String FORMAT = "neomedia.Recorder.FORMAT";

	/**
	 * Adds a new <tt>Listener</tt> to the list of listeners interested in notifications from this
	 * <tt>Recorder</tt>.
	 *
	 * @param listener
	 *        the new <tt>Listener</tt> to be added to the list of listeners interested in
	 *        notifications from this <tt>Recorder</tt>
	 */
	public void addListener(Listener listener);

	/**
	 * Gets a list of the formats in which this <tt>Recorder</tt> supports recording media.
	 *
	 * @return a <tt>List</tt> of the formats in which this <tt>Recorder</tt> supports recording
	 *         media
	 */
	public List<String> getSupportedFormats();

	/**
	 * Removes an existing <tt>Listener</tt> from the list of listeners interested in notifications
	 * from this <tt>Recorder</tt>.
	 *
	 * @param listener
	...
	/**
	 * Starts the recording of the media associated with this <tt>Recorder</tt> (e.g. the media
	 * being sent and received in a <tt>Call</tt>) into a file with a specific name.
	 *
	 * @param format
	 *        the format into which the media associated with this <tt>Recorder</tt> is to be
	 *        recorded into the specified file
	 * @param filename
	 *        the name of the file into which the media associated with this <tt>Recorder</tt> is to
	 *        be recorded
	 * @throws IOException
	...
	/**
	 * Stops the recording of the media associated with this <tt>Recorder</tt> (e.g. the media being
	 * sent and received in a <tt>Call</tt>) if it has been started and prepares this
	 * <tt>Recorder</tt> for garbage collection.
	 */
	public void stop();
	...
	{
		/**
		 * Notifies this <tt>Listener</tt> that a specific <tt>Recorder</tt> has stopped recording
		 * the media associated with it.
		 *
		 * @param recorder
		 *        the <tt>Recorder</tt> which has stopped recording its associated media
		 */
	...
	/**
	 * Sets the <tt>RecorderEventHandler</tt> which this <tt>Recorder</tt> should notify when events
