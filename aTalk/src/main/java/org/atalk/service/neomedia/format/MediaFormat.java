...
public interface MediaFormat
{
	 ...
	 * the stream (that's an error noted in the respective RFC and kept for the sake of
	 * compatibility.).
	 *
	 ...
	 * @return <tt>true</tt> if <tt>mediaFormat</tt> is equal to this format and <tt>false</tt>
	 *         otherwise.
	 */
	@Override
	...
	/**
	 * Determines whether the format parameters of this <tt>MediaFormat</tt> match a specific set of
	 * format parameters.
	 *
	 * @param fmtps
	 *        the set of format parameters to match to the format parameters of this
	 *        <tt>MediaFormat</tt>
	...
	/**
	 * Returns a <tt>Map</tt> containing advanced parameters specific to this particular
	 * <tt>MediaFormat</tt>. The parameters returned here are meant for use in SIP/SDP or XMPP
	 * session descriptions.
	 *
	 * @return a <tt>Map</tt> containing advanced parameters specific to this particular
	 *         <tt>MediaFormat</tt>
	 */
	 ...
	 *         <tt>mediaType</tt>, <tt>encoding</tt>, <tt>clockRate</tt> and <tt>channels</tt>;
