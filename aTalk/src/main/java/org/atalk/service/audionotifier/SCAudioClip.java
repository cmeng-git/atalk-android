...
public interface SCAudioClip
{
	 ...
	 * was invoked with a negative <tt>loopInterval</tt> and/or <tt>null</tt>
	 * <tt>loopCondition</tt>.
	 */
	public void play();
	 ...
	 *
	 * @param loopInterval
	 * 		the interval of time in milliseconds between consecutive plays of this audio. If
	 * 		negative, this audio is played once only and <tt>loopCondition</tt> is ignored.
	 * @param loopCondition
	 * 		a <tt>Callable</tt> which is called at the beginning of each iteration of looped
