...
/**
 * The AudioNotifierService is meant to be used to control all sounds in the application. An
 * audio could be created by calling the createAudio method. In order to stop all sounds in the
 * application one could call the setMute method. To check whether the sound is currently enabled
 * the isMute method could be used.
 *
