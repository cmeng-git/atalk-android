...
/**
 * The configuration services provides a centralized approach of storing persistent configuration
 * data.
 *
 * @author Emil Ivov
...
public interface ConfigurationService
{
	 ...
	 */
	public static final String PNAME_OMEMO_KEY_BLIND_TRUST = "omemo.KEY_BLIND_TRUST";
	 ...
	 * 		in case the changed has been refused by at least one propertyChange listener.
	 */
	 ...
	 *
	 * @param properties
	 * 		a <code>Map</code> of property names to their new values to be set
	 * @throws ConfigPropertyVetoException
	 * 		if a change in at least one of the properties has been refused by at least one of the
	 ...
	 * an empty <tt>List</tt>. Thus, if the <tt>suffix</tt> argument contains a dot, nothing will
	 * be found.
	 * </p>
	 *
	 * @param suffix
	 ...
	 * name fails or no value is associated in this <tt>ConfigurationService</tt> with the
	 ...
	 *
	 * @throws IOException
	 * 		in case reading the configuration fails
	 */
