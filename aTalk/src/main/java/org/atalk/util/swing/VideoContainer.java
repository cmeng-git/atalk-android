...
public class VideoContainer extends TransparentPanel {
     ...
     * unnecessary invocations to {@link #doLayout()}, {@link #repaint()} and {@link #validate()}.
     */
     ...
     * be invoked (as soon as {@link #inAddOrRemove} decreases from a positive number to zero).
     */
    ...
    /**
     * Adds the given component at the {@link VideoLayout#CENTER_REMOTE} position in the default video layout.
     *
