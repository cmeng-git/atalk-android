...
public class XMLUtils
{
            ...
            throws ParserConfigurationException
    {
        ...
        try {
            ...
            if (OSUtils.IS_ANDROID)
                Timber.w("Failed to set feature: %s", FEATURE_EXTERNAL_GENERAL_ENTITIES);
            else
                throw pce;
        }
        ...
        try {
            ...
            if (OSUtils.IS_ANDROID)
                Timber.w("Failed to set feature: %s", FEATURE_EXTERNAL_PARAMETER_ENTITIES);
            else
                throw pce;
        }
        ...
        try {
            ...
            if (OSUtils.IS_ANDROID)
                Timber.w("Failed to set feature: %s", FEATURE_DISSALLOW_DOCTYPE);
            else
                throw pce;
        }
    }
