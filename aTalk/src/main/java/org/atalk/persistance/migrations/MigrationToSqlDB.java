...
public class MigrationToSqlDB
{
     ...
     *
     * @param db the SQLiteDatabase dbRecords.db
     */
    public static void xmlToSqlDatabase(SQLiteDatabase db)
    {
        ...
        if (!dbFile.exists()) {
            Timber.i("Init metaContactList table for newly installed apk.");
         ...
         */
        SQLiteDatabase propertiesDB = SQLiteDatabase.openDatabase(DBPath, null, SQLiteDatabase.OPEN_READONLY);
