...
public class NotificationPopupHandler extends AbstractPopupMessageHandler implements ChatSessionManager.CurrentChatListener
{
	...
	/**
	 * Map of currently displayed <tt>AndroidPopup</tt>s. Value is removed when corresponding notification is clicked or discarded.
	 */
	 ...
	 *        the id of clicked notification.
	 */
	 ...
	 *
	 * @param notificationId
	 *        the id of notification to remove.
	 */
	 ...
	 * 
	 * @param popup
	 *        <tt>AndroidPopup</tt> on which timeout event has occurred.
	 */
