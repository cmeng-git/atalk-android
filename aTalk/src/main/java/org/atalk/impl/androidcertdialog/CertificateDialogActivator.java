...
public class CertificateDialogActivator extends SimpleServiceActivator<CertificateDialogServiceImpl>
{
	 ...
	 *
	 * @param requestId
	 * 		identifier of the request managed by <tt>CertificateDialogServiceImpl</tt>.
	 * @return <tt>VerifyCertDialog</tt> for given <tt>requestId</tt> or <tt>null</tt> if service
	 * has been shutdown.
	 */
