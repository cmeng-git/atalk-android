...
/**
 * Implementation of <tt>VerifyCertificateDialog</tt>. Serves as dialog data model for GUI
 * components.
 *
 * @author Pawel Domas
 */
class VerifyCertDialog implements VerifyCertificateDialogService.VerifyCertificateDialog
{
	 ...
	 *
	 * @param trusted
	 * 		<tt>true</tt> if subject certificate is trusted by the user.
	 */
	 ...
	 *
	 * @param alwaysTrust
	 * 		<tt>true</tt> if user decided to always trust subject certificate.
	 */
