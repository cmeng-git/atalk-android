...
public class CertInfoDialog extends OSGiDialogFragment
{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState)
	{
		...
		if (cert instanceof X509Certificate) {
			...
			if (algorithm.equals("RSA")) {
				...
				String keyStr = getString(R.string.service_gui_CERT_INFO_KEY_BYTES_PRINT, String.valueOf(key.getModulus().toByteArray().length - 1), key
			...
			// Signature
			String signatureStr = getString(R.string.service_gui_CERT_INFO_KEY_BYTES_PRINT, String.valueOf(x509.getSignature().length),
	 ...
	 * 
	 * @param table
	 *        the table to which new row wil be added.
	 * @param strResId
	 ...
	 * 
	 * @param table
	 *        the table to which new rows will be added.
	 * @param texts
	...
	/**
	 * Creates new instance of <tt>CertInfoDialog</tt> parametrized with given <tt>requestId</tt>.
	 * 
	 * @param requestId
	 *        identifier of dialog model managed by <tt>CertificateDialogServiceImpl</tt>
	 * @return new instance of <tt>CertInfoDialog</tt> parametrized with given <tt>requestId</tt>.
	 */
	...
	static public interface CertInfoDialogListener
	{
		 ...
		 * 
		 * @param continueAnyway
		 *        <tt>true</tt> if continue anyway button was pressed, <tt>false</tt> means that the dialog was
		 *        discarded or cancel button was pressed.
		 */
