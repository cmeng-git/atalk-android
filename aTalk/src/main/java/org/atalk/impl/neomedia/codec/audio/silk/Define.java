...
public class Define
{
	...
	{
		return (MAX_LPC_ORDER > DECISION_DELAY) ? MAX_LPC_ORDER : DECISION_DELAY;
	}
	...
	static final int TRANSITION_TIME_UP_MS = 5120; // 5120 = 64 * FRAME_LENGTH_MS * (
													// TRANSITION_INT_NUM - 1 ) =
													// 64*(20*4)
	static final int TRANSITION_TIME_DOWN_MS = 2560; // 2560 = 32 * FRAME_LENGTH_MS * (
														// TRANSITION_INT_NUM - 1 ) =
														// 32*(20*4)
