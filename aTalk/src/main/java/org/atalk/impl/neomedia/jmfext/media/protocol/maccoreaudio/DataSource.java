...
{
	/**
	 * The indicator which determines whether this <tt>DataSource</tt> will use audio quality
	 * improvement in accord with the preferences of the user.
	 */
	private final boolean audioQualityImprovement;

	/**
	 * The list of <tt>Format</tt>s in which this <tt>DataSource</tt> is capable of capturing audio
	 * data.
	 */
	...
	/**
	 * Initializes a new <tt>DataSource</tt> instance from a specific <tt>MediaLocator</tt> and
	 * which has a specific list of <tt>Format</tt> in which it is capable of capturing audio data
	 ...
	 *        the list of <tt>Format</tt>s in which the new instance is to be capable of capturing
	 *        audio data
	 * @param audioQualityImprovement
	 *        <tt>true</tt> if audio quality improvement is to be enabled in accord with the
	 *        preferences of the user or <tt>false</tt> to completely disable audio quality
	 *        improvement
	 */
	 ...
	 */
	@Override
	protected MacCoreaudioStream createStream(int streamIndex, FormatControl formatControl)
	{
		return new MacCoreaudioStream(this, formatControl, audioQualityImprovement);
	}
	...
	/**
	 * Gets the device index of the MacCoreaudio device identified by the <tt>MediaLocator</tt> of
	 * this <tt>DataSource</tt>.
	 *
	 * @return the device index of a MacCoreaudio device identified by the <tt>MediaLocator</tt> of
	 *         this <tt>DataSource</tt>
	 * @throws IllegalStateException
	 *         if there is no <tt>MediaLocator</tt> associated with this <tt>DataSource</tt>
	 */
	...
	/**
	 * Gets the device index of a MacCoreaudio device from a specific <tt>MediaLocator</tt>
	 * identifying it.
	 *
	 * @param locator
	 *        the <tt>MediaLocator</tt> identifying the device index of a MacCoreaudio device to get
	 * @return the device index of a MacCoreaudio device identified by <tt>locator</tt>
	 */
	 ...
	 * formats for a <tt>PullBufferStream</tt> at a specific zero-based index in the list of streams
	 * of this <tt>PullBufferDataSource</tt>.
	 *
	 * @param streamIndex
	 *        the zero-based index of the <tt>PullBufferStream</tt> for which the specified
	 ...
	 *         supported formats for the <tt>PullBufferStream</tt> at the specified
	 *         <tt>streamIndex</tt> in the list of streams of this <tt>PullBufferDataSource</tt>
