...
/**
 * Preprocessing of input speech. - 2nd order high pass filter with cut off frequency at 140 Hz.
 *
 * 2nd order high pass filter with cut off frequency at 140 Hz. Designed with SPPACK efi command -40
 * dB att, 0.25 ri.
 *
 * Algorithm:
 * 
...
class PreProc
{
	...
	/*
	 * File : PRE_PROC.C Used for the floating point version of both G.729 main body and G.729A
	 */
