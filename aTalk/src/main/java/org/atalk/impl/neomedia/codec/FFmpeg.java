...
public class FFmpeg
{
	...
	private static final int CODEC_ID_AMR_NB = 73728;
	...
	public static native int avpicture_fill(long picture, long ptr, int pix_fmt, int width,
		int height);

	public static native void avpacket_set_data(long avpkt, byte[] in, int inOff, int inLen);

	public static native void avframe_set_linesize(long frame, int linesize0, int linesize1,
		int linesize2);
	...
	/**
	 * Removes a reference to a buffer. If the specified <tt>AVFilterBufferRef</tt> is the last
	 * reference to the buffer, the buffer is also automatically freed.
	 *
	 * @param ref
	...
	/**
	 * Adds a filter graph described by a <tt>String</tt> to a specific <tt>AVFilterGraph</tt>
	 * instance.
	 *
	 * @param graph
	 *        a pointer to the <tt>AVFilterGraph</tt> instance where to link the parsed graph
	 *        context
	 * @param filters
	 *        the <tt>String</tt> to be parsed
	 * @param inputs
	 *        a pointer to a linked list to the inputs of the graph if any; otherwise, <tt>0</tt>
	 * @param outputs
	 *        a pointer to a linked list to the outputs of the graph if any; otherwise, <tt>0</tt>
	 * @param log_ctx
	 ...
	 *
	 * @param graph
	 *        a pointer to the <tt>AVFilterGraph</tt> instance where the <tt>AVFilterContext</tt>
	 *        instance with the specified name is to be found
	 * @param name
	 *        the name of the <tt>AVFilterContext</tt> instance which is to be found in the
	 ...
	 *
	 * @param graph
	 *        a pointer to the <tt>AVFilterGraph</tt> instance to check the validity of and
	 *        configure
	 * @param log_ctx
	 *        the <tt>AVClass</tt> context to be used for logging
	 * @return <tt>0</tt> on success; a negative <tt>AVERROR</tt> on error
	 ...
	 */
	public static native void avcodeccontext_set_scenechange_threshold(long ctx,
	 ...
	 * @param sample_rate
	 *        the samples per second to set to the specified <tt>AVCodecContext</tt>
	 */
	...
	public static native void avcodeccontext_set_quantizer(long ctx, int qmin, int qmax,
		int max_qdiff);
	 ...
	 * @param gop_size
	 *        the maximum number of pictures in a group of pictures i.e. the maximum interval
	 *        between keyframes
	 */
	 ...
	 * @param channels
	 *        the number of channels to set to the specified <tt>AVCodecContext</tt>
	 */
	 ...
	 * @param bit_rate
	 *        the average bit rate to be set to the specified <tt>AVCodecContext</tt>
	 */
	 ...
	 *
	 * @param ctx
	 *        the <tt>AVCodecContext</tt> which will be set up to use the specified <tt>AVCodec</tt>
	 * @param codec
	...
	public static native void avcodec_free_packet(long paramLong);
	 ...
	 *
	 * @param frame
	 *        an <tt>AVFrame *</tt> value which points to the <tt>AVFrame</tt> instance to be freed
	 */
	 ...
	 * @param samples
	 *        the input buffer containing the samples. The number of samples read from this buffer
	...
	public static native int avcodec_decode_audio4(long avctx, long frame, boolean[] got_frame,
		long avpkt);
	...
	public static native long avcodec_alloc_packet(int avpkt);
