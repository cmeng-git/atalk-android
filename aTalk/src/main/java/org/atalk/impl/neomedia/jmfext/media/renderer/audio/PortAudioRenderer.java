...
import org.atalk.impl.neomedia.jmfext.media.protocol.portaudio.*;
import org.atalk.impl.neomedia.portaudio.*;
...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>PortAudioRenderer</tt> class and its instances for
	 * logging output.
	 */
	 ...
	 * 		if the PortAudio device or output stream cannot be created or opened
	 */
	@Override
			...
			throws ResourceUnavailableException
	{
		try {
			...
			/*
			 * Log the problem because FMJ may swallow it and thus make debugging harder than
			 * necessary.
			 */
	 ...
	 *
	 * @param locator
	 * 		a <tt>MediaLocator</tt> which specifies the device index of the PortAudio device to be
	 ...
	 * 		<tt>true</tt> if <tt>Pa_WriteStream</tt> is malfunctioning; otherwise, <tt>false</tt>
	 */
