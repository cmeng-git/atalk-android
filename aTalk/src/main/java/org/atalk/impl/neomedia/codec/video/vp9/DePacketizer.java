...
public class DePacketizer
{
	...
	{
		/**
		 * Returns <tt>true</tt> if the B bit from the first byte of the payload descriptor has
		 * value 0.
		 *
		 * @param buf
		 * 		the byte buffer that holds the VP9 payload.
		 * @param off
		 * 		the offset in the byte buffer where the VP9 payload starts.
		 * @param len
		 * 		the length of the VP9 payload.
		 * @return <tt>true</tt> if the B bit from the first byte of the payload descriptor has
		...
		/**
		 * Returns <tt>true</tt> if the E bit from the first byte of the payload descriptor has
		 * value 0.
		 *
		 * @param buf
		 * 		the byte buffer that holds the VP9 payload.
		 ...
		 * @param len
		 * 		the length of the VP9 payload.
		 * @return <tt>true</tt> if the E bit from the first byte of the payload descriptor has
		 * value 0, false otherwise.
		 */
