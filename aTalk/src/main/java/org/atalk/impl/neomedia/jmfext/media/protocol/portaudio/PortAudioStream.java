...
public class PortAudioStream extends AbstractPullBufferStream<DataSource>
{
            ...
            throws IOException
    {
        ...
        try {
            ...
            Timber.e(paex, "Failed to open %s", getClass().getSimpleName());
            throw new IOException(paex.getLocalizedMessage(), paex);
        } finally {
            ...
            throws IOException
    {
        ...
        try {
            ...
            try {
                ...
                throw new IOException(pae.getLocalizedMessage(), pae);
            }
        ...
        if (this.deviceID != null) {
            ...
            if (stream != 0) {
                ...
                try {
                    ...
                    if (!closed) {
                        Timber.e(pae, "Failed to close %s", getClass().getSimpleName());
                        throw new IOException(pae.getLocalizedMessage(), pae);
                    }
                } finally {
                    if (closed) {
            ...
            throws IOException
    {
        if (stream != 0) {
            ...
            try {
                ...
                Timber.e(paex, "Failed to start %s", getClass().getSimpleName());
                throw new IOException(paex.getLocalizedMessage(), paex);
            }
        }
    }
            ...
            throws IOException
    {
        if (stream != 0) {
            ...
            try {
                ...
                Timber.e(paex, "Failed to stop %s", getClass().getSimpleName());
                throw new IOException(paex.getLocalizedMessage(), paex);
            }
        }
    }
