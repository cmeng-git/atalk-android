...
public class OpenSSLHMAC implements Mac
{
	...
	/**
	 * The context of the OpenSSL (Crypto) library through which the actual algorithm implementation
	 * is invoked by this instance.
	 */
	private long ctx;
	 ...
	 *        the algorithm of the digest to initialize the new instance with
