...
/**
 * Provides notifications when an audio endpoint device is added or removed, when the state or
 * properties of an endpoint device change, or when there is a change in the default role assigned
