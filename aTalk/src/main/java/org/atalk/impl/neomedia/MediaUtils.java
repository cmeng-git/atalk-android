...
//		if (cfg.getBoolean("neomedia.codec.video.h264.enabled", false)) {
		...
		if ((cfg == null)
				|| cfg.getBoolean("neomedia.codec.video.h264.packetization-mode-1.enabled",
				true)) {
	 ...
	 * 		the RTP payload type to be associated with a list of <tt>MediaFormat</tt>s
	 * @param encoding
	 * 		the well-known encoding (name) corresponding to <tt>rtpPayloadType</tt> (in
	 * 		contrast to the JMF-specific encoding specified by <tt>jmfEncoding</tt>)
	 * @param mediaType
	 * 		the <tt>MediaType</tt> of the <tt>MediaFormat</tt>s to be associated with
	 * 		<tt>rtpPayloadType</tt>
	 * @param jmfEncoding
	 * 		the JMF encoding of the <tt>MediaFormat</tt>s to be associated with
	 * 		<tt>rtpPayloadType</tt>
	 * @param clockRates
	 * 		the optional list of clock rates of the <tt>MediaFormat</tt>s to be associated
	 ...
	 * 		the RTP payload type to be associated with a list of <tt>MediaFormat</tt>s
	 * @param encoding
	 * 		the well-known encoding (name) corresponding to <tt>rtpPayloadType</tt> (in contrast
	 ...
	 * 		the set of format-specific parameters of the <tt>MediaFormat</tt>s to be associated
	 * 		with <tt>rtpPayloadType</tt>
	 * @param advancedAttributes
	 * 		the set of advanced attributes of the <tt>MediaFormat</tt>s to be associated with
	 * 		<tt>rtpPayload</tt>
	 * @param clockRates
	 * 		the optional list of clock rates of the <tt>MediaFormat</tt>s to be associated with
	 * 		<tt>rtpPayloadType</tt>
	 */
	 ...
	 *
	 * @param format
	 * 		the JMF <tt>Format</tt> to get the <tt>MediaFormat</tt> representation for
	 ...
	 *
	 * @param encoding
	 * 		the well-known encoding (name) of the <tt>MediaFormat</tt> to get
	 * @param clockRate
	 ...
	 *
	 * @param rtpPayloadType
	 * 		the RTP payload type to retrieve the corresponding <tt>MediaFormat</tt>s for
	 ...
	 *
	 * @param encoding
	 * 		the well-known encoding (name) to get the corresponding <tt>MediaFormat</tt>s of
	 ...
	 *
	 * @param jmfEncoding
	 * 		the JMF encoding as returned by
	 ...
	 * @param clockRate
	 * 		the clock rate to be taken into account in the search for the RTP payload type if the
	 ...
	 *
	 * @param jmfEncoding
	 * 		the JMF encoding to get the corresponding well-known encoding of
