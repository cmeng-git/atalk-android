...
class DecLd8k extends Ld8k
{
	...
	/*
	 * File : DEC_LD8K.C Used for the floating point version of G.729 main body (not for G.729A)
	 */
	 ...
	 */
	int decod_ld8k(int parm[], int voicing, float synth[], int synth_offset, float A_t[])
	{
		int parm_offset = 0;
