...
public class DataSource extends AbstractPushBufferCaptureDevice
{
			...
			implements Runnable
	{
		 ...
		 * @throws IOException
		 *         if an I/O error has prevented the reading of available media data from this
		 ...
		 *
		 * @throws IOException
		 *         if an error has prevented the start of the transfer of media from this instance
		 */
		@Override
		 ...
		 *
		 * @throws IOException
		 *         if an error has prevented the stopping of the transfer of media from this
		 *         instance
		 */
		@Override
