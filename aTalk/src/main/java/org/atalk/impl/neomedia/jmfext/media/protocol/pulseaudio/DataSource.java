...
public class DataSource extends AbstractPullBufferCaptureDevice
{
	...
	/**
	 * The indicator which determines whether debug-level logging is enabled for the
	 * <tt>DataSource</tt> class and its instances.
	 */
	...
	private class PulseAudioStream extends AbstractPullBufferStream<DataSource>
	{
		 ...
		 *
		 * @throws IOException
		 *         if this <tt>PulseAudioStream</tt> fails to connect to the configured source
		 */
		 ...
		 *
		 * @param b
		 *        <tt>true</tt> to pause the input of audio data or <tt>false</tt> to resume it
		 */
