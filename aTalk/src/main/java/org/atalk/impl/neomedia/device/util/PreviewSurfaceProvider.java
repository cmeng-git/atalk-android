 ...
 *
 */
public class PreviewSurfaceProvider extends ViewDependentProvider<SurfaceHolder> implements
	SurfaceHolder.Callback
{
	 ...
	 *
	 * @param parent
	 *        parent <tt>OSGiActivity</tt> instance.
	 * @param container
	 *        the <tt>ViewGroup</tt> that will hold maintained <tt>SurfaceView</tt>.
	 * @param setZMediaOverlay
	 *        if set to <tt>true</tt> then the <tt>SurfaceView</tt> will be displayed on the top of
	 *        other surfaces.
	 */
