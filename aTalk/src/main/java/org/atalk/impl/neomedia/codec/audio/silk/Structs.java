...
import static org.atalk.impl.neomedia.codec.audio.silk.Define.DEC_HP_ORDER;
...
import static org.atalk.impl.neomedia.codec.audio.silk.Define.MAX_LBRR_DELAY;
import static org.atalk.impl.neomedia.codec.audio.silk.Define.MAX_LPC_ORDER;
import static org.atalk.impl.neomedia.codec.audio.silk.Define.NB_SOS;
...
class SKP_Silk_NLSF_CBS
{
		...
		short[] SKP_Silk_NLSF_MSVQ_CB0_10_rates_Q5, int Q5_offset)
	{
		...
		System.arraycopy(SKP_Silk_NLSF_MSVQ_CB0_10_Q15, Q15_offset, this.CB_NLSF_Q15, 0,
			this.CB_NLSF_Q15.length);
		this.Rates_Q5 = new short[SKP_Silk_NLSF_MSVQ_CB0_10_rates_Q5.length - Q5_offset];
		System.arraycopy(SKP_Silk_NLSF_MSVQ_CB0_10_rates_Q5, Q5_offset, this.Rates_Q5, 0,
			this.Rates_Q5.length);
	}
