...
/**
 * Implements a managed <tt>IMediaBuffer</tt> which wraps around an unmanaged <tt>IMediaBuffer</tt>.
 *
...
public class PtrMediaBuffer implements IMediaBuffer
{
	...
	/**
	 * Initializes a new managed <tt>IMediaBuffer</tt> which is to represent a specific unmanaged
	 * <tt>IMediaBuffer</tt>.
	 * 
	 * @param ptr
	 *        the unmanaged <tt>IMediaBuffer</tt> to be represented by the new instance
	 */
