...
public class MediaRecorderSystem extends DeviceSystem
{
	 ...
	 *
	 * @throws Exception
	 *         if anything goes wrong while discovering and registering <tt>MediaRecorder</tt>
	 ...
	 *
	 * @param sizes
	 *        the <tt>Iterable</tt> of <tt>Dimension</tt>s which is to be represented as a
			...
			try {
				...
				if (supportedSizes != null) {
					...
					if (logger.isDebugEnabled()) {
						logger.debug("Sizes supported by " + locator + ": "
