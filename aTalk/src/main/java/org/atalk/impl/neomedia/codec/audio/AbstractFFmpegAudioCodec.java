...
public abstract class AbstractFFmpegAudioCodec extends AbstractCodec2
{
	 ...
	 *
	 * @param codecID
	 *        the <tt>AVCodecID</tt> to represent as a <tt>String</tt>
	 ...
	 * name, a specific <tt>AVCodecID</tt>, and a specific list of <tt>Format</tt>s supported as
	 * output.
	 *
	 * @param name
	 ...
	 *
	 * @param avctx
	 *        the <tt>AVCodecContext</tt> to configure
	 * @param format
	 *        the <tt>AudioFormat</tt> with which <tt>avctx</tt> is being configured
	 */
