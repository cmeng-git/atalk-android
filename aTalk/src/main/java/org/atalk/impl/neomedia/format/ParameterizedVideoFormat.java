...
public class ParameterizedVideoFormat extends VideoFormat
{
	 ...
	 * 		the encoding of the new instance
	 * @param fmtps
	 * 		the format parameters of the new instance in the form of an array of <tt>String</tt>s
	 * 		in which the key and the value of an association are expressed as consecutive
	 * 		elements.
	 */
	...
	/**
	 * Initializes a new <tt>ParameterizedVideoFormat</tt> instance which has the same
	 * properties as this instance.
	 *
	 * @return a new <tt>ParameterizedVideoFormat</tt> instance which has the same properties as
	 * this instance
	 */
	@Override
	public Object clone()
	 ...
	 *
	 * @param f
	 * 		the <tt>Format</tt> the properties of which are to be copied into this instance
	 */
	@Override
	 ...
	 *
	 * @param obj
	 * 		the <tt>Object</tt> to be determined whether it represents a value that is equal to
	...
	public boolean equals(Object obj)
	{
		...
		return VideoMediaFormatImpl.formatParametersAreEqual(getEncoding(), getFormatParameters(),
				objFmtps);
	}
	...
	public boolean formatParametersMatch(Format format)
	{
		...
		return VideoMediaFormatImpl.formatParametersMatch(getEncoding(), getFormatParameters(),
				formatFmtps);
	}
	 ...
	 * @return <tt>true</tt> if the specified <tt>format</tt> matches this one; otherwise,
	 * <tt>false</tt>
	 */
	@Override
	 ...
	 *
	 * @param <T>
	 * 		the very type of the keys and the values to be associated in the new <tt>Map</tt>
	 * @param entries
	 * 		the associations to be created in the new <tt>Map</tt> where the key and value of an
	 * 		association are expressed as consecutive elements
