...
{
	/**
	 * Initializes a new <tt>org.bouncycastle.crypto.Mac</tt> instance which implements a keyed-hash
	 * message authentication code (HMAC) with SHA-1.
	 *
	 * @return a new <tt>org.bouncycastle.crypto.Mac</tt> instance which implements a keyed-hash
	 *         message authentication code (HMAC) with SHA-1
	 */
