...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>SilenceEffect</tt> class and its instances for logging
	 * output.
	 */
	...
	protected void doClose()
	{
		if (logger.isInfoEnabled())
			logger.info("Closing SilenceEffect, inserted a total of " + totalSamplesInserted
				+ " samples of silence.");
	}
