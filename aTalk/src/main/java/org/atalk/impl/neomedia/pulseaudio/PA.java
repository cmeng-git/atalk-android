...
public final class PA
{
	...
	public static native long buffer_attr_new(int maxlength, int tlength, int prebuf, int minreq,
		int fragsize);
	...
	public static native long context_set_sink_input_volume(long c, int idx, long volume,
		context_success_cb_t cb);

	public static native long context_set_source_output_volume(long c, int idx, long volume,
		context_success_cb_t cb);
	...
	public static native int stream_connect_playback(long s, String dev, long attr, int flags,
		long volume, long syncStream);
	...
	public static native long stream_new_with_proplist(long c, String name, long ss, long map,
		long p);
	...
	public static native int stream_write(long s, byte[] data, int dataOffset, int dataLength,
		Runnable freeCb, long offset, int seek);
