...
public class DataSource extends AbstractPullBufferCaptureDevice
{
     ...
     *
     * @param locator the <tt>MediaLocator</tt> to create the new instance from
     * @param supportedFormats the list of <tt>Format</tt>s in which the new instance is to be capable of capturing
     * audio data
     * @param audioQualityImprovement <tt>true</tt> if audio quality improvement is to be enabled in accord with the
    ...
    /**
     * Gets the device index of the PortAudio device identified by the <tt>MediaLocator</tt> of this
     * <tt>DataSource</tt>.
     *
     * @return the device index of a PortAudio device identified by the <tt>MediaLocator</tt> of
     * this <tt>DataSource</tt>
     * @throws IllegalStateException if there is no <tt>MediaLocator</tt> associated with this <tt>DataSource</tt>
     */
    ...
    /**
     * Gets the device index of a PortAudio device from a specific <tt>MediaLocator</tt> identifying
     * it.
     *
     * @param locator the <tt>MediaLocator</tt> identifying the device index of a PortAudio device to get
     * @return the device index of a PortAudio device identified by <tt>locator</tt>
     */
     ...
     *
     * @param streamIndex the zero-based index of the <tt>PullBufferStream</tt> for which the specified
