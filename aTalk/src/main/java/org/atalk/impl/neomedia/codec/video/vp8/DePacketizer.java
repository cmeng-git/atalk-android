...
public class DePacketizer extends AbstractCodec2
{
	...
	public static class VP8PayloadDescriptor
	{
		 ...
		 *
		 * @param buf
		 * 		the byte buffer that holds the VP8 packet.
		 * @param off
		 * 		the offset in the byte buffer where the VP8 packet starts.
		 * @param len
		 * 		the length of the VP8 packet.
		 ...
		 *
		 * @param baf
		 * 		the <tt>ByteArrayBuffer</tt> that holds the VP8 payload descriptor.
		 ...
		 *
		 * @param buf
		 * 		the byte buffer that contains the VP8 payload.
		 * @param off
		 * 		the offset in the byte buffer where the VP8 payload
		 * 		starts.
		 * @param len
		 * 		the length of the VP8 payload in the byte buffer.
		 ...
		 * 		the byte buffer that contains the VP8 payload.
		 * @param off
		 * 		the offset in the byte buffer where the VP8 payload starts.
		 * @param len
		 * 		the length of the VP8 payload in the byte buffer.
		 * @return true if the operation succeeded, false otherwise.
		 */
