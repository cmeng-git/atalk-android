...
public class H264Parameters implements Serializable
{
	 ...
	 *
	 * @param path
	 *        the path to sample video file.
	 *
	 * @throws java.io.IOException
	 *         if we failed to parse and extract values.
	 */
	 ...
	 * 
	 * @param path
	 *        current boxes path(start with empty and we are looking for
	 *        ".moov.trak.mdia.minf.stbl.stsd" where avcC resides.
	 * @param file
	 *        random access sample video file
	 * @throws IOException
	 *         if we failed to parse video sample.
	 */
	 ...
	 * 
	 * @param file
	 *        the random access file with pointer set to stsd box position.
	 * @throws IOException
	 *         if we failed to extract sps and pps parameters.
	 */
	 ...
	 * @throws IOException
	 *         if end of stream or other error occurs.
	 */
	 ...
	 *
	 * @param params
	 *        the <tt>H264Parameters</tt> instance to be stored.
	 */
