...
public class InitEncoderFLP
{
	 ...
	 * @return
	 */
	static int SKP_Silk_init_encoder_FLP(SKP_Silk_encoder_state_FLP psEnc /* I/O Encoder state FLP */
	)
	{
		int ret = 0;
		...
		/*
		 * Initialize to 24 kHz API sampling, 24 kHz max internal sampling, 20 ms packets, 25 kbps,
		 * 0% packet loss, and init non-zero values
		 */
		ret = ControlCodecFLP
			.SKP_Silk_control_encoder_FLP(psEnc, 24000, 24, 20, 25, 0, 0, 0, 10, 0);
