...
{
	/**
	 * Initializes a new <tt>CVPixelBuffer</tt> instance which is to represent a specific CoreVideo
	 ...
	 *
	 * @param ptr
	 * 		the <tt>CVPixelBufferRef</tt> to get the number of bytes which represent its pixels of
	...
	/**
	 * Gets a <tt>byte</tt> array which represents the pixels of the associated CoreVideo
	 * <tt>CVPixelBufferRef</tt>.
	 *
	 * @return a <tt>byte</tt> array which represents the pixels of the associated CoreVideo
	 * <tt>CVPixelBufferRef</tt>
	 */
	...
	/**
	 * Gets a <tt>byte</tt> array which represents the pixels of a specific CoreVideo
	 * <tt>CVPixelBufferRef</tt>.
	 *
	 * @param ptr
	 * 		the <tt>CVPixelBufferRef</tt> to get the pixel bytes of
	 * @return a <tt>byte</tt> array which represents the pixels of the specified CoreVideo
	 * <tt>CVPixelBufferRef</tt>
	 */
	private static native byte[] getBytes(long ptr);

	/**
	 * Gets the bytes which represent the pixels of the associated <tt>CVPixelBufferRef</tt> into a
	...
	/**
	 * Gets the bytes which represent the pixels of a specific <tt>CVPixelBufferRef</tt> into a
	 * specific native byte buffer with a specific capacity.
	 *
	 * @param ptr
	...
	/**
	 * Gets the height in pixels of a specific CoreVideo <tt>CVPixelBufferRef</tt>.
	 *
	 * @param ptr
	 * 		the CoreVideo <tt>CVPixelBufferRef</tt> to get the height in pixels of
	 * @return the height in pixels of the specified CoreVideo <tt>CVPixelBufferRef</tt>
	 */
	...
	/**
	 * Gets the width in pixels of a specific CoreVideo <tt>CVPixelBufferRef</tt>.
	 *
	 * @param ptr
	 * 		the CoreVideo <tt>CVPixelBufferRef</tt> to get the width in pixels of
	 * @return the width in pixels of the specified CoreVideo <tt>CVPixelBufferRef</tt>
	 */
