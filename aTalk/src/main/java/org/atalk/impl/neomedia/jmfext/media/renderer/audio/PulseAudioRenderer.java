...
public class PulseAudioRenderer extends AbstractAudioRenderer<PulseAudioSystem>
{
	...
	/**
	 * The number of channels of audio data this <tt>PulseAudioRenderer</tt> is configured to
	 * render.
	 */
	...
	/**
	 * The PulseAudio stream which performs the actual rendering of audio data for this
	...
	/**
	 * Applies the volume specified by a specific <tt>GainControl</tt> on a specified sample of
	 * audio <tt>data</tt>.
	 *
	 * @param gainControl
	 * 		the <tt>GainControl</tt> which specifies the volume to set on <tt>data</tt>
	 * @param data
	 * 		the audio data to set the volume specified by <tt>gainControl</tt> on
	 * @param offset
	 * 		the offset in <tt>data</tt> at which the valid audio data begins
	 * @param length
	 * 		the number of bytes of valid audio data in <tt>data</tt> beginning at <tt>offset</tt>
	 */
	 ...
	 *
	 * @param b
	 * 		<tt>true</tt> to pause the playback of audio data or <tt>false</tt> to resume it
	 */
	 ...
	 *
	 * @throws ResourceUnavailableException
	 * 		if the opening of this <tt>PulseAudioRenderer</tt> failed
	 */
	 ...
	 *
	 * @param buffer
	 * 		the FMJ <tt>Buffer</tt> which specifies the audio data to play back
	 ...
	 *
	 * @param stream
	 * 		the PulseAudio stream to set the volume of
	 */
	@SuppressWarnings("unused")
	 ...
	 * 		the PulseAudio stream to set the volume of
	 * @param level
	 * 		the volume to set on <tt>stream</tt>
	 */
