		...
		implements MediaFormat
{
	 ...
	 *
	 * @param format
	 * 		the JMF <tt>Format</tt> the new instance is to provide an implementation of
	 ...
	 * assigns it specific clock rate and set of format-specific parameters.
	 *
	 * @param format
	 * 		the JMF <tt>Format</tt> the new instance is to provide an implementation of
	 * 		<tt>MediaFormat</tt> for
	...
	/**
	 * The advanced parameters of this instance which have been received via SIP/SDP or
	 * XMPP/Jingle.
	 */
	...
	/**
	 * The JMF <tt>Format</tt> this instance wraps and provides an implementation of
	 * <tt>MediaFormat</tt> for.
	 */
	protected final T format;

	/**
	 * The codec-specific parameters of this instance which have been received via SIP/SDP or
	 * XMPP/Jingle.
	 */
	 ...
	 * 		<tt>MediaFormat</tt> for
	 * @param formatParameters
	 * 		any codec-specific parameters that have been received via SIP/SDP or XMPP/Jingle
	 * @param advancedAttributes
	 * 		any parameters that have been received via SIP/SDP or XMPP/Jingle
	 */
	 ...
	 * @param adv2
	 * 		the second set of advanced attributes to be tested for equality
	 * @return <tt>true</tt> if the specified sets of advanced attributes equal; <tt>false</tt>,
	 * otherwise
	 */
	 ...
	 *
	 * @return a <tt>String</tt> representation of the clock rate associated with this
	 * <tt>MediaFormat</tt>.
	 */
	 ...
	 * that we are encapsulating here but it is the RFC-known encoding and not the internal JMF
	 * encoding.
	 *
	...
	/**
	 * Implements MediaFormat#getFormatParameters(). Returns a copy of the format properties of
	 * this instance. Modifications to the returned Map do no affect the format properties of this
	 * instance.
	 *
	 ...
	 * encode the stream (that's an error noted in the respective RFC and kept for the sake of
	 * compatibility.).
	 *
	 ...
	 * <tt>channels</tt> for <tt>MediaFormat</tt>s with <tt>mediaType</tt> equal to
	 * {@link MediaType#AUDIO}.
	 *
	 * @param format
	 * 		the {@link MediaFormat} whose properties we'd like to examine and compare with ours.
	 */
	 ...
	 * @param fmtps
	 * 		the format parameters expected to match these of the specified <tt>format</tt>
	...
	public String toString()
	{
		...
		/*
		 * If the number of channels is 1, it does not have to be mentioned because it is the
		 * default.
		 */
