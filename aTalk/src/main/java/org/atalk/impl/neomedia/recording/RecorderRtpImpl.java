        ...
        ActiveSpeakerChangedListener, ControllerListener
{
    ...
    private static final Format opusFormat = new AudioFormat(
            Constants.OPUS_RTP,
            48000,
    ...
    private static final String FMJ_VIDEO_JITTER_BUFFER_MIN_SIZE_PNAME
            = "neomedia.recording.FMJ_VIDEO_JITTER_BUFFER_MIN_SIZE";
    ...
    private static final String FMJ_AUDIO_JITTER_BUFFER_MIN_SIZE_PNAME
            = "neomedia.recording.FMJ_AUDIO_JITTER_BUFFER_MIN_SIZE_PNAME";
    ...
    public RecorderRtpImpl(RTPTranslator translator)
    {
        ...
        if (cfg != null) {
            performActiveSpeakerDetection
                    = cfg.getBoolean(PERFORM_ASD_PNAME, performActiveSpeakerDetection);
    ...
    private class RTPConnectorImpl implements RTPConnector
    {
        ...
        private class OutputDataStreamImpl implements OutputDataStream
        {
            ...
            public synchronized int write(byte[] buffer, int offset, int length, boolean transform)
            {
                ...
                if (transform) {
                    PacketTransformer packetTransformer = isControlStream
                            ? rtcpPacketTransformer : rtpPacketTransformer;
        ...
        private class PushSourceStreamImpl implements PushSourceStream
        {
                    ...
                    throws IOException
            {
                ...
                if (pendingPacketBuffer != null) {
                    ...
                    System.arraycopy(pendingPacketBuffer, pendingPacket.getOffset(), buffer,
                            offset, bytesToRead);
                }
                return bytesToRead;
            }
