...
public class ResamplerPrivateARMA4
{
	 ...
	 *        Signal length.
	 */
	static void SKP_Silk_resampler_private_ARMA4(int[] S, /* I/O: State vector [ 4 ] */
	...
	)
	{
		...
		for (k = 0; k < len; k++) {
			...
			out[out_offset + k] = (short) SigProcFIX.SKP_SAT16(Macros.SKP_SMLAWB(128, out2_Q8,
				Coef[Coef_offset + 6]) >> 8);
		}
	}
}
