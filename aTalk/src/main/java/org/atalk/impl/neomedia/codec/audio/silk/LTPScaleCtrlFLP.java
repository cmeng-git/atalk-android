...
public class LTPScaleCtrlFLP
{
	 ...
	 */
	static final float LTPScaleThresholds[] = { 0.95f, 0.8f, 0.50f, 0.400f, 0.3f, 0.2f, 0.15f,
	 ...
	 *        Encoder control FLP
	 */
	static void SKP_Silk_LTP_scale_ctrl_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
