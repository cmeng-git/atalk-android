 ...
 *
 * @param <T> the very type of <tt>DataSource</tt> to be wrapped in a <tt>PushBufferDataSourceDelegate</tt>
 *
        ...
        CaptureDeviceDelegatePushBufferDataSource
{
    ...
    /**
     * Initializes a new <tt>PushBufferDataSourceDelegate</tt> which is to delegate to a specific <tt>DataSource</tt>.
     *
     * @param dataSource the <tt>DataSource</tt> the new instance is to delegate to
     */
     ...
     *
     * @throws IOException if the wrapped <tt>DataSource</tt> throws such an exception
     */
    @Override
    public void connect()
            throws IOException
     ...
     * <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still needs to be disconnected.
     */
    @Override
    ...
    /**
     * Implements {@link DataSource#getContentType()}. Delegates to the wrapped <tt>DataSource</tt>.
     ...
     * the content type.
     *
     * @return a <tt>String</tt> value which describes the content type of the wrapped <tt>DataSource</tt>
     */
    @Override
     ...
     *
     * @return a <tt>MediaLocator</tt> value which describes the locator of the wrapped <tt>DataSource</tt>
     */
    @Override
     ...
     * <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still needs to give access to the control.
     *
     * @param controlType a <tt>String</tt> value which names the type of the control to be retrieved
     * @return an <tt>Object</tt> which represents the control of the requested <tt>controlType</tt>
    ...
    /**
     * Implements {@link DataSource#getControls()}. Delegates to the wrapped <tt>PushBufferDataSource</tt>. Overrides
     * {@link CaptureDeviceDelegatePushBufferDataSource#getControls()} because the wrapped
     * <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still needs to give access to the controls.
     *
     * @return an array of <tt>Objects</tt> which represent the controls of the wrapped <tt>DataSource</tt>
     */
    @Override
