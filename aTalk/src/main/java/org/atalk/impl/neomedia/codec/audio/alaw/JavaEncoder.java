...
public class JavaEncoder extends com.ibm.media.codec.audio.AudioCodec {
    ...
    public JavaEncoder() {
        supportedInputFormats = new AudioFormat[]{
                ...
                new AudioFormat(AudioFormat.LINEAR, Format.NOT_SPECIFIED, 8, 1, Format.NOT_SPECIFIED,
                        Format.NOT_SPECIFIED)}; // support 1 channel and 8/16 bit samples

        defaultOutputFormats = new AudioFormat[]{new AudioFormat(AudioFormat.ALAW, 8000, 8, 1,
    ...
    protected Format[] getMatchingOutputFormats(Format in) {
        ...
        supportedOutputFormats = new AudioFormat[]{new AudioFormat(AudioFormat.ALAW, sampleRate,
                8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED)};
     ...
     *
     * @throws ResourceUnavailableException if open failed (which cannot happend for this codec since no resources are to be
     * opened)
     */
    @Override
    public void open()
     ...
     */
    private static final byte[] pcmToALawMap;
     ...
     * @param target A pre-allocated array to receive the A-law bytes. This array must be at least half the
     * size of the source.
