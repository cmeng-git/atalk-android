	...
	)
	{
		...
		while (true) {
			...
			ResamplerPrivateAR2.SKP_Silk_resampler_private_AR2(S, ORDER_FIR, buf, ORDER_FIR, in,
				in_offset, ResamplerRom.SKP_Silk_Resampler_2_3_COEFS_LQ, 0, nSamplesIn);
			...
			while (counter > 2) {
				...
				res_Q6 = SKP_SMLAWB(res_Q6, buf[buf_ptr + 1],
					ResamplerRom.SKP_Silk_Resampler_2_3_COEFS_LQ[3]);
				res_Q6 = SKP_SMLAWB(res_Q6, buf[buf_ptr + 2],
					ResamplerRom.SKP_Silk_Resampler_2_3_COEFS_LQ[5]);
				res_Q6 = SKP_SMLAWB(res_Q6, buf[buf_ptr + 3],
				...
				res_Q6 = SKP_SMULWB(buf[buf_ptr + 1],
					ResamplerRom.SKP_Silk_Resampler_2_3_COEFS_LQ[4]);
				res_Q6 = SKP_SMLAWB(res_Q6, buf[buf_ptr + 2],
					ResamplerRom.SKP_Silk_Resampler_2_3_COEFS_LQ[5]);
				res_Q6 = SKP_SMLAWB(res_Q6, buf[buf_ptr + 3],
					ResamplerRom.SKP_Silk_Resampler_2_3_COEFS_LQ[3]);
				res_Q6 = SKP_SMLAWB(res_Q6, buf[buf_ptr + 4],
