 ...
 */
public class SDesControlImpl extends AbstractSrtpControl<SDesTransformEngine>
		implements SDesControl
{
	 ...
	 * @return A SrtpCryptoAttribute when a matching cipher suite was found; <tt>null</tt>,
	 *         otherwise.
	 */
	...
	public void start(MediaType mediaType)
	{
		...
		srtpListener.securityTurnedOn(mediaType, selectedInAttribute.getCryptoSuite().encode(),
			this);
	}
}
