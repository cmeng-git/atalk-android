...
/**
 * Post-processing of output speech. 2nd order high pass filter with cut off frequency at 100 Hz.
...
class PostPro
{
	...
	/*
	 * File : POST_PRO.C Used for the floating point version of both G.729 main body and G.729A
	 */
