...
{
	/**
	 * The {@code OutputDataStream} this instance facilitates in the implementation of the interface
	 * {@code TransformOutputStream}.
	 */
	private final OutputDataStream _outputDataStream;

	/**
	 * The view of {@link #_transformer} as a {@code TransformEngineChain.PacketTransformerChain}.
	 */
	private TransformEngineChain.PacketTransformerChain _transformerAsChain;

	/**
	 * Initializes a new {@code TransformOutputStreamImpl} which is to facilitate a specific
	 * {@code OutputDataStream} in the implementation of the interface {@code TransformOutputStream}
	 * .
	 *
	 * @param outputDataStream
	 *        the {@code OutputDataStream} the new instance is to facilitate in the implementation
	 *        of the interface {@code TransformOutputStream}
	 */
	...
	/**
	 * Transforms a specified array of {@code RawPacket}s using the {@code PacketTransformer}
	 * associated with this instance (if any).
	 *
	 * @param pkts
	 *        the {@code RawPacket}s to transform
	 * @param after
	 * @return an array of {@code RawPacket}s which are the result of the transformation of the
	 *         specified {@code pkts} using the {@code PacketTransformer} associated with this
	 *         instance. If there is no {@code PacketTransformer} associated with this instance,
	 *         returns {@code pkts}.
	 */
