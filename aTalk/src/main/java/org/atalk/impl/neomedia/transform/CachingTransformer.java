...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>CachingTransformer</tt> class and its instances to print
	 * debug information.
	 */
	...
	public long getTimeUntilNextRun()
	{
		return (lastUpdateTime < 0L)
				? 0L
				: lastUpdateTime + PROCESS_INTERVAL_MS - System.currentTimeMillis();
	}
	 ...
	 *
	 * @param enabled
	 * 		{@code true} if the caching of packets is to be enabled or
