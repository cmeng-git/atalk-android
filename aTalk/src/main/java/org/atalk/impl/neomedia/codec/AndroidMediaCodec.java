...
public class AndroidMediaCodec extends AbstractCodec2
{
	...
	/**
	 * The <tt>Logger</tt> used by the <tt>AndroidMediaCodec</tt> class and its instances to output
	 * logging information.
	 */
	 ...
	 *
	 * @param codecInfo
	 *        the <tt>MediaCodecInfo</tt> to invoke the method on
	 * @param type
	 *        the supported/mime type to pass as an argument to the method to be invoked
	 ...
	 *
	 * @param colorFormat
	 *        the <tt>colorFormat</tt> value in the terms of Android's <tt>MediaCodec</tt> class to
	 ...
	 *
	 * @param type
	 *        the mime type in the terms of Android's <tt>MediaCodec</tt> class to get an FMJ
	 ...
	 *
	 * @param format
	 *        the FMJ <tt>Format</tt> to get the equivalent to
	 ...
	 *
	 * @param format
	 *        the FMJ <tt>Format</tt> to be compared to the specified <tt>colorFormat</tt>
	 * @param colorFormat
	 *        the <tt>colorFormat</tt> defined in the terms of Android's <tt>MediaCodec</tt> class
	 ...
	 *
	 * @param format
	 *        the FMJ <tt>Format</tt> to be compared to the specified <tt>type</tt>
	 * @param type
	 *        the media type defined in the terms of Android's <tt>MediaCodec</tt> class to be
