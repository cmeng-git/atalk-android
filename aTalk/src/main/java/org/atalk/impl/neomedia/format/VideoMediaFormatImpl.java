		...
		implements VideoMediaFormat
{
	 ...
	 * 		the encoding of the new <tt>VideoMediaFormatImpl</tt> instance
	 * @param clockRate
	 * 		the clock rate of the new <tt>VideoMediaFormatImpl</tt> instance
	 */
	 ...
	 *
	 * @param format
	 * 		the JMF <tt>VideoFormat</tt> the new instance is to wrap and provide an implementation
	 ...
	 * 		the clock rate of the new <tt>VideoMediaFormatImpl</tt> instance
	 * @param frameRate
	 * 		the frame rate of the new <tt>VideoMediaFormatImpl</tt> instance
	 ...
	 * @param fmtps1
	 * 		the first set of format parameters which is to be matched against <tt>fmtps2</tt>
	 * @param fmtps2
	 * 		the second set of format parameters which is to be matched against <tt>fmtps1</tt>
