...
public class AndroidDecoder extends AndroidCodec
{
	...
	/**
	 * Name of configuration property that enables decoding directly into provided
	 * <tt>Surface</tt> object.
	 */
	...
	/**
	 * Surface provider used to obtain <tt>Surface</tt> object that will be used for decoded video
	 * rendering.
	 */
	...
	{
		return isHwDecodingEnabled() && LibJitsi.getConfigurationService()
