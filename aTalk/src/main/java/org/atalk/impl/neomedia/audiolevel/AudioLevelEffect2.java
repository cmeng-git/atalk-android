 ...
 * <p>
 * The class is based on {@link AudioLevelEffect}, but an
 * important difference is that the actual calculation is performed in the same thread that calls
...
public class AudioLevelEffect2 extends ControlsAdapter implements Effect
{
	...
	/**
	 * The ID of the RTP header extension for SSRC audio levels, which is to be added by this
	 * <tt>Effect</tt>.
	 */
	...
	/**
	 * Enables or disables this <tt>AudioLevelEffect2</tt> according to the value of
	 * <tt>enabled</tt>.
	 *
	 * @param enabled
	 * 		whether to enable or disabled this <tt>Effect</tt>.
	 */
