...
public class AndroidCamera extends CaptureDeviceInfo
{
	 ...
	 * 
	 * @param name
	 *        human readable name of the camera e.g. front camera.
	 * @param locator
	 *        the <tt>MediaLocator</tt> identifying the camera and it's system.
	 * @param formats
	 ...
	 *        locator protocol that identifies device system.
	 * @param cameraId
	 *        ID of camera that identifies the {@link Camera}.
	 * @param cameraInfo
	 *        <tt>CameraInfo</tt> corresponding to given <tt>cameraId</tt>.
	 * @return camera <tt>MediaLocator</tt> for given parameters.
	 */
	public static MediaLocator constructLocator(String locatorProtocol, int cameraId,
	 ...
	 * 
	 * @param locator
	 *        the <tt>MediaLocator</tt> that identifies the camera.
	...
	/**
	 * Finds camera with given <tt>facing</tt> from the same device system as currently selected
	 * camera.
	 *
	 * @param facing
	 *        the facing direction of camera to find.
	 * @return camera with given <tt>facing</tt> from the same device system as currently selected
	 *         camera.
	 */
	 ...
	 * 
	 * @param cameraLocator
	 *        camera device locator that will be used.
	 */
