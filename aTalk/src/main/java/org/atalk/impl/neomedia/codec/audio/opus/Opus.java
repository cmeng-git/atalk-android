...
public class Opus
{
	 ...
	 * frame, that's a 1 byte TOC + the maximum frame size. See
	 ...
	 * @param input
	 *        an array of <tt>byte</tt>s which represents the input payload to decode. If
	 *        <tt>null</tt>, indicates packet loss.
	 * @param inputOffset
	 *        the offset in <tt>input</tt> at which the payload to be decoded begins
	 * @param inputLength
	 *        the length in bytes in <tt>input</tt> beginning at <tt>inputOffset</tt> of the payload
	 *        to be decoded
	 * @param output
	 *        an array of <tt>byte</tt>s into which the decoded signal is to be output
	 * @param outputOffset
	 *        the offset in <tt>output</tt> at which the output of the decoded signal is to begin
	 * @param outputFrameSize
	 *        the number of samples per channel <tt>output</tt> beginning at <tt>outputOffset</tt>
	 *        of the maximum space available for output of the decoded signal
	 * @param decodeFEC
	 *        0 to decode the packet normally, 1 to decode the FEC data in the packet
	 * @return the number of decoded samples written into <tt>output</tt> (beginning at
	 *         <tt>outputOffset</tt>)
	 */
	 ...
	 */
	public static native int decoder_get_nb_samples(long decoder, byte[] packet, int offset,
		int length);
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Returns the current encoder
	 * audio bandwidth .
	 * 
	 * @param encoder
	 *        The encoder to use
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Returns the current DTX setting
	 * of the encoder.
	 *
	 * @param encoder
	 *        The encoder to use
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Returns the current inband FEC
	 * encoder setting.
	 *
	 * @param encoder
	 *        The encoder to use
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Returns the current encoder VBR
	 * setting
	 *
	 * @param encoder
	 *        The encoder to use
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Sets the encoder audio
	 * bandwidth.
	 *
	 * @param encoder
	 *        The encoder to use
	 * @param bandwidth
	 *        The bandwidth to set, should be one of <tt>BANDWIDTH_FULLBAND</tt>,
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Sets the encoder complexity
	 * setting.
	 *
	 * @param encoder
	 *        The encoder to use
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Sets the force channels setting
	 * of the encoder.
	 *
	 * @param encoder
	 *        The encoder to use
	 ...
	 *        The encoder to use
	 * @param maxBandwidth
	 *        The maximum bandwidth to use, should be one of <tt>BANDWIDTH_FULLBAND</tt>,
	 *        <tt>BANDWIDTH_MEDIUMBAND</tt>, <tt>BANDWIDTH_NARROWBAND</tt>,
	 *        <tt>BANDWIDTH_SUPERWIDEBAND</tt> or <tt>BANDWIDTH_WIDEBAND</tt>
	 *
	 * @return <tt>OPUS_OK</tt> on success.
	...
	/**
	 * Wrapper around the native <tt>opus_encoder_ctl</tt> function. Sets the encoder VBR constraint
	 * setting
	 *
	 * @param encoder
	 *        The encoder to use
	 ...
	 * <tt>BANDWIDTH_MEDIUMBAND</tt>, <tt>BANDWIDTH_NARROWBAND</tt>,
	 * <tt>BANDWIDTH_SUPERWIDEBAND</tt> or <tt>BANDWIDTH_WIDEBAND</tt>, or <tt>INVALID_PACKET</tt>
	 * on error.
	 *
	 * @param data
	 *        Array holding the packet.
