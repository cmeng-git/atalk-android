...
public class SRTPPolicy
{
    ...
    /**
     * Construct a SRTPPolicy object based on given parameters. This class acts as a storage class,
     * so all the parameters are passed in through this constructor.
     *
