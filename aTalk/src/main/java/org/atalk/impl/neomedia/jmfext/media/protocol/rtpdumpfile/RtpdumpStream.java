...
{
	/**
	 * The <tt>Logger</tt> used by <tt>RtpdumpStream</tt> and its instances for logging output.
	 */
	 ...
	 * @throws IOException
	 * 		if an I/O error has prevented the reading of available media data from this instance
