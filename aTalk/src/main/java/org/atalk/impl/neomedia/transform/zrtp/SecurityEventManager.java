...
public class SecurityEventManager extends ZrtpUserCallback
{
	...
	/**
	 * Show some information to user. ZRTP calls this method to display some information to the
	 * user. Along with the message ZRTP provides a severity indicator that defines: Info, Warning,
	 * Error, and Alert.
	 * 
	 * @param sev
	 ...
	 *
	 * @param sessionType
	 *        the <tt>MediaType</tt> to be converted into a <tt>String</tt> for the purposes of this
