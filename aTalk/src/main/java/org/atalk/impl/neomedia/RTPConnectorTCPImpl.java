...
public class RTPConnectorTCPImpl extends AbstractRTPConnector
{
	...
	/**
	 * Initializes a new <code>RTPConnectorTCPImpl</code> which is to use a given pair of sockets for
	 * RTP and RTCP traffic specified in the form of a <code>StreamConnector</code>.
	 *
	 * @param connector
	 ...
	 *
	 * @return the TCP Socket this instance uses to send and receive RTCP packets
	 */
