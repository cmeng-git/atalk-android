 ...
 *
 * @param <T>
 * 		the runtime type of the <tt>AudioSystem</tt> which provides the playback device used by
		...
		extends AbstractRenderer<AudioFormat>
{
	...
	/**
	 * The <tt>MediaLocator</tt> which specifies the playback device to be used by this
	 * <tt>Renderer</tt>.
	 */
	 ...
	 *
	 * @param audioSystem
	 * 		the <tt>AudioSystem</tt> which is to provide the playback devices to be used by the
	 * 		new instance
	 */
	 ...
	 * playback (as determined by <tt>dataFlow</tt>) devices provided by a specific
	 * <tt>AudioSystem</tt>.
	 *
	 * @param audioSystem
	 * 		the <tt>AudioSystem</tt> which is to provide the notification or playback devices to
	 * 		be used by the new instance
	 * @param dataFlow
	 * 		the flow of the media data to be implemented by the new instance i.e. whether
	 ...
	 * 		if the specified <tt>dataFlow</tt> is neither <tt>AudioSystem.DataFlow.NOTIFY</tt>
	 * 		nor <tt>AudioSystem.DataFlow.PLAYBACK</tt>
	 */
	 ...
	 * 		the protocol of the <tt>MediaLocator</tt>s of the <tt>CaptureDeviceInfo</tt>
	 ...
	 * <tt>MediaLocator</tt>s of the <tt>CaptureDeviceInfo</tt>s registered by the
	 * <tt>AudioSystem</tt>.
	 *
	 * @param locatorProtocol
	 * 		the protocol of the <tt>MediaLocator</tt>s of the <tt>CaptureDeviceInfo</tt>
	 ...
	 *
	 * @return an array of <tt>Object</tt>s which represent the available controls over this
	 * instance
	 */
	@Override
	...
	/**
	 * Gets the <tt>MediaLocator</tt> which specifies the playback device to be used by this
	 * <tt>Renderer</tt>.
	 *
	 * @return the <tt>MediaLocator</tt> which specifies the playback device to be used by this
	 * <tt>Renderer</tt>
	 */
			...
			throws ResourceUnavailableException
	{
		...
		if ((this.locator == null) && (audioSystem != null)) {
			 ...
			 * support that behavior, they will throw an exception and/or not call this
	...
	/**
	 * Sets the <tt>MediaLocator</tt> which specifies the playback device to be used by this
	 * <tt>Renderer</tt>.
	 *
	 * @param locator
	 * 		the <tt>MediaLocator</tt> which specifies the playback device to be used by this
