		...
		implements MediaStreamStats2
{
	...
	/**
	 * Notifies this instance that an RTP packet with a particular SSRC, sequence number and
	 * length was received.
	 *
	 * @param ssrc
	 ...
	 *
	 * @param ssrc
	 * 		the SSRC of the requested packet.
	 */
	 ...
	 * 		the SSRC of the packet.
	 * @param fractionLost
	 * 		the value of the "fraction lost" field.
	 */
	 ...
	 *
	 * @param ssrc
	 * 		the SSRC of the stream for which the jitter changed.
	 * @param direction
	 * 		whether the jitter is for a received or sent stream.
	 * @param jitter
	 * 		the new jitter value in milliseconds.
	 */
	 ...
	 * 		the SSRC of the stream for which the jitter changed.
	 * @param rtt
	 * 		the new measured RTT in milliseconds.
	 */
	...
	private abstract class AggregateTrackStats<T> extends AbstractTrackStats
	{
		 ...
		 *
		 * @param interval
		 * 		the interval in milliseconds over which average
		 * 		values will be calculated.
		 * @param children
		 * 		a reference to the map which holds the statistics to
		 * 		aggregate.
		 */
