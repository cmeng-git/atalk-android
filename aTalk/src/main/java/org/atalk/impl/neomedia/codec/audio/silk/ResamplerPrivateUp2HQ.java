...
public class ResamplerPrivateUp2HQ
{
	 ...
	 */
	static void SKP_Silk_resampler_private_up2_HQ(int[] S, /* I/O: Resampler state [ 6 ] */
	...
	)
	{
		...
		for (k = 0; k < len; k++) {
			...
			/* Biquad notch filter */
			out32_2 = SKP_SMLAWB(out32_2, S[S_offset + 5],
				ResamplerRom.SKP_Silk_resampler_up2_hq_notch[2]);
			out32_2 = SKP_SMLAWB(out32_2, S[S_offset + 4],
				ResamplerRom.SKP_Silk_resampler_up2_hq_notch[1]);
			out32_1 = SKP_SMLAWB(out32_2, S[S_offset + 4],
				ResamplerRom.SKP_Silk_resampler_up2_hq_notch[0]);
			S[S_offset + 5] = out32_2 - S[S_offset + 5];

			/* Apply gain in Q15, convert back to int16 and store to output */
			out[out_offset + 2 * k] = (short) SigProcFIX.SKP_SAT16(SKP_SMLAWB(256, out32_1,
			...
			out32_2 = SKP_SMLAWB(out32_2, S[S_offset + 5],
				ResamplerRom.SKP_Silk_resampler_up2_hq_notch[1]);
			out32_1 = SKP_SMLAWB(out32_2, S[S_offset + 5],
				ResamplerRom.SKP_Silk_resampler_up2_hq_notch[0]);
			S[S_offset + 4] = out32_2 - S[S_offset + 4];

			/* Apply gain in Q15, convert back to int16 and store to output */
			out[out_offset + 2 * k + 1] = (short) SigProcFIX.SKP_SAT16(SKP_SMLAWB(256, out32_1,
				ResamplerRom.SKP_Silk_resampler_up2_hq_notch[3]) >> 9);
		}
	}
	 ...
	 *        Number of input samples.
	 */
	static void SKP_Silk_resampler_private_up2_HQ_wrapper(Object SS, /* I/O: Resampler state (unused) */
