...
class QuaLsp
{
	...
	/*
	 * File : QUA_LSP.C Used for the floating point version of both G.729 main body and G.729A
	 */
	 ...
	 */
	private static final float[/* M */] FREQ_PREV_RESET = { 0.285599f, 0.571199f, 0.856798f,
		1.142397f, 1.427997f, 1.713596f, 1.999195f, 2.284795f, 2.570394f, 2.855993f }; /*
																						 * PI*(float)
																						 * (
																						 * j+1)/(float
																						 * )(M+1)
	...
	private void lsp_qua_cs(float[] flsp_in, float[] lspq_out, int[] code)
	{
		...
		relspwed(flsp_in, wegt, lspq_out, lspcb1, lspcb2, fg, freq_prev, fg_sum, fg_sum_inv, code);
	}
	 ...
	 *        output:codes of the selected LSP
	 */
	private void relspwed(float lsp[], float wegt[], float lspq[], float lspcb1[][/* M */],
		float lspcb2[][/* M */], float fg[/* MODE */][/* MA_NP */][/* M */],
		...
		float fg_sum_inv[/* MODE */][/* M */], int code_ana[])
	{
		...
		Lspgetq.lsp_get_quant(lspcb1, lspcb2, cand[mode_index], tindex1[mode_index],
			tindex2[mode_index], fg[mode_index], freq_prev, lspq, fg_sum[mode_index]);
	}
	 ...
	 */
	private int lsp_select_1(float rbuf[], float lspcb1[], float wegt[], float lspcb2[][/* M */])
	{
		float FLT_MAX_G729 = Ld8k.FLT_MAX_G729;
		int M = Ld8k.M;
		int NC = Ld8k.NC;
	 ...
	 * @return selected codebook index
	 */
	private int lsp_select_2(float rbuf[], float lspcb1[], float wegt[], float lspcb2[][/* M */])
	{
		float FLT_MAX_G729 = Ld8k.FLT_MAX_G729;
		int M = Ld8k.M;
		int NC = Ld8k.NC;
