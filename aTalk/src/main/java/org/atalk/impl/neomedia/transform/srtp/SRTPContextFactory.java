...
/**
 * The <tt>SRTPContextFactory</tt> creates the initial crypto contexts for RTP and RTCP encryption
...
public class SRTPContextFactory
{
	...
	/**
	 * Construct a SRTPTransformEngine based on given master encryption key, master salt key and
	 * SRTP/SRTCP policy.
	 *
	 * @param sender
