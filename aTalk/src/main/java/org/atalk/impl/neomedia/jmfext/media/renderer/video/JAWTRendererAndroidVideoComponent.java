...
public class JAWTRendererAndroidVideoComponent extends Component implements ViewAccessor
{
	...
	/**
	 * The <tt>Logger</tt> used by the <tt>JAWTRendererAndroidVideoComponent</tt> class and its
	 ...
	 *
	 * @param renderer
	 * 		the <tt>JAWTRenderer</tt> which is to use the new instance as its visual
	 * 		<tt>Component</tt>
	 */
	 ...
	 *
	 * @param context
	 * 		the <tt>Context</tt> in which the provided <tt>View</tt> will be used
