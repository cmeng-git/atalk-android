...
public class RecorderImpl implements Recorder
{
	...
	/**
	 * The <tt>RecorderEventHandler</tt> which this <tt>Recorder</tt> should notify when events
	...
	/**
	 * The indicator which determines whether this <tt>Recorder</tt> is set to skip media from mic.
	 */
	 ...
	 *
	 * @param device
	 * 		device that can create a session that provides the output data source
	 */
	...
	/**
	 * Adds a new <tt>Recorder.Listener</tt> to the list of listeners interested in notifications
	 ...
	 * 		if the specified <tt>format</tt> is not a supported recording format
	 */
	...
	/**
	 * Removes a existing <tt>Recorder.Listener</tt> from the list of listeners interested in
	 * notifications from this <tt>Recorder</tt>.
	 *
	 * @param listener
	 * 		the existing <tt>Recorder.Listener</tt> to be removed from the list of listeners
	...
	/**
	 * Stops the recording of the media associated with this <tt>Recorder</tt> (e.g. the media
	 * being
	 ...
	 * {@inheritDoc}
	 * <p>
	 * This <tt>Recorder</tt> implementation does not use a <tt>Synchronizer</tt>.
	 */
