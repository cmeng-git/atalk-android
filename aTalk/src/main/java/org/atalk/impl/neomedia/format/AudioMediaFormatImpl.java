		...
		implements AudioMediaFormat
{
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance which is to provide an
	 * implementation of <tt>AudioMediaFormat</tt> for a specific JMF <tt>AudioFormat</tt>.
	 *
	 * @param format
	 * 		the JMF <tt>AudioFormat</tt> the new instance is to wrap and provide an implementation
	 * 		of <tt>AudioMediaFormat</tt> for
	 */
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance which is to provide an
	 * implementation of <tt>AudioMediaFormat</tt> for a specific JMF <tt>AudioFormat</tt> and to
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified encoding and a
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified encoding and
	 * clock rate and a single audio channel.
	 *
	 * @param encoding
	 * 		the encoding of the new <tt>AudioMediaFormatImpl</tt> instance
	 * @param clockRate
	 * 		the clock (i.e. sample) rate of the new <tt>AudioMediaFormatImpl</tt> instance
	 */
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified encoding, clock
	 ...
	 * @param advancedParameters
	 * 		set of advanced parameters that have been received by SIP/SDP or XMPP/Jingle
	 */
	...
	/**
	 * Gets an <tt>AudioFormat</tt> instance which matches a specific <tt>AudioFormat</tt> and
	 * has 1 channel if the specified <tt>AudioFormat</tt> has its number of channels not
	 * specified.
	 *
	 * @param format
	 * 		the <tt>AudioFormat</tt> to get a match of
	 * @return if the specified <tt>format</tt> has a specific number of channels, <tt>format</tt>;
	 * otherwise, a new <tt>AudioFormat</tt> instance which matches <tt>format</tt> and has
	 * 1 channel
	 */
	...
	/**
	 * Gets the number of audio channels associated with this <tt>AudioMediaFormat</tt>.
	 *
	...
	/**
	 * Gets the type of this <tt>MediaFormat</tt> which is {@link MediaType#AUDIO} for
