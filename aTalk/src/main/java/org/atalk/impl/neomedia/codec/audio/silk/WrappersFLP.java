...
public class WrappersFLP
{
	...
	static void SKP_Silk_A2NLSF_FLP(float[] pNLSF, /* O NLSF vector [ LPC_order ] */
	...
	static void SKP_Silk_NLSF2A_stable_FLP(float[] pAR, /* O LPC coefficients [ LPC_order ] */
	...
	static void SKP_Silk_interpolate_wrapper_FLP(float xi[], /* O Interpolated vector */
	...
	/****************************************/
	static int SKP_Silk_VAD_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
	...
	/****************************************/
	static void SKP_Silk_NSQ_wrapper_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
		SKP_Silk_encoder_control_FLP psEncCtrl, /* I/O Encoder control FLP */
