...
public class DePacketizer extends AbstractCodec2
{
    ...
    protected int doProcess(Buffer inBuffer, Buffer outBuffer)
    {
        ...
        if ((lastSequenceNumber != -1) && ((sequenceNumber - lastSequenceNumber) != 1)) {
             ...
             */
            Timber.log(TimberLog.FINER, "Dropped RTP packets upto sequenceNumber %s and\n continuing with sequenceNumber %s",
        ...
        if (plen > 0) {
            Timber.i("Extra picture header present PLEN: %s", plen);
        }
     ...
     * @param outOffset the index in <tt>outOffset</tt> at which the writing of <tt>outputPaddingSize</tt>
