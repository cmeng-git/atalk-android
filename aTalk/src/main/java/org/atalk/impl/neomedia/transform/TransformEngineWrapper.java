    ...
    implements TransformEngine
{
	 ...
	 *
	 * @param t
	 *        the {@code TransofmrEngine} to check whether it is contained in this
	 *        {@code TransformEngineWrapper}
	 * @return {@code true} if {@code t} equals {@link #wrapped} or {@code t} is contained in the
	 *         {@code chain} of {@code wrapped} (if {@code wrapped} is a
	 *         {@code TransformEngineChain}); otherwise, {@code false}
	 */
