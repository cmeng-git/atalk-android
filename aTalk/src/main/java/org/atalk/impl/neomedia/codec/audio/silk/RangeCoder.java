...
public class RangeCoder
{
	...
	static void SKP_Silk_range_decoder(int data[], /* O uncompressed data */
		int data_offset, SKP_Silk_range_coder_state psRC, /* I/O compressor data structure */
	 ...
	 *        number of data symbols.
	 */
	static void SKP_Silk_range_decoder_multi(int data[], /* O uncompressed data [nSymbols] */
	...
	static void SKP_Silk_range_dec_init(SKP_Silk_range_coder_state psRC, /*
		...
		int buffer_offset, final int bufferLength /* I buffer length (in bytes) */
	)
	{
		/* check input */
