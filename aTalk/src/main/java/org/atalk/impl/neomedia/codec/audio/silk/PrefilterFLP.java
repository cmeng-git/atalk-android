...
public class PrefilterFLP
{
	 ...
	 */
	static void SKP_Silk_prefilter_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
		...
		int x_offset)
	{
		...
		for (k = 0; k < NB_SUBFR; k++) {
			...
			System.arraycopy(psEncCtrl.AR1, k * SHAPE_LPC_ORDER_MAX, AR1_shp, 0,
				psEncCtrl.AR1.length - k * SHAPE_LPC_ORDER_MAX);
	 ...
	 * @param length
	 */
	static void SKP_Silk_prefilt_FLP(SKP_Silk_prefilter_state_FLP P,/* (I/O) state */
		float st_res[], /* (I) */
