 ...
 */
public class ZrtpControlImpl extends AbstractSrtpControl<ZRTPTransformEngine>
		implements ZrtpControl
{
	 ...
	 *
	 * @param index
	 * 		Hello hash of the Hello packet identified by index. Index must be
	...
	protected ZRTPTransformEngine createTransformEngine()
	{
		...
		transformEngine.initialize("GNUZRTP4J.zid", false,
	 ...
	 *
	 * @param connector
	 * 		the <tt>RTPConnector</tt> which is to use or uses this ZRTP engine
	 */
