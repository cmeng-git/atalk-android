...
public class Resampler
{
	 ...
	 * @return
	 */
	static int SKP_Silk_resampler_init(SKP_Silk_resampler_state_struct S, /* I/O: Resampler state */
	 ...
	 * @return
	 */
	static int SKP_Silk_resampler_clear(SKP_Silk_resampler_state_struct S /* I/O: Resampler state */
	)
	{
	 ...
	 * @return
	 */
	static int SKP_Silk_resampler(SKP_Silk_resampler_state_struct S, /* I/O: Resampler state */
...
{
	public void down_pre_function(int[] state, short[] out, int outOffset, short[] in,
		int inOffset, int len)
	{
...
{
	public void up_post_function(int[] state, short[] out, int outOffset, short[] in, int inOffset,
		int len)
	{
...
{
	public void resampler_function(Object state, short[] out, int outOffset, short[] in,
		int inOffset, int len)
	{
...
{
	public void up2_function(int[] state, short[] out, int outOffset, short[] in, int inOffset,
		int len)
	{
		ResamplerUp2.SKP_Silk_resampler_up2(state, 0, out, outOffset, in, inOffset, len);
	}
