...
public class RtpdumpMediaDevice
{
	 ...
	 * 		the format this <tt>MediaDevice</tt> will have. You can find the list of possible
	 * 		format in the class <tt>Constants</tt> of libjitsi (ex : Constants.VP8_RTP).
	 * @param format
	 * 		the <tt>MediaFormat</tt> of the data contained in the payload of the recorded rtp
	 ...
	 * <tt>computeDuration(long)</tt> method, because FMJ insists on using this to compute its own
	 * RTP timestamps.
	 * <p>
	 ...
	 * {@link RtpdumpStream#RtpdumpStream(DataSource, javax.media.control.FormatControl)} TODO:
	 * Avoid this hack...
	 *
	 * @param filePath
	 * 		the location of the rtpdump file
	 * @param format
	 * 		the <tt>AudioFormat</tt> of the data contained in the payload of the recorded rtp
	 * 		packet in the rtpdump file.
	 * @return a <tt>MediaDevice</tt> that will read the rtpdump file given.
	 */
