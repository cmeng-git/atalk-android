 ...
 *
 * @param <T>
 * 		the type of <tt>Format</tt> of the media data processed as input by
 * 		<tt>AbstractRenderer</tt>
 * @author Lyubomir Marinov
 */
public abstract class AbstractRenderer<T extends Format> extends ControlsAdapter implements
		Renderer
{
	/**
	 ...
	 *
	 * @param format
	 * 		the <tt>Format</tt> of the media data to be rendered by this <tt>Renderer</tt>
