...
public class CaptureDeviceInfo2 extends CaptureDeviceInfo
{
	 ...
	 *        the <tt>CaptureDeviceInfo</tt> whose properties are to be copied into the new instance
	 * @param uid
	 *        the unique identifier of the hardware device (interface) which is to be represented by
	 *        the new instance
	 * @param transportType
	 *        the transport type (e.g. USB) of the device to be represented by the new instance
	 * @param modelIdentifier
	 *        the persistent identifier of the model of the hardware device to be represented by the
	 *        new instance
	 */
	 ...
	 * @param locator
	 *        the <tt>MediaLocator</tt> which uniquely identifies the device to be described by the
	 *        new instance
	 * @param formats
	 *        an array of the <tt>Format</tt>s supported by the device to be described by the new
	 *        instance
	 * @param uid
	 *        the unique identifier of the hardware device (interface) which is to be represented by
	 *        the new instance
	 ...
	 *
	 * @param obj
	 *        the <tt>Object</tt> to be determined whether it is equal (by value) to this instance
	 * @return <tt>true</tt> if the specified <tt>obj</tt> is equal (by value) to this instance;
	 ...
	 * system UID if not null. Otherwise returns the device name and (if not null) the transport
	 * type.
	 *
	 ...
	 *
	 * @param transportType
	 *        the transport type to compare to the transport type of this instance
