...
class PredLt3
{
	...
	/*
	 * File : PRED_LT3.C Used for the floating point version of both G.729 main body and G.729A
	 */

	/**
	 * Compute the result of long term prediction with fractional interpolation of resolution 1/3.
	 *
	 * On return exc[0..L_subfr-1] contains the interpolated signal (adaptive codebook excitation)
	 *
	 * @param exc
