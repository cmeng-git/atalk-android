		...
		implements SrtpControl.TransformEngine, ZrtpCallback
{
	 ...
	 * been
	 * invoked on this instance to prepare it for garbage collection. Disallows
	 ...
	 * 		The ZID file name
	 * @param autoEnable
	 * 		Set this true to start with auto-sensing and false to disable it.
	 * @param config
	...
	/**
	 * @param startMuted
	 * 		whether to be started as muted if no secure communication is established
	 */
	 ...
	 * 		The SAS string.
	 * @param verified
	 * 		if <code>verified</code> is true then SAS was verified by both parties during a
	 * 		previous call.
	 ...
	 *
	 * @param index
	 * 		Hello hash of the Hello packet identified by index. Index must be 0 <= index <
