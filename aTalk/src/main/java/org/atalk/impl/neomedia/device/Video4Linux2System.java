...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>Video4Linux2System</tt> class and its instances for
	 * logging output.
	 */
	 ...
	 *
	 * @throws Exception
	 *         if anything goes wrong while discovering and registering <tt>CaptureDevice</tt>s
	 ...
	 *
	 * @param deviceName
	 *        the device name of a candidate for a <tt>CaptureDevice</tt> implementing the Video for
	 ...
	 *         <tt>false</tt>
	 * @throws Exception
	 *         if anything goes wrong while discovering and registering the specified
	 ...
	 *         <tt>false</tt>
	 * @throws Exception
	 *         if anything goes wrong while registering the specified <tt>CaptureDevice</tt> with
	 *         JMF
	 */
