...
public class AndroidEncoder extends AndroidCodec
{
	...
	/**
	 * Name of configuration property that enables usage of <tt>Surface</tt> object as a source of
	 * video data.
	 */
	...
	private static boolean isHwEncodingEnabled()
	{
		...
		return LibJitsi.getConfigurationService().getBoolean(HW_ENCODING_ENABLE_PROPERTY,
				supported);
	}
	...
	public static boolean isDirectSurfaceEnabled()
	{
		...
		return isHwEncodingEnabled() && supported && LibJitsi.getConfigurationService()
	...
	public Format setOutputFormat(Format format)
	{
		...
		/* maxDataLength */Format.NOT_SPECIFIED, videoFormat.getDataType(),
