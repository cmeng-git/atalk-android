...
public class PortAudioSystem extends AudioSystem2
{
	...
	/**
	 * The <tt>Logger</tt> used by the <tt>PortAudioSystem</tt> class and its instances for logging
	 * output.
	 */
	 ...
	 *
	 * @param input
	 *        <tt>true</tt> if the supported sample rate is to be retrieved for the PortAudio device
	 *        with the specified device index as an input device or <tt>false</tt> for an output
	 *        device
	 * @param deviceIndex
	 *        the device index of the PortAudio device for which a supported sample rate is to be
	 *        retrieved
	 * @param channelCount
	 *        number of channel
	 * @param sampleFormat
	 ...
	 *        the <tt>DiagnosticsControl</tt> to be placed under monitoring of its functional health
	 ...
	 *
	 * @throws Exception
	 *         if anything wrong happens while creating the PortAudio capture and playback devices
	 */
	PortAudioSystem()
		throws Exception
	{
