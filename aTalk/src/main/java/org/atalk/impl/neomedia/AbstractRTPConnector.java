...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>AbstractRTPConnector</tt> class and its instances to
	 ...
	 * @throws IOException
	 *         if there was a socket-related error while adding the specified target
	 */
	 ...
	 *
	 * @param create
	 *        <tt>true</tt> to create the <tt>PushSourceStream</tt> which gives access to the RTCP
	 ...
	 *
	 * @param create
	 *        <tt>true</tt> to create the <tt>OutputDataStream</tt> which is to be used to write
	 ...
	 *
	 * @param create
	 *        <tt>true</tt> to create the <tt>PushSourceStream</tt> which gives access to the RTP
	 *        data received from the remote targets if it does not exist yet; otherwise,
	 *        <tt>false</tt>
	 ...
	 *
	 * @param create
	 *        <tt>true</tt> to create the <tt>OutputDataStream</tt> which is to be used to write RTP
	 ...
	 *
	 * @param direction
	 *        Specifies how to configure the data streams of this <tt>AbstractRTPConnector</tt>. The
