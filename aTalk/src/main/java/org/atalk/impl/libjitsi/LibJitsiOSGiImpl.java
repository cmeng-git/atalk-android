...
{
	/**
	 * The <tt>BundleContext</tt> discovered by this instance during its initialization and used to look for registered
	 * services.
	 */
	private final BundleContext bundleContext;

	/**
	 * Initializes a new <tt>LibJitsiOSGiImpl</tt> instance with the <tt>BundleContext</tt> of the <tt>Bundle</tt> which
	 * has loaded the <tt>LibJitsi</tt> class.
	 */
	 ...
	 *
	 * @param bundleContext
	 *        the <tt>BundleContext</tt> to be used by the new instance to look for registered services
	 */
