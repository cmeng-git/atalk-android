	...
	protected <T> T getService(Class<T> serviceClass)
	{
		...
		synchronized (services) {
			if (services.containsKey(serviceClassName)) {
				...
				/*
				 * Do not allow concurrent and/or repeating requests to create an instance of the specified
				 * serviceClass.
				 */
		...
		/*
		 * Allow the service implementation class names to be specified as System properties akin to standard Java class
		 * factory names.
		 */
