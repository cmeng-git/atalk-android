...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>XMLConfigurationStore</tt> class and its instances for
	 * logging output.
	 */
	 ...
	 * @param propertyName
	 * 		a String containing the prefix describing the route to the specified node including
	 * 		its one name
	 * @param props
	 * 		the dictionary object where all properties extracted from this node and its children
	 * 		should be recorded.
	 */
	 ...
	 *
	 * @param doc
	 * 		the XML <tt>Document</tt> where the new entries should be created
	 * @param newProperties
	 * 		the table containing the properties that are to be introduced in the document.
	 */
	 ...
	 * @param isSystem
	 * 		specifies whether this is a system property (system attribute will be set to true).
	 */
	 ...
	 * @param propertyName
	 * 		a String containing the prefix describing the dot-separated route to the specified
	 * 		node including its one name
	 * @param props
	 * 		the dictionary object where the up to date values of the node should be queried.
	 */
	...
	private static class PropertyReference
	{
		 ...
		 *
		 * @param propertyName
		 * 		the name of the system property to be represented by the new instance
		 */
