...
public class ChangeEventDispatcher
{
	...
	/**
	 * Add a VetoableChangeListener to the listener list. The listener is registered for all
	 * properties.
	 *
	 * @param listener
	...
	// throws PropertyVetoException
	{
		...
		synchronized (this) {
			if (vetoableChangeListeners != null) {
				targets = vetoableChangeListeners.toArray(
						new ConfigVetoableChangeListener[vetoableChangeListeners.size()]);
			}
