...
public class SortedProperties extends Properties
{
	...
	public synchronized Object put(Object key, Object value)
	{
		 ...
		 * implementation during testing in which the key was a String composed of null
		 * characters only (which would be trimmed) consumed megabytes of heap. Do now allow such
		  * keys.
		 */
