...
{
	/**
	 * The <tt>HashTable</tt> instance which stores the property name-value associations of this
	 * <tt>ConfigurationStore</tt> instance and which is effectively adapted by this instance to
	 * <tt>ConfigurationStore</tt>.
	 */
	protected final T properties;

	/**
	 * Creates an instance of this class using <tt>properties</tt> as the set of properties where
	 ...
	 * properties which have values associated in this <tt>ConfigurationStore</tt>.
	 *
	 ...
	 * are managed through the <tt>System</tt> class, setting a property as system in this
	 * <tt>ConfigurationStore</tt> effectively removes any existing value associated with the
