 ...
 * properties and their associated values of <tt>ConfigurationServiceImpl</tt> and the format of
 * the configuration file. Thus <tt>ConfigurationServiceImpl</tt> can operate regardless of these
 * specifics and takes care of asking the <tt>VetoableChangeListener</tt>s, converting the
 * property values to the requested types and notifying the <tt>PropertyChangeListener</tt>s.
 *
...
{
	/**
	 * Gets the value in this <tt>ConfigurationStore</tt> of a property with a specific name.
	 *
	 * @param name
	...
	/**
	 * Removes the value association in this <tt>ConfigurationStore</tt> of the property with a
	 * specific name. If the property with the specified name is not associated with a value in
	 * this <tt>ConfigurationStore</tt>, does nothing.
	 *
	 * @param name
