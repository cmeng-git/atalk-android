...
public class AndroidContactQuery extends AbstractContactQuery<AndroidContactSource>
{
	 ...
	 * Selection query
	 */
	private static final String SELECTION = DISPLAY_NAME_COLUMN + " LIKE ?" + " AND "
	...
	private static final String[] PROJECTION = {ContactsContract.Contacts._ID,
			ContactsContract.Contacts.LOOKUP_KEY, DISPLAY_NAME_COLUMN,
			ContactsContract.Contacts.PHOTO_THUMBNAIL_URI, ContactsContract.Contacts.PHOTO_URI,
	...
	private void doQuery()
	{
		...
		Cursor rCursor = ctx.getContentResolver().query(CONTACTS_URI, PROJECTION, SELECTION,
