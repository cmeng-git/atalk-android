...
public class AuthWindowServiceImpl implements AuthenticationWindowService
{
	 ...
	 *        indicates if the user name is editable
	 * @param icon
	 *        the icon to display on the left of the authentication window
	 * @param windowTitle
	 *        customized window title
	 * @param windowText
	 *        customized window text
	 * @param usernameLabelText
	 *        customized username field label text
	 * @param passwordLabelText
	 *        customized password field label text
	 * @param errorMessage
	 *        an error message if this dialog is shown to indicate the user that something went wrong
	 * @param signupLink
	 *        an URL that allows the user to sign up
	 */
	public AuthenticationWindow create(String userName, char[] password, String server, boolean isUserNameEditable, boolean isRememberPassword, Object icon,
		String windowTitle, String windowText, String usernameLabelText, String passwordLabelText, String errorMessage, String signupLink)
	{
		long requestId = System.currentTimeMillis();

		AuthWindowImpl authWindow = new AuthWindowImpl(requestId, userName, password, server, isUserNameEditable, isRememberPassword, windowTitle, windowText,
