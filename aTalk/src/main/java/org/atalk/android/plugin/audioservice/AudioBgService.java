		...
		implements MediaPlayer.OnCompletionListener
{
	...
	{
		Log.e(TAG, "AudioBG started!!");
		ActivityCompat.requestPermissions(aTalkApp.getCurrentActivity(), permissions,
	...
	public void recordAudio()
	{
		...
		try {
			...
			Log.e(TAG, "io problems while recording [" +
			...
			throws IOException
	{
		...
		File mediaStorageDir = new File(Environment
				.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC), "Sound");
