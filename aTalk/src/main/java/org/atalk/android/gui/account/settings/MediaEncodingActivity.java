...
/**
 * Activity allows user to edit audio or video encodings settings and set their priority. The
 * intent starting this activity must be parametrized with:<br/>
 * - {@link #ENC_MEDIA_TYPE_KEY} with {@link MediaType} which specifies if audio or video
 * encoding will be edited<br/>
 * - {@link #EXTRA_KEY_ENC_REG} with {@link EncodingsRegistrationUtil} instance which stores
 * encoding properties<br/>
 * <br/>
 * After activity finishes it's job it return in {@link Intent} the
 * {@link EncodingsRegistrationUtil} under it's key and additional <tt>boolean</tt> flag
 * indicating whether any changes has been made under key:
		...
		implements ActionBarToggleFragment.ActionBarToggleModel
{
	 ...
	 * 		bundle that contains the state or <tt>null</tt> if the <tt>Activity</tt> was just
	 * 		created.
	 */
	 ...
	 *
	 * @param mf
	 * 		{@link MediaFormat} for encoding list row
	 ...
	 *
	 * @param encodings
	 * 		the iterator with <tt>MediaFormat</tt> to be converted into strings.
	 ...
	 *
	 * @param encodings
	 * 		set of <tt>MediaFormat</tt>s from which the one will be selected.
	 * @param str
	 * 		string representation of <tt>MediaFormat</tt>.
	 ...
	 *
	 * @param encodings
	 * 		the set of encodings that will be used.
	 * @param encodingConfig
	 * 		encodings configuration that stores priorities.
	 ...
	 *
	 * @param encodingConf
	 * 		configuration that will store encodings priorities.
	 * @param mediaType
	 * 		audio or video media type that was edited.
	 * @param encFragment
	 * 		the fragment which edited encodings priorities.
	 */
