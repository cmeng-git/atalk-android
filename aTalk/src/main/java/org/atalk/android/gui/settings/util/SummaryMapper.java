 ...
 * registered to the {@link SharedPreferences} instance containing preferences we want handle. Single instance can map
 * multiple {@link Preference} at one time.
 *
 * @author Pawel Domas
 */
public class SummaryMapper implements SharedPreferences.OnSharedPreferenceChangeListener
{
	...
	/**
	 * Mapping containing optional {@link SummaryConverter} that can provide custom operation on the value before it is
	 * applied as a summary.
	 */
	 ...
	 *
	 * @param pref
	 *        the {@link Preference} to be included
	 * @param empty
	 *        optional empty String that will be set when the <tt>Preference</tt> value is <tt>null</tt> or empty
	 * @param converter
	 *        optional {@link SummaryConverter}
	 *
	 ...
	 *
	 * @param sharedPrefs
	 *        the {@link SharedPreferences} that manages the <tt>preference</tt>
	 * @param preference
	 */
	...
	public interface SummaryConverter
	{
		 ...
		 *
		 * @param input
		 *        {@link Preference} value as a <tt>String</tt>
