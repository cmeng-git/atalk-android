...
import org.atalk.android.gui.util.event.*;
		...
		ServiceListener, AvatarListener
{
	 ...
	 *
	 * @param accountID
	 * 		the {@link AccountID} that will be encapsulated by this class
	 * @param context
	 * 		the {@link BundleContext} of parent {@link OSGiActivity}
	 ...
	 * 		if not <tt>null</tt> all listeners are registered otherwise listeners are unregistered
	 * 		from current
	 ...
	 *
	 * @param listener
	 * 		the {@link EventListener} that listens for changes on this {@link Account} object
	 */
	 ...
	 *
	 * @param listener
	 * 		the {@link EventListener} that doesn't want to be notified about the changes to this
	...
	{
		logger.trace("Provider registration notification");
