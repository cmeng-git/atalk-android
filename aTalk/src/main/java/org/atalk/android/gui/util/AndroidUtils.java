...
public class AndroidUtils
{
	 ...
	 *
	 * @param context
	 * 		the android <tt>Context</tt>
	 * @param titleId
	 * 		the title identifier in the resources
	 * @param messageId
	 * 		the message identifier in the resources
	 */
	 ...
	 * @param listener
	 * 		the <tt>DialogInterface.DialogListener</tt> to attach to the confirm button
	 */
	public static void showAlertConfirmDialog(Context context, final String title,
			final String message, final String button,
	 ...
	 * 		the message
	 */
	public static void showAlertDialog(final Context context, final String title,
	 ...
	 *
	 * @param appContext
	 * 		the <tt>Context</tt> that will be used to create new activity from notification
	 * 		<tt>Intent</tt>.
	 */
	 ...
	 * 		the message
	 * @param date
	 * 		the date on which the event corresponding to the notification happened
	 */
	 ...
	 * 		the Android context
	 * @param activityClass
	 * 		the activity class to check
	 * @return <tt>true</tt> if the activity given by the class is running, <tt>false</tt> -
	 * otherwise
	 */
