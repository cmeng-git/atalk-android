...
public class AccountPreferencesActivity extends OSGiActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (savedInstanceState == null) {
			...
			preferencesFragment = (AccountPreferenceFragment) getFragmentManager()
	 ...
	 * @param protocolName
	 * 		protocol name for which the impl fragment will be created.
	 * @return impl preference fragment for given <tt>userUniqueID</tt> and <tt>protocolName</tt>.
	 */
	private AccountPreferenceFragment createPreferencesFragment(String userUniqueID,
			String protocolName)
	{
	 ...
	 * 		the context.
	 * @param accountID
	 * 		<tt>AccountID</tt> for which preferences will be opened.
	 * @return <tt>Intent</tt> for starting account preferences activity parametrized with given
	 * <tt>AccountID</tt>.
	 */
