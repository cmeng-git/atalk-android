...
public class InvitationReceivedDialog extends Dialog
{
	 ...
	 * 		invitation
	 * @param invitation
	 * 		the invitation that this dialog represents
	 */
	public InvitationReceivedDialog(Context context,
	 ...
	 * 		the operation set that would handle the rejection if the user choose to reject the
	 * 		invitation
	 * @param invitationAdHoc
	 * 		the invitation that this dialog represents
	 */
	public InvitationReceivedDialog(Context mContext,
			ConferenceChatManager multiUserChatManager,
	...
	private void onRejectClicked()
	{
		...
		if (mMultiUserChatAdHocOpSet == null && mInvitationAdHoc == null)
			AndroidGUIActivator.getMUCService().rejectInvitation(mMultiUserChatOpSet,
					mInvitation, reasonField);
		else {
			mMultiUserChatManager.rejectInvitation(mMultiUserChatAdHocOpSet,
					mInvitationAdHoc, reasonField);
		}
	}
