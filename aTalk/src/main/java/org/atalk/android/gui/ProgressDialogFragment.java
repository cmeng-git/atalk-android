...
public class ProgressDialogFragment extends OSGiFragment
{
	 ...
	 *        dialog's title
	 * @param message
	 *        the message to be displayed next to the progress bar.
	...
	public static long showProgressDialog(String title, String message)
	{
		...
		return DialogActivity.showCustomDialog(aTalkApp.getGlobalContext(), title, ProgressDialogFragment.class.getName(), args, null, null, extras);
	}
}
