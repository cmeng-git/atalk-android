...
public class PresenceFilter implements ContactListFilter
{
	 ...
	 *
	 * @param filterQuery
	 *        the query which keeps track of the filtering results
	 */
...
//		}
		...
		query.fireQueryEvent(query.isCanceled() ? MetaContactQueryStatusEvent.QUERY_CANCELED
	 ...
	 *
	 * @param isShowOffline
	 *        indicates if offline contacts are shown
	 */
	 ...
	 *
	 * @param metaGroup
	 *        the <tt>MetaContactGroup</tt>, which matching contacts to add
	 * @param query
	 *        the <tt>MetaContactQuery</tt> that notifies interested listeners of the results of this matching
	 * @param resultCount
	 *        the initial result count we would insert directly to the contact list without firing events
	 */
