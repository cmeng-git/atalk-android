...
public class VideoHandlerFragment extends OSGiFragment
{
	 ...
	 *
	 * @param callVideoButton
	 * 		local video button <tt>View</tt>.
	 */
	 ...
	 *
	 * @param enable
	 * 		flag indicating local video status to be set.
	 */
	 ...
	 *
	 * @param callPeer
	 * 		the <tt>CallPeer</tt> to which we add a video listener
	 */
	...
	private void initRemoteVideo(CallPeer callPeer)
	{
		...
		if (pps != null) {
			OperationSetVideoTelephony osvt = pps.getOperationSet(OperationSetVideoTelephony
					.class);
	 ...
	 * @param event
	 * 		the <tt>VideoEvent</tt> that notified us
	 */
	 ...
	 * 		the remote video <tt>Component</tt> if available or <tt>null</tt> otherwise.
	 * @param scve
	 * 		the <tt>SizeChangeVideoEvent</tt> event if was supplied.
	 */
			...
			final SizeChangeVideoEvent scve)
	{
		...
		runOnUiThread(new Runnable()
		{
			public void run()
			{
				View view = (remoteVideoAccessor != null)
						? remoteVideoAccessor.getView(mActivity) : null;
				Dimension preferredSize = selectRemotePreferredSize(visualComponent, view, scve);
				logger.info("Remote video size: " + preferredSize.getWidth() + " x "
	 ...
	 *
	 * @param visualComponent
	 * 		remote video <tt>Component</tt>, <tt>null</tt> if not available
	 * @param remoteVideoView
	 * 		the remote video <tt>View</tt> if already created, or <tt>null</tt> otherwise
	 * @param scve
	 * 		the <tt>SizeChangeVideoEvent</tt> if was supplied during event handling or
	 ...
	 *
	 * @param remoteVideoView
	 * 		the remote video <tt>View</tt> if available or <tt>null</tt> otherwise.
	 * @param preferredSize
	 * 		preferred size of remote video <tt>View</tt>.
	 */
