 ...
 */
package org.atalk.android.gui.chatroomslist.joinforms;

import net.java.sip.communicator.service.muc.ChatRoomProviderWrapper;

/**
 * The <tt>NewChatRoom</tt> is meant to be used from the <tt>JoinChatRoomWizard</tt>, to collect information concerning the chat room to
 * join.
 *
