...
public class AndroidUIServiceImpl implements UIService
{
	 ...
	 * 		default security authority that will be used.
	 */
	 ...
	 *
	 * @param visible
	 * 		if <code>true</code>, shows the main application window; otherwise, hides the main
	 * 		application window.
	 * @see #isVisible()
	 */
	@Override
	 ...
	 *
	 * @param exitOnClose
	 * 		When TRUE, the user could exit the application by simply closing the main application
	 ...
	 *
	 * @param windowID
	 * 		One of the WINDOW_XXX WindowID-s.
	 * @return the window to be shown.
	 * @throws IllegalArgumentException
	 * 		if the specified <tt>windowID</tt> is not recognized by the implementation (note that
	 ...
	 * 		One of the WINDOW_XXX WindowID-s.
	 * @param params
	 * 		The parameters to be passed to the returned exported window.
	 * @return the window to be shown.
	 * @throws IllegalArgumentException
	 * 		if the specified <tt>windowID</tt> is not recognized by the implementation (note that
	 * 		implementations MUST properly handle all WINDOW_XXX ID-s.
	 ...
	 *
	 * @param contact
	 * 		the <tt>Contact</tt> for which the searched chat is about.
	 ...
	 *
	 * @param chatRoom
	 * 		the <tt>ChatRoom</tt> for which the searched chat is about.
	 ...
	 *
	 * @param chat
	 * 		The chat to get the MetaContact from
	 ...
	 * 		the <tt>ProtocolProviderService</tt> for which the authentication window is about.
	 ...
	 *
	 * @param windowID
	 * 		one of the <tt>WindowID</tt>-s, defined in the <tt>ExportedWindow</tt> interface.
	...
	/**
	 * Returns the <tt>WizardContainer</tt> for the current UIService implementation. The
	 * <tt>WizardContainer</tt> is meant to be
	 * implemented by the UI service implementation in order to allow other modules to add to the
	 * GUI <tt>AccountRegistrationWizard</tt> s.
	 * Each of these wizards is made for a given protocol and should provide a sequence of user
	 * interface forms through which the user could
	 * register a new account.
	 *
	 * @return Returns the <tt>AccountRegistrationWizardContainer</tt> for the current UIService
	 * implementation.
	 */
	@Override
	 ...
	 *
	 * @param containderID
	 * 		One of the CONTAINER_XXX Container-s.
	...
	/**
	 * Returns the <tt>ConfigurationContainer</tt> associated with this <tt>UIService</tt>.
	 *
	 * @return the <tt>ConfigurationContainer</tt> associated with this <tt>UIService</tt>
	 */
	@Override
	 ...
	 *
	 * @param participants
	 * 		an array of <tt>String</tt> values specifying the participants to be included into the
	 ...
	 * 		newly created <tt>Chat</tt>
	 * @param isSmsEnabled
	 * 		whether sms option should be enabled if possible
	 */
	@Override
	 ...
	 *
	 * @param clContainer
	 * 		the parent contact list container
	 ...
	 *
	 * @param chatRoomId
	 * 		the chat room id of the chat room associated with the dialog
	 * @param pps
	 * 		the protocol provider service of the chat room
	 */
	@Override
