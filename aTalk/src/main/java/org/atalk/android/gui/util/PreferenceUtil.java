...
public class PreferenceUtil
{
	 ...
	 * 
	 * @param screen
	 *        the <tt>PreferenceScreen</tt> containing the <tt>CheckBoxPreference</tt> we want to edit.
	 * @param prefKey
	 *        preference key id from <tt>R.string</tt>.
	 * @param isChecked
	 *        the value we want to set to the "checked" property of <tt>CheckBoxPreference</tt>.
	 */
	 ...
	 * 
	 * @param screen
	 *        the <tt>PreferenceScreen</tt> containing the <tt>EditTextPreference</tt> we want to edit.
	 * @param prefKey
	 *        preference key id from <tt>R.string</tt>.
	 * @param txtValue
	 *        the text value we want to set on <tt>EditTextPreference</tt>
	 */
	 ...
	 * 
	 * @param screen
	 *        the <tt>PreferenceScreen</tt> containing the <tt>ListPreference</tt> we want to edit.
	 * @param prefKey
	 *        preference key id from <tt>R.string</tt>.
	 * @param value
	 *        the value we want to set on <tt>ListPreference</tt>
	 */
