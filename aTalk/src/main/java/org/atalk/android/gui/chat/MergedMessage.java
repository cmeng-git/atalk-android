...
public class MergedMessage implements ChatMessage
{
	 ...
	 *
	 * @param rootMsg
	 * 		the rootMessage message for this merged instance.
	 */
	 ...
	 *
	 * @param newMsg
	 * 		new message to check if it is a correction for any of merged messages.
	...
	public boolean isConsecutiveMessage(ChatMessage nextMsg)
	{
		return ((findCorrectedMessage(nextMsg) != null)
				|| (rootMessage.isConsecutiveMessage(nextMsg)));
	}
