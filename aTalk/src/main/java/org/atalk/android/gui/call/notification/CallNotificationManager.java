...
public class CallNotificationManager
{
	 ...
	 *        the Android context.
	 * @param callID
	 *        the ID of call that will be used. The ID is managed by {@link CallManager}.
	 */
	public synchronized void showCallNotification(Context ctx, final String callID)
	{
		...
		NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(ctx).setWhen(System.currentTimeMillis()).setSmallIcon(R.drawable.ic_notification);
	 ...
	 *        Android context.
	 * @param contentView
	 *        notification root <tt>View</tt>.
	 * @param callID
	 *        the call ID that will be used in the <tt>Intents</tt>
	 */
	 ...
	 * 
	 * @param callId
	 *        the ID of the call managed by {@link CallManager}.
	 */
	 ...
	 * 
	 * @param callID
	 *        the ID of a call managed by {@link CallManager}.
