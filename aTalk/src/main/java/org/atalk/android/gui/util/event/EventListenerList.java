...
/**
 * Utility class to that stores the list of {@link EventListener}s. Provides add/remove and notify all operations.
 * 
 * @param <T>
...
public class EventListenerList<T>
{
	 ...
	 *
	 * @param listener
	 *        the {@link EventListener} that will be added to the list
	 */
	 ...
	 *
	 * @param listener
	 *        the {@link EventListener} that will be removed from the list
	 */
