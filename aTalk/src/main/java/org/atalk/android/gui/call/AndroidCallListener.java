...
public class AndroidCallListener implements CallListener, CallChangeListener
{
	 ...
	 *
	 * @param evt
	 *        the <tt>CallEvent</tt> this <tt>CallListener</tt> is being notified about
	 */
	 ...
	 *
	 * @param evt
	 *        the <tt>CallEvent</tt> that notified us
	 */
	 ...
	 * 
	 * @param evt
	 *        the <tt>CallChangeEvent</tt> that describes missed call.
	 */
	private void fireMissedCallNotification(CallChangeEvent evt)
	{
		NotificationService notificationService = ServiceUtils.getService(AndroidGUIActivator.bundleContext,
