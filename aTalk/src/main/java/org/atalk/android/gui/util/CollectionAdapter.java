 ...
 *
 * @param <T>
 *        class of the elements contained in this adapter
 *
 * @author Pawel Domas
 */
public abstract class CollectionAdapter<T> extends BaseAdapter
{
	 ...
	 *
	 * @param iterator
	 *        source of {@link T} instances that will be contained in this {@link CollectionAdapter}
	 */
	 ...
	 *
	 * @param collection
	 *        the {@link List} that will be included in this {@link CollectionAdapter}
	 */
	 ...
	 *
	 * @param i
	 *        the index of {@link T} that will be retrieved
	 ...
	 *
	 * @param object
	 *        instance of {@link T} that will be added to this adapter
	 */
	 ...
	 * @param object
	 *        the object to insert into adapter's list.
	 */
	 ...
	 *
	 * @param object
	 *        instance of {@link T} that will be removed from the adapter
	 */
	 ...
	 *
	 * @param isDropDown
	 *        <tt>true</tt> if the <tt>View</tt> should be created for drop down spinner item
	 * @param item
	 *        the item for which a new View shall be created
	 * @param parent
	 *        {@link ViewGroup} parent View
	 * @param inflater
	 *        the {@link LayoutInflater} for creating new Views
	 *
