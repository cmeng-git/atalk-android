...
public class AdHocChatRoomList
{
	 ...
	 * Removes the corresponding server and all related ad-hoc chat rooms from this list.
	 *
	 * @param adHocChatRoomProvider
	 * 		the <tt>AdHocChatRoomProviderWrapper</tt> corresponding to the server to remove
	 */
	 ...
	 * 		the <tt>AdHocChatRoom</tt> to add
	 */
	 ...
	 *
	 * @param adHocChatRoomWrapper
	 * 		the <tt>AdHocChatRoomWrapper</tt> to remove
	 */
