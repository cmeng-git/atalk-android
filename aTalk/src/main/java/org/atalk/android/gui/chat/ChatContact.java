...
public abstract class ChatContact<T>
{
	 ...
	 *
	 * @param descriptor
	 * 		the descriptor to be adapted by the new instance
	 */
	 ...
	 *
	 * @param obj
	 * 		the <tt>Object</tt> to be checked for value equality with this <tt>ChatContact</tt>
	...
	public boolean equals(Object obj)
	{
		...
		/*
		 * ChatContact is an adapter so two ChatContacts of the same runtime type with equal
	 ...
	 *
	 * @return an array of bytes which represents the avatar image corresponding to the source
	 * contact
	 */
	protected abstract byte[] getAvatarBytes();

	/**
	 * Returns the descriptor object corresponding to this chat contact. In the case of single
	 * chat this could be the <tt>MetaContact</tt> and in the case of conference chat this could
	 * be the <tt>ChatRoomMember</tt>.
	 *
