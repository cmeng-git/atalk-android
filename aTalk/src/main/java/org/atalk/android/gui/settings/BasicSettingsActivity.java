...
/**
 * Base class for settings screens which only adds preferences from XML resource. By default
 * preference resource id is obtained from <tt>Activity</tt> meta-data,
 * resource key: "android.preference".
 *
 * @author Pawel Domas
 */
