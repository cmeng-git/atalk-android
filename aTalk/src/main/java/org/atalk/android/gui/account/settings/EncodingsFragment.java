...
{
	/**
	 * Argument key for list of encodings as strings (see {@link EncodingActivity} for utility methods.)
	 */
	 ...
	 *
	 * @param from
	 *        index indicating source position
	 * @param to
	 *        index indicating destination position
	 */
	 ...
	 *
	 * @param idx
	 *        the index of encoding on the list
