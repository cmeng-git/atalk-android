...
/**
 * The dialog that displays a list of security protocols in {@link SecurityActivity}. It allows user to enable/disable
 * each protocol and set their priority.
 */
public class SecProtocolsDialogFragment extends DialogFragment
{
	 ...
	 *
	 * @param securityReg
	 *        the registration object that will hold new security preferences
	 */
