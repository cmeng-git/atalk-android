...
public class NotificationsTableSettings extends OSGiActivity implements NotificationChangeListener
{
	 ...
	 *
	 * @param enableColumnButton
	 *        the button that enables whole event.
	 */
	...
	public void onPopupItemClicked(View v)
	{
		...
		PopupMessageNotificationAction popupAction = (PopupMessageNotificationAction) notificationService.getEventNotificationAction(eventType,
	 ...
	 * 
	 * @param v
	 *        the sound notification checkbox
	 */
	public void onSoundNotificationItemClicked(View v)
	{
		...
		SoundNotificationAction soundNotificationAction = (SoundNotificationAction) notificationService.getEventNotificationAction(eventType,
			NotificationAction.ACTION_SOUND);
	...
	public void onSoundPlaybackItemClicked(View v)
	{
		...
		SoundNotificationAction soundPlaybackAction = (SoundNotificationAction) notificationService.getEventNotificationAction(eventType,
			NotificationAction.ACTION_SOUND);
