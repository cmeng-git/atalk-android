...
public class ChatPagerAdapter extends FragmentStatePagerAdapter implements ChatListener
{
	 ...
	 *
	 * @param fm
	 * 		the parent <tt>FragmentManager</tt>
	 */
	 ...
	 *
	 * @param pos
	 * 		the position of the chat we're looking for
	 ...
	 *
	 * @param container
	 * 		the parent <tt>ViewGroup</tt>
	 * @param position
	 * 		the position in the <tt>ViewGroup</tt>
	...
	public void setPrimaryItem(ViewGroup container, int position, Object object)
	{
		 ...
		 * many times with the same parameter, so we keep track of last item and notify only on
		 * changes.
		 *
