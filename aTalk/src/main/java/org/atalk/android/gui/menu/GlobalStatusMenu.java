...
public class GlobalStatusMenu implements OnDismissListener
{
	...
	{
		public abstract void onItemClick(GlobalStatusMenu source, int pos, int actionId);
	}
	 ...
	 * @param onTop
	 *        flag to indicate where the popup should be displayed. Set TRUE if displayed on top of anchor view and vice
	 *        versa
	 */
