...
/**
 * The <tt>AccountLoginFragment</tt> is used for creating new account, but can be also used to
 * obtain user credentials. In order to do that parent <tt>Activity</tt> must implement
 * {@link AccountLoginListener}.
 *
...
public class AccountLoginFragment extends OSGiFragment
{
	 ...
	 *        the <tt>ProtocolProviderService</tt>, corresponding to the account to store
	 */
	...
	public interface AccountLoginListener
	{
		 ...
		 * 
		 * @param userName
		 *        the login account entered by the user.
		 * @param password
