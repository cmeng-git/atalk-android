...
public class AndroidLoginRenderer implements LoginRenderer
{
	 ...
	 * 		the protocol provider for which we add the user interface
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the protocol provider to remove
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the protocol provider for which we add the connecting user interface
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the protocol provider for which we remove the connecting user interface
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the <tt>ProtocolProviderService</tt> corresponding to the connected account
	 * @param date
	 * 		the date/time at which the account has connected
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the <tt>ProtocolProviderService</tt>, which connection failed
	 * @param loginManagerCallback
	 * 		the <tt>LoginManager</tt> implementation, which is managing the process
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the specific <tt>ProtocolProviderService</tt>, for which we're obtaining a security
	 * 		authority
	 ...
	 *
	 * @param protocolProvider
	 * 		the <tt>ProtocolProviderService</tt>, which related user interface we're looking for
