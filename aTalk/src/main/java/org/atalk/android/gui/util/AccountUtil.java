...
public class AccountUtil
{
	 ...
	 *
	 * @param context
	 *        {@link Context} of current {@link android.app.Activity}
	 * @param protocolName
	...
	static public Drawable getDefaultPresenceIcon(Context context, String protocolName)
	{
		if (protocolName.equals(ProtocolNames.SIP)) {
			return new BitmapDrawable(BitmapFactory
					.decodeResource(context.getResources(), R.drawable.default_sip_status));
		}
		else if (protocolName.equals(ProtocolNames.JABBER)) {
			return new BitmapDrawable(BitmapFactory
					.decodeResource(context.getResources(), R.drawable.default_jabber_status));
		}
