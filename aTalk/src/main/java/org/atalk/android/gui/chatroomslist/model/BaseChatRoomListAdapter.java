...
public abstract class BaseChatRoomListAdapter extends BaseExpandableListAdapter
{
	 ...
	 *
	 * @param crlFragment
	 * 		the parent <tt>ChatRoomListFragment</tt>
	 */
	 ...
	 *
	 * @param groupIndex
	 * 		index of the chatRoomWrapper group.
	 ...
	 * @param chatRoomIndex
	 * 		the index of the chatRoomWrapper to update
	 */
	 ...
	 * 		the index of the group to update
	 * @param chatRoomIndex
	 * 		the index of the chatRoom to update
	 * @param chatRoomWrapper
	 * 		ChatRoomWrapper implementation object instance
	 */
	 ...
	 * @param chatRoomIndex
	 * 		the index of the child chatRoom
