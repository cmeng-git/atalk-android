		...
		implements ChatRoomProviderWrapperListener, ChatRoomListChangeListener, UIGroupRenderer
{
	 ...
	 *
	 * @param groupPosition
	 * 		the index of the mCrpWrapperGroup
	 */
	@Override
	 ...
	 *
	 * @param group
	 * 		the mCrpWrapperGroup for which we need the index.
	 ...
	 *
	 * @param groupIndex
	 * 		index of mCrpWrapperGroup we want to search.
	 * @param chatRoomWrapper
	 * 		the <tt>ChatRoomWrapper</tt> to find inside the mCrpWrapperGroup.
	 ...
	 *
	 * @param groupPosition
	 * 		the index of the mCrpWrapperGroup, which children we would like to count
	 */
	@Override
	 ...
	 *
	 * @param providers
	 * 		the providers mCrpWrapperGroup, which child mCrWrapperList to add
	 */
	 ...
	 *
	 * @param crpWrapper
	 * 		the <tt>chatRoomProviderWrapper</tt> to be removed
	 */
	 ...
	 *
	 * @param crpWrapperGroup
	 * 		the parent ChatRoomProviderWrapper Group of the child ChatRoomWrapper to add
	 * @param crWrapper
	 * 		the <tt>ChatRoomWrapper</tt> to add
	 */
	 ...
	 *
	 * @param providers
	 * 		the <tt>ChatRoomProviderWrapper</tt>, which content we'd like to remove
	 */
	 ...
	 *
	 * @param crpWrapper
	 * 		the parent <tt>ChatRoomProviderWrapper</tt> of the ChatRoomWrapper to remove
	 * @param crWrapper
	 ...
	 *
	 * @param chatRoomWrapper
	 * 		the <tt>chatRoomWrapper</tt> to check
	 * @param query
	 * 		the query string i.e. chatRoomID to check for matches. A null always return true
	 ...
	 *
	 * @param chatRoomProviderWrapper
	 * 		the <tt>ChatRoomProviderWrapper</tt> to check
	 * @param query
	 * 		the query string i.e. accountUuid to check for matches. A null will always return true
	...
	public void contentChanged(ChatRoomListChangeEvent evt)
	{
		...
		switch (evt.getEventID()) {
			...
			case ChatRoomListChangeEvent.CHAT_ROOM_REMOVED:
				...
				String msg = aTalkApp.getResString(R.string.service_gui_CHATROOM_DESTROYED,
