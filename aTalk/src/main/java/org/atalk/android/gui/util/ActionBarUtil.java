...
public class ActionBarUtil
{
	 ...
	 * @param subtitle
	 * 		the subtitle string to set
	 */
	public static void setSubtitle(Activity activity, String subtitle)
	{
		TextView statusText = (TextView) activity.getActionBar().getCustomView().findViewById(R.id.actionBarStatusText);
	 ...
	 *
	 * @param activity
	 * 		the <tt>Activity</tt>, for which we get the action bar title
	 * @param statusIcon
	 * 		display Icon per the user status
	 */
	public static void setStatus(Activity activity, byte[] statusIcon)
	{
		...
		if (actionBar != null) {
			...
			if (avatarStatusBmp != null) {
				ImageView actionBarStatus = (ImageView) activity.getActionBar()
						.getCustomView().findViewById(R.id.globalStatusIcon);
	 ...
	 *
	 * @param activity
	 * 		the current activity where the status should be displayed
	 * @param avatar
	...
	private static LayerDrawable getDefaultAvatarDrawable(Activity activity)
	{
		...
		return (LayerDrawable) activity.getResources()
