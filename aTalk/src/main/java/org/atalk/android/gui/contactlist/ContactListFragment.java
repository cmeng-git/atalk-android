		...
		implements OnChildClickListener, OnGroupClickListener
{
	 ...
	 *
	 * @param menu
	 * 		the menu to inflate when long press on contact item.
	 * @param inflater
	 * 		the menu inflater.
	 * @param group
	 * 		clicked group index.
	 ...
	 *
	 * @param contact
	 * 		the contact for which we request authorization
	 */
	 ...
	 *
	 * @param descriptor
	 * 		<tt>MetaContact</tt> for which chat activity will be started.
	 */
