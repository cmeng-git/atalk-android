 ...
 *         The main <tt>Activity</tt> for aTalk application with pager slider for both contact
 *         and chatRoom list windows.
 */
public class aTalk extends MainMenuActivity
		implements EntityListHelper.TaskCompleted
{
	/**
	 * The logger
	 */
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// Checks if OSGi has been started and if not starts LauncherActivity which
		// will restore this Activity from its Intent.
		...
		if (isAndroidM && permissionRequest) {
	 ...
	 *
	 * @param intent
	 * 		<tt>Activity</tt> <tt>Intent</tt>.
	 * @param instanceState
	 * 		<tt>Activity</tt> instance state.
	 */
