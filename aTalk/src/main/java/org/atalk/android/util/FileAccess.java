...
public class FileAccess
{
	 ...
	 * @param targetDirPath
	 * 		the full path of the target directory to which the file or directory should be copied
	 * @param newName
	 ...
	 * 		if unable to create the new file or directory specified by destination path
	 * @throws IOException
	 * 		if an attempt is made to copy the contents of a directory into itself, or if the
