...
public class JetSecurityImpl extends JingleSecurity<JetSecurity> {
    ...
    public JetSecurityImpl(JetSecurity element) {
        super();
    ...
    public JetSecurityImpl(JingleEnvelopeManager envelopeManager, FullJid recipient, String contentName, String cipherName)
    ...
    public JetSecurity getElement() {
        return new JetSecurity(contentName, cipherName, child);
    }

    @Override
    public Jingle handleSecurityInfo(JingleContentSecurityInfo element, Jingle wrapping) {
        return null;
    }
