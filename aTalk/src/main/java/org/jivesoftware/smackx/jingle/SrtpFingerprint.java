...
public class SrtpFingerprint extends AbstractXmlElement
{
     ...
     */
    public SrtpFingerprint(Builder build)
    {
        super(build);
    }
    ...
    /**
     * Returns value of 'setup' attribute. See {@link #ATTR_SETUP} for more info.
     */
    ...
    /**
     * Builder for SrtpEncryption. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the SrtpEncryption.
     */
