...
public abstract class JingleTransport<D extends JingleContentTransport>
{
    ...
    public abstract void establishIncomingBytestreamSession(XMPPConnection connection, JingleTransportCallback callback, JingleSessionImpl session)
            throws SmackException.NotConnectedException, InterruptedException;

    public abstract void establishOutgoingBytestreamSession(XMPPConnection connection, JingleTransportCallback callback, JingleSessionImpl session)
            throws SmackException.NotConnectedException, InterruptedException;
    ...
    public abstract void handleSessionAccept(JingleContentTransport transportElement, XMPPConnection connection);
}
