...
/**
 * Implements <code>ExtensionElement</code> for the "transferred" element defined by:
...
public class SdpTransferred extends AbstractXmlElement
{
    ...
    /**
     * Builder for SdpTransferred. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the SdpTransferred.
     */
