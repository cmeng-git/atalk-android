...
public class RtpHeader extends AbstractXmlElement
{
     ...
     */
    public RtpHeader(Builder build)
    {
        super(build);
    }
...
//    /**
//     * Creates a deep copy of a {@link PayloadType}.
//     *
//     * @param source the {@link PayloadType} to copy.
//     * @return the copy.
//     */
//    public static RtpHeader clone(RtpHeader source)
//    {
//        RtpHeader destination = RtpHeader.clone(source);
//
...
//        String attributes = source.getExtAttributes();
//        if (attributes != null) {
//            destination.setExtAttributes(attributes);
//        }
//        return destination;
//    }
    ...
    /**
     * Builder for RtpHeader. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the RtpHeader.
     */
