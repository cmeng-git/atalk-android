...
public class SessionInfo extends AbstractXmlElement
{
     ...
     */
    public SessionInfo(Builder build)
    {
        super(build);
    }
    ...
    /**
     * Builder for SessionInfo. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the SessionInfo.
     */
