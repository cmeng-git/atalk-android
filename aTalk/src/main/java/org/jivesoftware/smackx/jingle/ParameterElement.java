...
public class ParameterElement extends AbstractXmlElement
{
     ...
     * Default to use RtpDescription.NAMESPACE, to be modified in:
     ...
     */
    public ParameterElement(Builder build)
    {
        super(build);
    }
    ...
    /**
     * Builder for ParameterElement. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the ParameterElement.
     */
