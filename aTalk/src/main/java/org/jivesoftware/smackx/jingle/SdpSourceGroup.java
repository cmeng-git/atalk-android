...
public class SdpSourceGroup extends AbstractXmlElement
{
     ...
     */
    public SdpSourceGroup(Builder build)
    {
        super(build);
    }
    ...
    /**
     * Builder for SdpSourceGroup. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the SdpSourceGroup.
     */
