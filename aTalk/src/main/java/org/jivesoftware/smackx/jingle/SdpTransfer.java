...
/**
 * Implements <code>ExtensionElement</code> for the "transfer" element defined by:
...
public class SdpTransfer extends AbstractXmlElement
{
     ...
     */
    public SdpTransfer(Builder build)
    {
        super(build);
    }
    ...
    /**
     * Builder for SdpTransfer. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the SdpTransfer.
     */
