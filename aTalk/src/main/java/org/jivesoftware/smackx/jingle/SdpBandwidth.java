...
public class SdpBandwidth extends AbstractXmlElement
{
     ...
     */
    public SdpBandwidth(Builder build)
    {
        super(build);
    }
    ...
    /**
     * Builder for SdpBandwidth. Use {@link AbstractXmlElement#builder()} to
     * obtain a new instance and {@link #build} to build the SdpBandwidth.
     */
