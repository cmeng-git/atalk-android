/*
 * Java OTR library Copyright (C) 2008-2009 Ian Goldberg, Muhaimeen Ashraf, Andrew Chung, Can Tang
 * 
 * This library is free software; you can redistribute it and/or modify it under the terms of
 * version 2.1 of the GNU
...
public class SM
{
	 ...
	 * 		the prefix to use
	 * @param a
	 * 		The 1st BigInteger to hash.
	 * @param b
	 * 		The 2nd BigInteger to hash.
	 * @return the BigInteger for the resulting hash value.
	 * @throws net.java.otr4j.crypto.SM.SMException
	 * 		when the SHA-256 algorithm is missing or when the bigInteger can't be serialized.
	 */
	 ...
	 * @param version
	 * 		the prefix to use for the hashing function
	 * @return c and d.
	 * @throws SMException
	 * 		when c and d could not be calculated
	 */
