...
public class ThumbnailElement
{
	 ...
	 *
	 * @param serverAddress
	 *        the Jabber address of the destination contact
	 * @param thumbnailData
	 *        the byte array containing the thumbnail data
	 * @param mimeType
	 ...
	 *
	 * @param buff
	 *        the <tt>StringBuffer</tt> to add the attribute and value to.
	 * @param attrName
	 *        the name of the thumbnail attribute that we're adding.
	 * @param attrValue
	 *        the value of the attribute we're adding to the XML buffer.
