...
public class MetaContactEvent extends EventObject
{
	...
	/**
	 * Indicates that the MetaContactEvent instance was triggered by the removal of an existing
	 * MetaContact.
	 */
	public static final int META_CONTACT_REMOVED = 2;

	/**
	 * Indicates that the MetaContactEvent instance was triggered by moving an existing
	 * MetaContact.
	 */
	 ...
	 * @param parentGroup
	 * 		the MetaContactGroup under which the corresponding MetaContact is located
	 * @param eventID
	 * 		one of the METACONTACT_XXX static fields indicating the nature of the event.
	 */
	public MetaContactEvent(MetaContact source, MetaContactGroup parentGroup, int eventID)
	{
		super(source);
	...
	{
		StringBuilder buff = new StringBuilder("MetaContactEvent-[ ContactID=");
	...
	/**
	 * Returns an event id specifying whether the type of this event (e.g. METACONTACT_ADDED,
	 * METACONTACT_REMOVED and etc.)
	 *
