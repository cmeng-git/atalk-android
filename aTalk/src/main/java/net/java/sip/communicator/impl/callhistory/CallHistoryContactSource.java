...
public class CallHistoryContactSource implements ContactSourceService
{
	...
	public String getDisplayName()
	{
		return CallHistoryActivator.getResources()
				.getI18NString("gui.CALL_HISTORY_GROUP_NAME");
	}
			...
			implements ContactQuery
	{
		 ...
		 *
		 * @param callRecords
		 * 		the list of call records, which are the result
		 * 		of this query
		 */
		 ...
		 *
		 * @param callHistoryQuery
		 * 		the query used to track the call history
		 */
		 ...
		 *
		 * @param l
		 * 		the <tt>ContactQueryListener</tt> to remove
		 */
		 ...
		 *
		 * @param contact
		 * 		the <tt>SourceContact</tt> this event is about
		 */
