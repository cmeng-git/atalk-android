	...
	Comparable<CandidatePacketExtension>
{
	...
	/**
	 * Creates a new {@link CandidatePacketExtension} with the specified <tt>elementName</tt> so
	 * that this class would be usable as a <tt>RemoteCandidatePacketExtension</tt> parent.
	 *
	 * @param elementName
	 ...
	 *
	 * @param generation
	 *        this candidate's generation index.
	 */
	...
	/**
	 * Compares this instance with another CandidatePacketExtension by preference of type: host <
