...
public class LoggingUtilsActivator implements BundleActivator {
	 ...
	 * 		OSGI bundle context
	 * @throws Exception
	 * 		if error creating configuration.
	 */
	...
	public static ResourceManagementService getResourceService() {
		if (resourceService == null) {
			...
			resourceService =
					(ResourceManagementService) bundleContext.getService(resourceReference);
		}
	...
	public static PacketLoggingService getPacketLoggingService() {
		if (packetLoggingService == null) {
			ServiceReference confReference
					= bundleContext.getServiceReference(PacketLoggingService.class.getName());
	...
	/** (cmeng: for android)
	 * Returns a reference to a FileAccessService implementation currently registered in the bundle context or null if no such
	...
	public static FileAccessService getFileAccessService() {
		if (fileAccessService == null) {
			fileAccessService = ServiceUtils.getService(
