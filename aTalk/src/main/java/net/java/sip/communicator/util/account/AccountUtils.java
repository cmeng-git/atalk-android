...
public class AccountUtils
{
	 ...
	 *
	 * @param accountUID
	 * 		the account unique identifier string
	 * @return the <tt>AccountID</tt> corresponding to the given string account unique identifier
	 */
	...
	/**
	 * Returns a list of all currently registered providers, which support the given
	 * <tt>operationSetClass</tt>.
	 *
	 * @param opSetClass
	 * 		the operation set class for which we're looking for providers
	 * @return a list of all currently registered providers, which support the given
	 * <tt>operationSetClass</tt>
	 */
	 ...
	 *
	 * @param opSet
	 * 		the operation set for which we're looking for providers
	 * @param preferredProvider
	 * 		the preferred protocol provider
	 * @param preferredProtocolName
	 * 		the preferred protocol name
