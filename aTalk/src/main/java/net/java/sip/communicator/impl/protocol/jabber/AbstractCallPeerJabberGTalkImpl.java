	...
	extends MediaAwareCallPeer<T, U, ProtocolProviderServiceJabberImpl>
{
	 ...
	 *
	 * @param peerAddress
	 *        the Jabber or Google Talk address of the new call peer.
	 * @param owningCall
	...
	protected AbstractCallPeerJabberGTalkImpl(String peerAddress, T owningCall)
	{
		...
		try {
			this.peerJid = JidCreate.from(peerAddress);
		}
	 ...
	 *
	 * @param discoverInfo
	 *        the discovery information that we have obtained for this peer.
	 */
