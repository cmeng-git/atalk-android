...
/**
 * The <tt>GlobalDisplayNameImpl</tt> offers generic access to a global display name for the
 * local user.
 * <p>
 *
		...
		RegistrationStateChangeListener, ServerStoredDetailsChangeListener, AvatarListener
{
	 ...
	 *
	 * @param evt
	 * 		the <tt>RegistrationStateChangeEvent</tt> that notified us of the change
	 */
	 ...
	 *
	 * @param event
	 * 		the event containing the new image
	 */
	 ...
	 *
	 * @param evt
	 * 		the <tt>ServerStoredDetailsChangeEvent</tt> the event for name change.
	 */
	...
	private class UpdateAccountInfo extends Thread
	{
		 ...
		 * 		the provider.
		 * @param accountInfoOpSet
		 * 		the opSet.
		 * @param isUpdate
		 * 		indicates if the display name and avatar should be updated from this provider even
