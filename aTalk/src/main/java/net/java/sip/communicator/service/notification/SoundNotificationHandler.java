...
/**
 * The <tt>SoundNotificationHandler</tt> interface is meant to be implemented by the notification bundle in order to
 * provide handling of sound actions.
 *
...
{
	/**
	 * Start playing the sound pointed by <tt>getDescriotor</tt>. This method should check the loopInterval value to
	 * distinguish whether to play a simple sound or to play it in loop.
	 * 
	 * @param action
	...
	/**
	 * Stops playing the sound pointing by <tt>getDescriptor</tt>. This method is meant to be used to stop sounds that
	 * are played in loop.
	 * 
	 * @param data
	 *        Additional data for the event.
