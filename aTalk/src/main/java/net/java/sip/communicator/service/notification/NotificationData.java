...
public class NotificationData
{
	 ...
	 * @param extras
	 *        additional/extra {@link NotificationHandler}-specific data to be provided by the new instance to the
	 *        various <tt>NotificationHandler</tt>s
	 */
	NotificationData(String eventType, String title, String message, byte[] icon, Map<String, Object> extras) {
	 ...
	 *
	 * @param key
	 *        the key whose associated <tt>NotificationHandler</tt>-specific extra is to be returned. Well known keys
