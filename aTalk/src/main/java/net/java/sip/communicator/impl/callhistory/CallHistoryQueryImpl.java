...
public class CallHistoryQueryImpl implements CallHistoryQuery {
     ...
     *
     * @param query the underlying <code>HistoryQuery</code> this query is based on
     */
    public CallHistoryQueryImpl(HistoryQuery query) {
        ...
        for (HistoryRecord historyRecord : historyQuery.getHistoryRecords()) {
            CallRecord callRecord = CallHistoryServiceImpl.createCallRecordFromProperties(historyRecord.getProperties());
            callRecords.add(callRecord);
        }
    }
     ...
     *
     * @param callRecord the <code>CallRecord</code> to add
     */
