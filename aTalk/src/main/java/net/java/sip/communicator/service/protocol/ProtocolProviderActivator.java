...
public class ProtocolProviderActivator implements BundleActivator
{
	 ...
	 */
	private final static Logger logger = Logger.getLogger(ProtocolProviderActivator.class);

	/**
	 * The <code>ServiceRegistration</code> of the <code>AccountManager</code> implementation
	...
	/**
	 * The <code>BundleContext</code> of the one and only <code>ProtocolProviderActivator</code>
	 * instance which is currently started.
	 */
	private static BundleContext bundleContext;

	/**
	 * The <code>ConfigurationService</code> used by the classes in the bundle represented by
	...
	/**
	 * The <code>SingleCallInProgressPolicy</code> making sure that the <code>Call</code>s
	 * accessible in the <code>BundleContext</code> of this activator will obey to the rule that a
	 * new <code>Call</code> should put the other existing <code>Call</code>s on hold.
	 */
	private SingleCallInProgressPolicy singleCallInProgressPolicy;

	/**
	 * Gets the <code>ConfigurationService</code> to be used by the classes in the bundle
	 * represented by <code>ProtocolProviderActivator</code>.
	 *
	 * @return the <code>ConfigurationService</code> to be used by the classes in the bundle
	 * represented by <code>ProtocolProviderActivator</code>
	 */
	...
	/**
	 * Gets the <code>ResourceManagementService</code> to be used by the classes in the bundle
	 * represented by <code>ProtocolProviderActivator</code>.
	 *
	 * @return the <code>ResourceManagementService</code> to be used by the classes in the bundle
	 * represented by <code>ProtocolProviderActivator</code>
	 */
	...
	/**
	 * Gets the <code>CalendarService</code> to be used by the classes in the bundle represented by
	 * <code>ProtocolProviderActivator</code>.
	 *
	 * @return the <code>CalendarService</code> to be used by the classes in the bundle represented
	 * by <code>ProtocolProviderActivator</code>
	 */
	 ...
	 *
	 * @param protocolName
	 * 		the name of the protocol, which factory we're looking for
	...
	/**
	 * Registers a new <code>AccountManagerImpl</code> instance as an <code>AccountManager</code>
	 * service and starts a new <code>SingleCallInProgressPolicy</code> instance to ensure that
	 * only
	 * one of the <code>Call</code>s accessible in the <code>BundleContext</code> in which this
	 * activator is to execute will be in progress and the others will automatically be put on
	 * hold.
	 *
	 * @param bundleContext
	 * 		the <code>BundleContext</code> in which the bundle activation represented by this
	 * 		<code>BundleActivator</code> executes
	 */
	 ...
	 * <code>AccountManager</code> service in {@link #start(BundleContext)} and stops the
	 * <code>SingleCallInProgressPolicy</code> started there as well.
	 *
	 * @param bundleContext
	 * 		the <code>BundleContext</code> in which the bundle activation represented by this
	 * 		<code>BundleActivator</code> executes
