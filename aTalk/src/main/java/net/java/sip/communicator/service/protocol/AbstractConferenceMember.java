...
public class AbstractConferenceMember extends PropertyChangeNotifier implements ConferenceMember
{
	 ...
	 *        the <tt>CallPeer</tt> to which this member is connected
	 * @param address
	 *        the protocol address of this <tt>ConferenceMember</tt>
	 * @throws NullPointerException
	 *         if <tt>conferenceFocusCallPeer</tt> or <tt>address</tt> is <tt>null</tt>
	 */
	 ...
	 *
	 * @param ssrc
	 *        the audio SSRC ID to set for this member.
	 */
	 ...
	 *        the conference-info XML endpoint status of this <tt>ConferenceMember</tt> indicated by
	 ...
	 *
	 * @param ssrc
	 *        the video SSRC ID to set for this member.
	 */
