...
/**
 * The <tt>ChatRoomConfigurationForm</tt> contains the chat room configuration. It's meant to be
 ...
 * The <tt>ChatRoomConfigurationForm</tt> contains a list of <tt>ChatRoomConfigurationFormField</tt>
...
{
	/**
	 * Returns an Iterator over a set of <tt>ChatRoomConfigurationFormField</tt>s, containing the
	 ...
	 *
	 * @return a list of <tt>ChatRoomConfigurationFormField</tt>s, containing the current
