...
public class ContactPresenceStatusChangeEvent extends PropertyChangeEvent
{
	 ...
	 * @param parentGroup
	 *        the group containing the contact that caused this event (to be set as null in cases
	 *        where groups are not supported);
	 * @param oldValue
	 *        the status the source contact was in before entering the new state.
	 * @param newValue
	 *        the status the source contact is currently in.
	 */
	public ContactPresenceStatusChangeEvent(Contact source, ProtocolProviderService sourceProvider,
