...
public class DnsUtilActivator implements BundleActivator, ServiceListener
{
	...
	public static final String PNAME_BACKUP_RESOLVER_FALLBACK_IP
			= "dns.BACKUP_RESOLVER_FALLBACK_IP";
	 ...
	 *
	 * @param context
	 * 		The execution context of the bundle being started (unused).
	 * @throws Exception
	 * 		If this method throws an exception, this bundle is marked as stopped and the Framework
	...
	{
		if (getConfigurationService().getBoolean(
				ProxyInfoX.CONNECTION_PROXY_FORWARD_DNS_PROPERTY_NAME, false)) {
			try {
				...
				try {
					port = getConfigurationService().getInt(
							ProxyInfoX.CONNECTION_PROXY_FORWARD_DNS_PORT_PROPERTY_NAME,
	...
	public static NotificationService getNotificationService()
	{
		if (notificationService == null) {
			notificationService = ServiceUtils.getService(bundleContext,
