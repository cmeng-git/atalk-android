 ...
 * @author Emil Ivov
 */
public class WhiteboardParticipantChangeEvent extends java.beans.PropertyChangeEvent
{
	/**
	 * Serial version UID.
	 */
	 ...
	 */
	public WhiteboardParticipantChangeEvent(WhiteboardParticipant source, String type,
	...
	public String toString()
	{
		return "WhiteboardParticipantChangeEvent: type=" + getEventType() + " oldV="
			+ getOldValue() + " newV=" + getNewValue() + " for participant="
