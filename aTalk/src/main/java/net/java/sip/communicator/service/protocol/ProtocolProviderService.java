...
public interface ProtocolProviderService
{
	 ...
	 *
	 * @param authority
	 * 		the security authority that will be used for resolving any security
	 * 		challenges that may be returned during the registration or at any moment while we're
	 * 		registered.
	 * @throws OperationFailedException
	 * 		with the corresponding code it the registration fails
	 ...
	 *
	 * @param <T>
	 * 		the type which extends <tt>OperationSet</tt> and which is to be retrieved
	 * @param opsetClass
