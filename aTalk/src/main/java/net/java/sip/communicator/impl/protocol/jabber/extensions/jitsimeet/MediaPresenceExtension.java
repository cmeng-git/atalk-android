...
public class MediaPresenceExtension extends AbstractPacketExtension
{
	 ...
	 * 		the <tt>ProviderManager</tt> to which media presence extensions will be registered to.
	 */
	...
	public static class Source extends AbstractPacketExtension
	{
		...
		/**
		 * Creates new instance of <tt>Source</tt> packet extension with default 'sendrecv'
		 * direction set.
		 */
		public Source()
		{
		 ...
		 *
		 * @param mediaType
		 * 		media type string('audio' or 'video').
		 */
		 ...
		 *
		 * @param direction
		 * 		media direction like used in SDP ('sendrecv, 'recvonly'...).
		 */
		...
		/**
		 * Sets synchronization source identifier of the media represented by this source packet
		 * extension.
		 *
		 * @param ssrc
		 * 		synchronization source identifier to set.
		 */
