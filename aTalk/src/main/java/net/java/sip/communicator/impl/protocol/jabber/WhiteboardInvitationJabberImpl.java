...
public class WhiteboardInvitationJabberImpl implements WhiteboardInvitation
{
	...
	/**
	 * Creates an invitation for the given <tt>targetWhiteboard</tt>, from the given
	 * <tt>inviter</tt>.
	 *
	 * @param targetWhiteboard
	 *        the <tt>WhiteboardSession</tt> for which the invitation is
	 * @param firstWhiteboardObject
	 ...
	 * @param inviter
	 *        the <tt>WhiteboardParticipant</tt>, which sent the invitation
	 * @param reason
	 *        the reason of the invitation
	 * @param password
	 *        the password to use to join the given white-board
	 */
	public WhiteboardInvitationJabberImpl(WhiteboardSession targetWhiteboard,
		WhiteboardObject firstWhiteboardObject, String inviter, String reason, byte[] password)
	{
	 ...
	 *
	 * @return the password to use in order to join the white-board, that this invitation is about.
	 */
	 ...
	 * If the user accepts this invitation he/she should see this object on his white-board.
	 *
