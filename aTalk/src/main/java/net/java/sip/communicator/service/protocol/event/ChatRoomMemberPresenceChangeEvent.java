...
public class ChatRoomMemberPresenceChangeEvent extends EventObject
{
	...
	/**
	 * The well-known reason for a <code>ChatRoomMemberPresenceChangeEvent</code> to occur as part
	 * of an operation which lists all users in a <code>ChatRoom</code>.
	 */
	 ...
	 * @param eventType
	 *        the event type; one of the MEMBER_XXX constants
	 * @param reason
	 ...
	 *        the <tt>ChatRoom</tt> that produced this event
	 * @param sourceMember
	 *        the <tt>ChatRoomMember</tt> who this event is about
	 * @param actorMember
	 *        the <tt>ChatRoomMember</tt> who participated as an actor in the new event. For
