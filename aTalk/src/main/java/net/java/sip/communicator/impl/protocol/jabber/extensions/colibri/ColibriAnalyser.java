...
public class ColibriAnalyser
{
	...
	/**
	 * Creates new instance of analyser that will used given Colibri IQ instance for storing
	 * conference state.
	 *
	 * @param conferenceStateHolder
	 * 		the Colibri IQ instance that will be used for storing conference state.
	 */
	 ...
	 *
	 * @param allocateResponse
	 * 		the Colibri IQ that describes JVB response to allocate request.
	 */
	 ...
	 * might not work as expected when channels for multiple peers with single query were
	 * allocated.
	 *
	 * @param conferenceResponse
	 * 		JVB response to allocate channels request.
	 * @param peerContents
	 * 		list of peer media contents that has to be matched with allocated channels.
	 ...
	 */
	private static String readChannelBundle(ColibriConferenceIQ.ChannelCommon channel,
