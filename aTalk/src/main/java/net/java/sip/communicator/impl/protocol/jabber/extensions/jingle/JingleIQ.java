...
public class JingleIQ extends IQ
{
		...
		IQChildElementXmlStringBuilder xml)
	{
		...
		// cmeng - any extensionsXML will be handled by IQ base class and closed element properly
	...
	/**
	 * Sets this element's session ID value. A "sid" is a random session identifier generated by the
	 * initiator, which effectively maps to the local-part of a SIP "Call-ID" parameter.
	 *
	 * @param sid
	 ...
	 *
	 * @param contentPacket
	 *        the content packet extension we'd like to add to this element's content list.
	 */
	 ...
	 * 
	 * @param contentName
	 *        the name of the content for which extension will be returned
	 ...
	 *
	 * @param si
	 *        a {@link SessionInfoPacketExtension} that we'd like to add here.
	 */
