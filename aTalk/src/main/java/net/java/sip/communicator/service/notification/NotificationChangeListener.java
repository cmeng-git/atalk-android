...
/**
 * The <tt>NotificationChangeListener</tt> is notified any time an action type or an event type is added, removed or
 * changed.
 *
 * @author Emil Ivov
...
public interface NotificationChangeListener extends EventListener
{
	 ...
	 *
	 * @param event
	 *        the <tt>NotificationActionTypeEvent</tt>, which is dispatched when a new action has been added.
	 */
	 ...
	 *
	 * @param event
	 *        the <tt>NotificationActionTypeEvent</tt>, which is dispatched when an action has been removed.
	 */
	public void actionRemoved(NotificationActionTypeEvent event);

	/**
	 * This method gets called when a notification action for a particular event type has been changed (for example the
	 * corresponding descriptor has changed).
	 *
	 * @param event
	 *        the <tt>NotificationActionTypeEvent</tt>, which is dispatched when an action has been changed.
	 */
	 ...
	 *
	 * @param event
	 *        the <tt>NotificationEventTypeEvent</tt>, which is dispatched when a new event type has been added
	 */
	 ...
	 *
	 * @param event
	 *        the <tt>NotificationEventTypeEvent</tt>, which is dispatched when an event type has been removed.
	 */
