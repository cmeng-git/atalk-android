...
public class ProvisioningForm extends TransparentPanel {
	 ...
	 */
	private final JCheckBox enableCheckBox = null;

	/**
	 * The DHCP provisioning discovery button.
	 */
	private final JRadioButton dhcpButton = null;

	/**
	 * The DNS provisioning discovery button.
	 */
	private final JRadioButton dnsButton = null;

	/**
	 * The Bonjour provisioning discovery button.
	 */
	private final JRadioButton bonjourButton = null;

	/**
	 * The manual provisioning button.
	 */
	private final JRadioButton manualButton = null;
