...
/**
 * A listener that registers for <tt>ChatRoomMessageEvent</tt>s issued by a particular
 * <tt>ChatRoom</tt>.
 *
 * @author Emil Ivov
 */
public interface ChatRoomMessageListener extends EventListener
{
	 ...
	 * 
	 * @param evt
	 *        the <tt>ChatRoomMessageReceivedEvent</tt> containing the newly received message, its
	 ...
	 * 
	 * @param evt
	 *        the <tt>ChatRoomMessageDeliveredEvent</tt> containing the id of the message that has
	 *        caused the event.
	 */
	 ...
	 * 
	 * @param evt
	 *        the <tt>ChatRoomMessageDeliveryFailedEvent</tt> containing the ID of the message whose
	 *        delivery has failed.
	 */
