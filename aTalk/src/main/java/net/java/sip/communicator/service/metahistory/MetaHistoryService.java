...
public interface MetaHistoryService
{
	 ...
	 * @return Collection sorted result that consists of records returned from the services we wrap
	 */
	Collection<Object> findByKeywords(String[] services, Object descriptor,
	 ...
	 * @return Collection sorted result that consists of records returned from the services we wrap
	 */
	Collection<Object> findFirstMessagesAfter(String[] services, Object descriptor, Date date,
			int count);
	 ...
	 * @return Collection sorted result that consists of records returned from the services we wrap
	 */
	Collection<Object> findLastMessagesBefore(String[] services, Object descriptor, Date date,
			int count);
