...
public class ReasonExtension extends AbstractPacketExtension
{
	...
	/**
	 * Indication that the call ended due to being rejected by the remote party subsequent to being
	 * accepted.
	 */
	public static final String BUSY = "busy";

	/**
	 * Indication that the call ended due to being rejected by the remote party before being
	 * accepted.
	 */
	...
	/**
	 * Creates an {@link ReasonExtension} instance for the specified <tt>namespace</tt> and
	 * <tt>elementName</tt>.
	 *
	 * @param elementName
	 ...
	 * 
	 * @param code
	 *        new value of platform code attribute. Pass <tt>null</tt> to remove.
	 */
