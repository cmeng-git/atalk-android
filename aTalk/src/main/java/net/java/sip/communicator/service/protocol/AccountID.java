...
public class AccountID
{
	 ...
	 * 		a Map containing any other protocol and implementation specific account initialization
	 * 		properties
	 * @param protocolName
	 * 		the protocol name implemented by the provider that this id is meant for e.g. Jabber
	 * @param serviceName
	 * 		the name of the service (e.g. iptel.org, jabber.org, icq.com) that this account is
	 * 		registered with.
	 * 		<p>
	 ...
	 * 		a Map containing any other protocol and implementation specific account initialization
	 * 		properties
	 * @param defaultProtocolName
	 * 		the protocol name to be used in case <tt>accountProperties</tt> doesn't provide an
	 * 		overriding value
	 ...
	 *
	 * @param key
	 * 		the key of the property to get the value of as a signed decimal integer
	 * @param defaultValue
	 * 		the value to be returned if parsing the value of the specified property key as a
	 ...
	 *
	 * @param key
	 * 		the key, corresponding to the property string we're looking for
	 ...
	 * 		the key, corresponding to the property string we're looking for
	 * @param defValue
	 * 		the default value returned when given <tt>key</tt> is not present
	 * @return the account property string corresponding to the given key
	 */
	public String getAccountPropertyString(Object key, String defValue)
	{
		...
		if (value == null) {
			...
			// for later retrieval
			value = ProtocolProviderActivator.getConfigurationService()
					.getString(uuid + "." + property);
	 ...
	 *
	 * @param displayName
	 * 		the account display name value to set.
	 */
	 ...
	 *
	 * @param storePassword
	 * 		indicates whether password is to be stored persistently.
	 */
	 ...
	 * registered.
	 *
	 * @param isKeepAliveEnable
	 * 		<tt>true</tt> if we are to send keep alive packets and <tt>false</tt> otherwise.
	 */
	 ...
	 * 		indicates if the server is overridden
	 */
	 ...
	 *
	 * @param isUseProxy
	 * 		<tt>true</tt> to indicate that Proxy should be used for this account, <tt>false</tt> -
	 * 		otherwise.
	 */
	 ...
	 *
	 * @param ibRegistration
	 * 		indicates if the account wants to perform an IBR registration with the server
	 */
	 ...
	 *
	 * @param iconPath
	 * 		a path to the protocol icon to set.
	 */
	 ...
	 *
	 * @param iconPath
	 * 		a path to the account icon to set.
	 */
	 ...
	 * 		The minimal DTMF tone duration to set.
	 */
	 ...
	 *
	 * @param id
	 * 		the client certificate configuration template ID.
	 */
	 ...
	 *
	 * @param srtpType
	 * 		The name of the encryption protocol ("ZRTP", "SDES" or "MIKEY").
	 */
	 ...
	 *
	 * @param bundleContext
	 * 		the OSGi bundle context that we are currently running in.
	 * @param accountID
	 * 		account ID
	 * @param namePrefix
	 * 		name prefix
	 ...
	 * 		the property value
	 * @param trim
	 * 		<tt>true</tt> if the value will be trimmed, before <tt>isEmpty()</tt> is called.
	 */
	 ...
	 * map.
	 *
	 * @param protocolIconPath
	 * 		the path to the protocol icon is used
	 * @param accountIconPath
	 * 		the path to the account icon if used
	 * @param accountProperties
	 ...
	 * @param cursor
	 * 		AccountID table cursor for properties extraction
	 * @param factory
	 * 		Account protocolProvider Factory
