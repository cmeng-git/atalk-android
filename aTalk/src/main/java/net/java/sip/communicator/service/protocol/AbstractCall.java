...
/**
 * Provides implementations for some of the methods in the <tt>Call</tt> abstract class to
...
public abstract class AbstractCall<T extends CallPeer, U extends ProtocolProviderService> extends Call
{
	 ...
	 *
	 * @param callPeer
	 *        the <tt>CallPeer</tt> to be added to the list of <tt>CallPeer</tt>s of this
	 *        <tt>Call</tt>
	 ...
	 *         if <tt>callPeer</tt> is <tt>null</tt>
	 */
	 ...
	 *
	 * @param callPeer
	 *        the <tt>CallPeer</tt> to be removed from the list of <tt>CallPeer</tt>s of this
	 *        <tt>Call</tt>
	 * @return <tt>true</tt> if the list of <tt>CallPeer</tt>s of this <tt>Call</tt> was modified as
	 *         a result of the execution of the method; otherwise, <tt>false</tt>
	 */
	...
	/**
	 * Gets an unmodifiable <tt>List</tt> of the <tt>CallPeer</tt>s of this <tt>Call</tt>. The
	 * implementation of {@link Call#getCallPeers()} returns an <tt>Iterator</tt> over the same
	 * <tt>List</tt>.
	 *
	 ...
	 * returned <tt>Iterator</tt> operates over the <tt>List</tt> returned by
	 * {@link #getCallPeerList()}.
	 *
