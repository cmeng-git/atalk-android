...
{
	/**
	 * Creates an ad-hoc room with the named <tt>adHocRoomName</tt> and according to the specified
	 * <tt>adHocRoomProperties</tt>. When the method returns the ad-hoc room the local user will
	 * have joined it.
	 * <p>
	 *
	 * @param adHocRoomName
	 ...
	 *        properties specifying how the ad-hoc room should be created; <tt>null</tt> for no
	...
	/**
	 * Creates an ad-hoc room with the named <tt>adHocRoomName</tt> and in including to the
	 * specified <tt>contacts</tt> for the given <tt>reason
	 * </tt>. When the method returns the ad-hoc room the local user will have joined it.
	 * <p>
	 *
	 * @param adHocRoomName
	 *        the name of the <tt>AdHocChatRoom</tt> to create.
	 * @param contacts
	 *        the contacts (ID) who are added to the room when it's created; <tt>null</tt> for no
	 *        contacts
	 * @param reason
	...
	/**
	 * Adds the given <tt>listener</tt> to the list of <tt>AdHocChatRoomInvitationListener</tt>-s
	 ...
	 * <tt>AdHocChatRoomInvitationRejectionListener</tt>-s that would be notified when an add-hoc
