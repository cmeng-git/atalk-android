...
public interface OperationSetPresence extends OperationSet
{
	 ...
	 *
	 * @param status
	 *        the PresenceStatus as returned by getRequestableStatusSet
	 * @param statusMessage
	 ...
	 *
	 * @param listener
	 *        the listener that would received presence status updates for contacts.
	 */
	 ...
	 *
	 * @param listener
	 *        the SubscriptionListener to register
	 */
