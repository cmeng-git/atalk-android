 ...
 */
public class CallPeerSecurityOnEvent extends CallPeerSecurityStatusEvent
{
	/**
	 * Serial version UID.
	 */
	 ...
	 * @param sessionType
	 *        the type of the session, either {@link CallPeerSecurityStatusEvent#AUDIO_SESSION} or
	 ...
	 */
	public CallPeerSecurityOnEvent(CallPeer callPeer, int sessionType, String cipher,
