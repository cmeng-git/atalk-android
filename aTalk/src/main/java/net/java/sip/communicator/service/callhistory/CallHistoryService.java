...
public interface CallHistoryService
{
	...
	/**
	 * Returns all the calls made by all the contacts in the supplied <tt>contact</tt> before the
	 * given date.
	 *
	 * @param contact
	 * 		MetaContact which contacts participate in the returned calls
	...
	/**
	 * Returns the supplied number of recent calls made by all the contacts in the supplied
	 * <tt>contact</tt>.
	 *
	 * @param contact
	 * 		MetaContact which contacts participate in the returned calls
	 ...
	 *
	 * @param address
	 * 		String the address of the peer
	 * @param recordCount
