...
public class ProvisioningActivator implements BundleActivator
{
	...
	/**
	 * Indicates if the provisioning configuration form should be disabled, i.e. not visible to
	 * the user.
	 */
	 ...
	 * 		BundleContext
	 * @throws Exception
	 * 		if anything goes wrong during the start of the bundle
	 */
			...
			throws Exception
	{
		...
		bundleContext.registerService(ProvisioningService.class.getName(),
	 ...
	 * 		BundleContext
	 * @throws Exception
	 * 		if anything goes wrong during the stop of the bundle
	 */
	...
	public static CredentialsStorageService getCredentialsStorageService()
	{
		if (credentialsService == null) {
			...
			credentialsService
					= (CredentialsStorageService) bundleContext.getService(credentialsReference);
		}
	...
	public static NetworkAddressManagerService getNetworkAddressManagerService()
	{
		if (netaddrService == null) {
			ServiceReference netaddrReference = bundleContext.getServiceReference(
					NetworkAddressManagerService.class.getName());
			netaddrService
					= (NetworkAddressManagerService) bundleContext.getService(netaddrReference);
		}
