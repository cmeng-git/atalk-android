...
public class CallConference extends PropertyChangeNotifier
{
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> for which the number of <tt>CallPeer</tt>s associated with the
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> which specifies the telephony conference the <tt>CallPeer</tt>s of
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> which participates in the telephony conference the list of
	 ...
	 *
	 * @param calls
	 *        the list of <tt>Call</tt> which are to be judged whether the local peer/user that they
	 ...
	 *
	 * @param jitsiVideobridge
	 *        <tt>true</tt> if the telephony conference represented by the new instance is to
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> to add to the list of <tt>Call</tt>s participating in this telephony
	 *        conference
	 ...
	 *
	 * @param listener
	 *        the <tt>CallChangeListner</tt> to be added to the <tt>Call</tt>s participating in this
	 *        telephony conference
	 * @throws NullPointerException
	 *         if <tt>listener</tt> is <tt>null</tt>
	 */
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> to whose associated <tt>CallPeer</tt>s
	 ...
	 *
	 * @param listener
	 *        the <tt>CallPeerConferenceListener</tt> to be added to the <tt>CallPeer</tt>s
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> which has been added to the list of <tt>Call</tt>s participating in
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> which has been removed from the list of <tt>Call</tt>s participating
	 *        in this telephony conference
	 */
	 ...
	 *
	 * @param ev
	 *        a <tt>CallChangeEvent</tt> which specifies the <tt>Call</tt> which had its
	 ...
	 *
	 * @param oldValue
	 *        the value of the <tt>conferenceFocus</tt> property of this instance before the change
	 * @param newValue
	 *        the value of the <tt>conferenceFocus</tt> property of this instance after the change
	 */
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> which is to be checked whether it is participating in this telephony
	 *        conference
	...
	{
		synchronized (callChangeListeners) {
			return callChangeListeners.toArray(new CallChangeListener[callChangeListeners.size()]);
		}
	}
	...
	{
		synchronized (callPeerConferenceListeners) {
			return callPeerConferenceListeners
	 ...
	 *
	 * @param callPeers
	 *        a <tt>List</tt> into which the <tt>CallPeer</tt>s associated with the <tt>Call</tt>s
	 ...
	 *
	 * @param ev
	 *        a <tt>CallPeerEvent</tt> which specifies the <tt>CallPeer</tt> which was added or
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> to remove from the list of <tt>Call</tt>s participating in this
	 *        telephony conference
	 * @return <tt>true</tt> if the list of <tt>Call</tt>s participating in this telephony
	 *         conference changed as a result of the method call; otherwise, <tt>false</tt>
	 */
	 ...
	 *
	 * @param listener
	 *        the <tt>CallChangeListener</tt> to be removed from the <tt>Call</tt>s participating in
	 *        this telephony conference
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> from whose associated <tt>CallPeer</tt>s
	 ...
	 *
	 * @param listener
	 *        the <tt>CallPeerConferenceListener</tt> to be removed from the <tt>CallPeer</tt>s
	 *        associated with the <tt>Call</tt>s participating in this telephony conference
	 ...
	 *        <tt>true</tt> if the local peer represented by this instance and the <tt>Call</tt>s
