 ...
 * ad-hoc chat room. Changes may include member being join, left, etc.
 *
 * @author Valentin Martinet
 */
public interface AdHocChatRoomParticipantPresenceListener extends EventListener
{
	/**
	 * Called to notify interested parties that a change in the presence of a participant in a
	 * particular ad-hoc chat room has occurred. Changes may include participant being join, left.
	 *
	 * @param evt
     *        the <code>AdHocChatRoomParticipantPresenceChangeEvent</code> instance containing the
