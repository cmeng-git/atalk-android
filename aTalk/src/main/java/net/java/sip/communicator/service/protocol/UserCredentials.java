...
public class UserCredentials
{
	 ...
	 *
	 * @param userName
	 * 		the name of the user that this credentials relate to.
	 */
	 ...
	 *
	 * @param password
	 * 		the passWord associated with this set of credentials.
	 */
	 ...
	 *
	 * @param storePassword
	 * 		indicates whether passwords contained by this credentials object are to be stored
	 * 		persistently.
	 */
	 ...
	 * 		<tt>true</tt> requests IB Registration
	 */
	 ...
	 * <p>
	 *
	 * @param serverOverridden
	 * 		indicates whether login server address need to be overridden for this credentials
	 * 		object.
	 */
	 ...
	 *
	 * @param serverAddress
	 * 		the name of the login server address that this credentials relate to.
	 */
	 ...
	 *
	 * @param serverPort
	 * 		the name of the login server port that this credentials relate to.
	 */
	 ...
	 *
	 * @param reason
	 * 		the reason for the login / reLogin.
	 */
	 ...
	 *
	 * @param isCancel
	 * 		<tt>true</tt> if user has click "Cancel" during Login User Credential prompt
	 */
