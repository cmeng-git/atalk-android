...
public class SoundNotificationAction extends NotificationAction
{
	 ...
	 * @param loopInterval
	 *        the loop interval
	 * @param isSoundNotificationEnabled
	 *        True if this sound is activated. False Otherwise.
	 * @param isSoundPlaybackEnabled
	 *        True if this sound is activated. False Otherwise.
	 * @param isSoundPCSpeakerEnabled
	 *        True if this sound is activated. False Otherwise.
	 */
	public SoundNotificationAction(String soundDescriptor, int loopInterval, boolean isSoundNotificationEnabled, boolean isSoundPlaybackEnabled,
	 ...
	 *        True if this sound is played on notification device. False Otherwise.
	 */
	 ...
	 *
	 * @param isSoundEnabled
	 *        True if this sound is played on playback device. False Otherwise.
	 */
	 ...
	 *
	 * @param isSoundEnabled
	 *        True if this sound is played on speaker device. False Otherwise.
	 */
