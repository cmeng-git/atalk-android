...
public class RtpDescriptionPacketExtension extends AbstractPacketExtension
{
	...
	/**
	 * Create a new <tt>RtpDescriptionPacketExtension</tt> with a different namespace.
	 *
	 * @param namespace
	 *        namespace to use
	 */
	...
	/**
	 * Specifies the media type for the stream that this description element represents, such as
	 * "audio" or "video".
	 *
	 * @param media
	 *        the media type for the stream that this element represents such as "audio" or "video".
	 */
	...
	/**
	 * Returns the media type for the stream that this description element represents, such as
	 * "audio" or "video".
	 *
	 * @return the media type for the stream that this description element represents, such as
	 *         "audio" or "video".
	 */
	 ...
	 *
	 * @param ssrc
	 *        the SSRC ID that the RTP stream represented here will be using.
	 */
	...
	/**
	 * Returns a <b>reference</b> to the list of payload types that we have registered with this
	 * description so far.
	 *
	 * @return a <b>reference</b> to the list of payload types that we have registered with this
	 *         description so far.
	 */
	...
	/**
	 * Casts <tt>childExtension</tt> to one of the extensions allowed here and sets the
	 * corresponding field.
	 *
	 ...
	 *
	 * @param encryption
	 *        the encryption {@link ExtensionElement} we'd like to add to this packet.
	 */
	 ...
	 *
	 * @return the encryption {@link ExtensionElement} added to this packet or <tt>null</tt> if none
	 *         has been set yet.
	 */
	 ...
	 *
	 * @param bandwidth
	 *        the max/preferred bandwidth indication that we'd like to add to this packet.
	 */
	 ...
	 * use by this application type.
	 *
	 * @return the max/preferred bandwidth set for this session or <tt>null</tt> if none has been
	 *         set yet.
	 */
	...
	/**
	 * Adds an optional <tt>extmap</tt> element that allows negotiation RTP extension headers as per
	 * RFC 5282.
	 *
	 * @param extmap
	 *        an optional <tt>extmap</tt> element that allows negotiation RTP extension headers as
	 *        per RFC 5282.
	 */
