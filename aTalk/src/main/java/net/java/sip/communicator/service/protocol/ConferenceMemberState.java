...
/**
 * Represents the state of the device and signaling session of <code>ConferenceMember</code> in the
 * conference it is participating in.
 *
...
public enum ConferenceMemberState {
	...
	/**
	 * Focus is in the process of disconnecting the endpoint (e.g., in SIP a DISCONNECT or BYE was
	...
	/**
	 * The state of the device and signaling session of the associated <code>ConferenceMember</code>
	 * in the conference is unknown.
	 */
	UNKNOWN("Unknown");
