...
/**
 * Implements <tt>AbstractPacketExtension</tt> for the <tt>fingerprint</tt> element defined by
...
public class DtlsFingerprintPacketExtension extends AbstractPacketExtension
{
	...
	/**
	 * Gets the hash function utilized to calculate the fingerprint carried/represented by this
	 * instance.
	 *
	 * @return the hash function utilized to calculate the fingerprint carried/represented by this
	 *         instance
	 */
	 ...
	 *
	 * @param fingerprint
	 *        the fingerprint to be carried/represented by this instance
	 */
	...
	/**
	 * Sets the hash function utilized to calculate the fingerprint carried/represented by this
	 * instance.
	 *
	 * @param hash
	 *        the hash function utilized to calculate the fingerprint carried/represented by this
	 *        instance
	 */
	 ...
	 * 
	 * @param setup
	 *        see {@link #SETUP_ATTR_NAME} for the list of allowed values.
	 */
