...
{
	/**
	 * Contains either the bareJid of contact as retrieved from the Roster Entry
	 ...
	 *
	 * @param rosterEntry
	 * 		the RosterEntry object that we will be encapsulating.
	 * @param ssclCallback
	 * 		a reference to the ServerStoredContactListImpl instance that created us.
	 * @param isPersistent
	 * 		determines whether this contact is persistent or not.
	 * @param isResolved
	 * 		specifies whether the contact has been resolved against the server contact list
	 */
	 ...
	 * @param isPersistent
	 * 		is the contact persistent.
	 */
	ContactJabberImpl(String id, ServerStoredContactListJabberImpl ssclCallback,
	 ...
	 *
	 * @param retrieveIfNecessary
	 * 		specifies whether the method should queue this contact for avatar update from the
	 * 		server.
	 ...
	 *
	 * @param imgBytes
	 * 		the bytes of the image that we'd like to set.
	 */
	...
	public String toString()
	{
		...
		buff.append(getAddress()).append(", isPersistent=").append(isPersistent)
	 ...
	 *
	 * @param status
	 * 		the JabberStatusEnum that this contact is currently in.
	 */
	...
	{
		if (isResolved) {
			RosterEntry entry = ssclCallback.getRosterEntry(contactJid);
			String name = null;
	 ...
	 *
	 * @param persistent
	 * 		true if the buddy is to be considered persistent and false for volatile.
	 */
	...
	{
		return ssclCallback.getRosterEntry(contactJid);
	}
	 ...
	 *
	 * @param fullJid
	 * 		the fullJid of the volatile contact.
	 */
