 ...
 * stores the information for the chat room even when the corresponding protocol provider is not
 * connected.
 *
...
public interface ChatRoomWrapper extends Comparable<ChatRoomWrapper>
{
	...
	/**
	 * Property to be fired when chat room requires registration and we failed while joining the
	 * chat room.
	 */
	...
	/**
	 * Returns <code>true</code> if the chat room is persistent, otherwise - returns <code>false
	 * </code>.
	 *
