...
public class WhiteboardObjectPacketExtension implements ExtensionElement
{
	...
	/**
	 * The identifier of the WhiteboardObject to be treated When we receive a delete message, we've
	 * only the identifier of the WhiteboardObject
	 */
	 ...
	 *
	 * @param id
	 *        Identifier of the WhiteboardObject to be treated
	 * @param action
	 *        The current action associated with the WhiteboardObject.
	 */
	 ...
	 *        The WhiteboardObject to be treated
	 * @param action
	 *        The current action associated with the WhiteboardObject.
	 */
	...
	public String toXML()
	{
		...
		return "<" + WhiteboardObjectPacketExtension.ELEMENT_NAME + " xmlns=\""
			+ WhiteboardObjectPacketExtension.NAMESPACE + "\">" + s + "</"
			+ WhiteboardObjectPacketExtension.ELEMENT_NAME + ">";
	}

	/**
	 * Returns the current action associated with the WhiteboardObject to send. (DELETE - DRAW -
	 * MOVE)
	 *
	...
	/**
	 * Returns the current WhiteboardObject's identifier to be sent. (For a delete WhiteboardObject
	 * message)
	 *
	...
	/**
	 * Sets the current WhiteboardObject's identifier to be sent. (For a delete WhiteboardObject
	 * message)
	 *
	 * @param objectID
