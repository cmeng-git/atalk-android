...
public abstract class Call extends DataObject
{
	 ...
	 * 		the proto provider that created us.
	 */
	 ...
	 * 		the source <tt>CallPeer</tt> for the newly created event.
	 * @param eventID
	 * 		the ID of the event to create (see constants defined in <tt>CallPeerEvent</tt>)
	 */
	 ...
	 * 		the ID of the event to create (see constants defined in <tt>CallPeerEvent</tt>)
	 * @param delayed
	 * 		<tt>true</tt> if the adding/removing of the peer from the GUI should be delayed and
	 * 		<tt>false</tt> if not.
	 */
	protected void fireCallPeerEvent(CallPeer sourceCallPeer, int eventID, boolean delayed)
	{
		...
		if (logger.isDebugEnabled()) {
			logger.debug("Dispatching a CallPeer event to " + callListeners.size()
	 ...
	 *
	 * @param type
	 * 		the type of the event to create (see CallChangeEvent member ints)
	 * @param oldValue
	 * 		the value of the call property that changed, before the event had occurred.
	 * @param newValue
	 * 		the value of the call property that changed, after the event has occurred.
	 */
	 ...
	 * 		the value of the call property that changed, after the event has occurred.
	 * @param cause
	 * 		the event that is the initial cause of the current one.
	 */
	protected void fireCallChangeEvent(String type, Object oldValue, Object newValue,
			CallPeerChangeEvent cause)
	{
		...
		if (logger.isDebugEnabled()) {
			logger.debug("Dispatching a CallChange event to " + callListeners.size()
					+ " listeners. The event is: " + event);
		}
	 ...
	 *
	 * @param newState
	 * 		a reference to the <tt>CallState</tt> instance that the call is to enter.
	 */
	 ...
	 *
	 * @param conference
	 * 		the <tt>CallConference</tt> instance to represent the telephony conference-related
	 * 		state of this <tt>Call</tt>
	 */
	 ...
	 *
	 * @param property
	 * 		the name of the property of this <tt>Call</tt> which had its value changed
	 * @param oldValue
	 ...
	 *
	 * @param autoAnswer
	 * 		whether incoming calls into this <tt>Call</tt> should be auto-answered.
	 */
