 ...
 * @author Emil Ivov
 */
public class DefaultPacketExtensionProvider<C extends AbstractPacketExtension> extends ExtensionElementProvider<C>
{
    /**
     ...
     */
    @Override
    public C parse(XmlPullParser parser, int depth)
            throws Exception
    {
