...
/**
 * The <tt>CallPeerSecurityFailedEvent</tt> is triggered whenever a problem has occurred during
...
public class CallPeerSecurityMessageEvent extends EventObject
{
	...
	/**
	 * Creates a <tt>CallPeerSecurityFailedEvent</tt> by specifying the call peer, event type and
	 ...
	 * 		the message associated with this event.
	 * @param i18nMessage
	 * 		the internationalized message associated with this event that could be shown to the
	 * 		user.
	 * @param eventSeverity
	 * 		severity level.
	 */
