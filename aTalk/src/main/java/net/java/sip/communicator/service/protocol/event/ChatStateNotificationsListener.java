...
public interface ChatStateNotificationsListener extends EventListener
{
	 ...
	 * 
	 * @param event
	 *        a <tt>ChatStateNotificationEvent</tt> containing the sender of the notification and
	 *        its type.
	 */
	public void chatStateNotificationReceived(ChatStateNotificationEvent event);
	 ...
	 *        its type.
	 */
	public void chatStateNotificationDeliveryFailed(ChatStateNotificationEvent event);
}
