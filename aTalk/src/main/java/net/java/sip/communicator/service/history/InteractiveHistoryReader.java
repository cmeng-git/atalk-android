...
/**
 * The <tt>InteractiveHistoryReader</tt> allows to search in the history in an interactive way, i.e. be able to cancel
 * the search at any time and track the results through a <tt>HistoryQueryListener</tt>.
 *
