...
public class CallPeerSecurityNegotiationStartedEvent extends CallPeerSecurityStatusEvent
{
	 ...
	 *        {@link net.java.sip.communicator.service.protocol.event.CallPeerSecurityStatusEvent#AUDIO_SESSION}
	 *        or
	 ...
	 */
	public CallPeerSecurityNegotiationStartedEvent(CallPeer callPeer, int sessionType,
