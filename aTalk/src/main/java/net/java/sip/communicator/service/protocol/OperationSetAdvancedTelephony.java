...
/**
 * Extends <code>OperationSetBasicTelephony</code> with advanced telephony operations such as call
 * transfer.
 *
 * @param <T>
 ...
 */
public interface OperationSetAdvancedTelephony<T extends ProtocolProviderService> extends
	OperationSetBasicTelephony<T>
{
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> to be transfered to the specified callee address
	 * @param target
	 ...
	 * 
	 * @param authority
	 *        transfer authority asks user for accepting a particular transfer request.
	 */
