...
public class SipAccountID extends AccountID
{
	 ...
	 */
	private static final String SIP_DEFAULTS_PREFIX = AccountID.DEFAULT_PREFIX + "sip.";
	...
	private String getXcapCompatible(String newKey, String oldKeyXcap, String oldKeyXivo)
	{
		...
		if (value == null) {
			...
			if (value != null) {
				...
				mAccountProperties.put(newKey, value);
			}
		}
		return value;
	}
	...
	{
		String val = getXcapCompatible(OPT_CLIST_USE_SIP_CREDETIALS, "XCAP_USE_SIP_CREDETIALS",
	...
	{
		String value = ProtocolProviderActivator.getConfigurationService().getString(
...
//===================================
	...
	protected String avatar = "avatar_filePath";
	protected String rosterVersion = "version";

	public ContentValues getContentValues() {
		final ContentValues values = new ContentValues();
		values.put(ACCOUNT_UUID, accountUID);
