 ...
 * @author Boris Grozev
 */
public class ConferenceDescriptionExtensionElement extends AbstractExtensionElement
{
    /**
     ...
     */
    public ConferenceDescriptionExtensionElement()
    {
        this(null, null, null);
    }
     ...
     */
    public ConferenceDescriptionExtensionElement(String uri)
    {
        this(uri, null, null);
    }
     ...
     */
    public ConferenceDescriptionExtensionElement(String uri, String callId)
    {
     ...
     *
     * @param cd the <tt>ConferenceDescription</tt> which to represent in the new instance.
     */
    public ConferenceDescriptionExtensionElement(ConferenceDescription cd)
    {
        ...
        for (String transport : transports) {
            addChildExtension(new TransportExtensionElement(transport));
        }
    }
    ...
    public ConferenceDescription toConferenceDescription()
    {
        ...
        for (TransportExtensionElement t : getChildExtensionsOfType(TransportExtensionElement.class)) {
