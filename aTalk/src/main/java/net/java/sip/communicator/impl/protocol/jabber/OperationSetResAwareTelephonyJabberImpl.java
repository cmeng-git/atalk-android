...
{
	/**
	 * The <tt>OperationSetBasicTelephonyJabberImpl</tt> supported by the parent Jabber protocol
	 * provider
	 */
	 ...
	 *        the <tt>OperationSetBasicTelephonyJabberImpl</tt> supported by the parent Jabber
	 *        protocol provider
	 */
