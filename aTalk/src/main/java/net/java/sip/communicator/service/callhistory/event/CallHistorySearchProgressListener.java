...
public interface CallHistorySearchProgressListener
{
     ...
     */
    public static int PROGRESS_MINIMUM_VALUE = HistorySearchProgressListener.PROGRESS_MINIMUM_VALUE;

    /**
     * The maximum value for the progress change.
     * This is value indicates that the process is finished.
     */
    public static int PROGRESS_MAXIMUM_VALUE = HistorySearchProgressListener.PROGRESS_MAXIMUM_VALUE;
