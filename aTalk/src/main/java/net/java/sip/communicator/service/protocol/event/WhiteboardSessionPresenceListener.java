...
/**
 * A listener that will be notified of changes in our presence in the white-board, such as joined,
 * left, dropped, etc.
 *
 * @author Yana Stamcheva
 */
public interface WhiteboardSessionPresenceListener extends EventListener
{
	/**
	 ...
	 * 
	 * @param evt
	 *        the <tt>WhiteboardSessionPresenceChangeEvent</tt> instance containing the session and
