...
public interface ChatRoom
{
	 ...
	 * @throws OperationFailedException
	 *         if the user doesn't have the right to change this property.
	 */
	 ...
	 *
	 * @param listener
	 *        a member participation listener.
	 */
	 ...
	 *
	 * @param listener
	 *        a room member property change listener.
	 */
	 ...
	 */
	Message createMessage(byte[] content, int encType, String contentEncoding, String subject);
	 ...
	 * @throws OperationFailedException
	 *         if an error occurred while performing the request to the server or you don't have
	 ...
	 *
	 * @param address
	 *        the user address of the user to grant administrator privileges (e.g. "user@host.org").
	 */
	 ...
	 *
	 * @param address
	 *        the user address of the user to grant membership privileges (e.g. "user@host.org").
	 */
	 ...
	 *
	 * @param address
	 *        the user address of the user to grant ownership privileges (e.g. "user@host.org").
	 */
	 ...
	 *
	 * @param address
	 *        the user address of the user to revoke membership (e.g. "user@host.org").
	 */
	 ...
	 *
	 * @param address
	 *        the user address of the user to revoke ownership (e.g. "user@host.org").
	 */
