 ...
 * @author Emil Ivov
 */
public interface WhiteboardChangeListener extends EventListener
{
	/**
	 * Indicates that a new whiteboard participant has joined the source whiteboard.
	 *
	 * @param evt
	 *        the <tt>WhiteboardParticipantEvent</tt> containing the source whiteboard and
	 ...
	 *
	 * @param evt
	 *        the <tt>WhiteboardChangeEvent</tt> instance containing the source whiteboards and its
	 *        old and new state.
	 */
