...
public interface OperationSetVideoTelephony extends OperationSet
{
	 ...
	 * when visual/video <tt>Component</tt>s are being added and removed for a specific
	 * <tt>CallPeer</tt>.
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> whose video the specified listener is to be notified about
	 * @param listener
	...
	/**
	 * Gets the visual <tt>Component</tt> which depicts the local video being streamed to a specific
	 * <tt>CallPeer</tt>.
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> to whom the local video which is to be depicted by the returned
	 ...
	 *         if creating the component fails for whatever reason.
	 */
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> whose video the specified listener is to no longer be notified
	 *        about
	 * @param listener
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> to get the indicator of
	...
	/**
	 * Indicates a user request to answer an incoming call with video enabled from the specified
	 * CallPeer.
	 * 
	 * @param peer
	 *        the call peer that we'd like to answer.
	 * @throws OperationFailedException
	 *         with the corresponding code if we encounter an error while performing this operation.
	 */
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> which is the conference focus of the telephony conference to be
	 ...
	 *        the visual <tt>Component</tt> which displays the video content/RTP stream of the
