 ...
 * @author Emil Ivov
 */
public class MetaContactRenamedEvent extends MetaContactPropertyChangeEvent
{
	/**
	 * Serial version UID.
	 */
	 ...
	 * 		the old display name of this meta contact.
	 * @param newDisplayName
	 * 		the new display name of this meta contact.
	 */
	public MetaContactRenamedEvent(MetaContact source, String oldDisplayName,
