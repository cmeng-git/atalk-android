...
public interface CustomResolver extends Resolver
{
     ...
     */
    public static final String PNAME_DNS_PATIENCE = "dns.DNS_PATIENCE";
     ...
     */
    public static final String PNAME_DNS_REDEMPTION = "dns.DNS_REDEMPTION";
     ...
     */
    public static final String PNAME_DNSSEC_RESOLVER_ENABLED = "dns.DNSSEC_ENABLED";
