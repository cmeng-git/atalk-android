...
/**
 * A listener that will be notified of changes in the presence of a member in a particular chat
 * room. Changes may include member being kicked, join, left.
 *
 * @author Emil Ivov
 */
public interface ChatRoomMemberPresenceListener extends EventListener
{
	 ...
	 *
	 * @param evt
	 *        the <tt>ChatRoomMemberPresenceChangeEvent</tt> instance containing the source chat
