 ...
 * methods for finding a call by its ID, peer session and others.
 *
 * @author Emil Ivov
 * @author Symphorien Wanko
 * @author Vincent Lucas
 */
public class ActiveCallsRepositoryJabberGTalkImpl<T extends AbstractCallJabberGTalkImpl<U>, U extends AbstractCallPeerJabberGTalkImpl<T, ?, ?>>
	extends ActiveCallsRepository<T, OperationSetBasicTelephonyJabberImpl>
{
	 ...
	 *
	 * @param opSet
	 *        the <tt>OperationSetBasicTelphony</tt> instance which has been used to create calls in
	 *        this repository
	 */
	 ...
	 * corresponding jingle session has the specified jingle <tt>sid</tt>.
	 *
	 * @param sid
	 ...
	 *
	 * @param id
	 *        the IQ <tt>id</tt> we're looking for.
	 *
	 ...
	 * @param cause
	 *        the <tt>CallChangeEvent</tt>, if any, which is the cause that necessitated a new
