...
public interface OperationSetMessageWaiting extends OperationSet
{
	...
	public enum MessageType {
		VOICE("voice-message"), FAX("fax-message"), PAGER("pager-message"), MULTIMEDIA(
			"multimedia-message"), TEXT("text-message"), NONE("none");
	 ...
	 *
	 * @param type
	 *        register the listener for certain type of messages.
	 * @param listener
	 *        the <tt>MessageWaitingListener</tt> to register.
	 */
	 ...
	 *        register the listener for certain type of messages.
	 * @param listener
	 *        the <tt>MessageWaitingListener</tt> to unregister.
	 */
