 ...
 *
 * @param <T>
 *        the peer extension class like for example <tt>CallSipImpl</tt> or <tt>CallJabberImpl</tt>
 * @param <U>
 *        the media handler extension class like for example <tt>CallPeerMediaHandlerSipImpl</tt> or
		...
		CsrcAudioLevelListener, SimpleAudioLevelListener
{
	 ...
	 *
	 * @param listener
	 *        the <tt>ConferenceMembersSoundLevelListener</tt> to add
	...
	public void addStreamSoundLevelListener(SoundLevelListener listener)
	{
		synchronized (streamSoundLevelListenersSyncRoot) {
			 ...
			 */
			streamSoundLevelListeners = (streamSoundLevelListeners == null) ? new ArrayList<SoundLevelListener>()
				: new ArrayList<SoundLevelListener>(streamSoundLevelListeners);
	 ...
	 *
	 * @param newLevel
	 *        the new audio level of the audio stream received from the remote peer
	 */
	 ...
	 *        the event containing information (that we don't really use) on the newly add member.
	 */
	 ...
	 *
	 * @param conferenceEvent
	 *        the event containing information (that we don't really use) on the freshly removed
	 *        member.
	 */
	 ...
	 *
	 * @param newLevel
	 *        the new value of the sound level to notify <tt>streamSoundLevelListeners</tt> about
	 */
	 ...
	 *
	 * @param message
	 *        a message to log and display to the user.
	 * @param throwable
	 *        the exception that cause the error we are logging
	 */
	 ...
	 *
	 * @param listener
	 *        the <tt>ConferenceMembersSoundLevelListener</tt> to remove
	 */
	...
	public void removeStreamSoundLevelListener(SoundLevelListener listener)
	{
		synchronized (streamSoundLevelListenersSyncRoot) {
			 ...
			 */
			if (streamSoundLevelListeners != null) {
				streamSoundLevelListeners = new ArrayList<SoundLevelListener>(
	 ...
	 *
	 * @param call
	 *        the call that this call peer is participating in.
	 */
	 ...
	 *
	 * @param mediaHandler
	 *        a reference to the <tt>CallPeerMediaHandler</tt> instance that this peer uses for
	 *        media related tips and tricks.
	 */
	 ...
	 *
	 * @param newState
	 *        the <tt>CallPeerState</tt> that we are about to enter and that we pass to our
	 *        predecessor.
	 * @param reason
	 *        a reason phrase explaining the state (e.g. if newState indicates a failure) and that
	 ...
	 *
	 * @param mediaType
	 *        the <tt>MediaType</tt> to be converted
