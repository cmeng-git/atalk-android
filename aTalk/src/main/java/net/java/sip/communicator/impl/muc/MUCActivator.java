...
public class MUCActivator implements BundleActivator
{
	 ...
	 *
	 * @param context
	 * 		the bundle context where we register and obtain services.
	 */
			...
			throws Exception
	{
		...
		bundleContext.registerService(ContactSourceService.class.getName(),
				chatRoomContactSource, null);
	 ...
	 * 		the <tt>ProtocolProviderService</tt> to add
	 */
	 ...
	 *
	 * @param protocolProvider
	 * 		the <tt>ProtocolProviderService</tt> to remove
	 */
