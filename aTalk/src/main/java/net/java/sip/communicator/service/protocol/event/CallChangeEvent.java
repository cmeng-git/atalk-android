...
public class CallChangeEvent extends PropertyChangeEvent
{
	 ...
	 * <tt>CallChangeEvent</tt> to be fired. For example, when the last <tt>CallPeer</tt> in a
	 * <tt>Call</tt> is disconnected, the <tt>Call</tt> will end.
	 */
	 ...
	 *        current value of the changed property.
	 * @param cause
	 *        the event that causes this event, if any(null otherwise).
	 */
	public CallChangeEvent(Call source, String type, Object oldValue, Object newValue,
	...
	{
		return "CallChangeEvent: type=" + getEventType() + " oldV=" + getOldValue() + " newV="
			+ getNewValue();
	}
}
