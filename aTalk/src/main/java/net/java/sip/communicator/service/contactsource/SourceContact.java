 ...
 * to call this contact through the preferred telephony provider defined in the
...
public interface SourceContact
{
	 ...
	 * 		if categories aren't supported for call history records
	 */
	 ...
	 *
	 * @param operationSet
	 * 		the <tt>OperationSet</tt> class, for which we would like to obtain a
	 * 		<tt>ContactDetail</tt>
	 ...
	 *
	 * @param key
	 * 		the key of the user data associated with this instance to be retrieved
	 ...
	 * @param value
	 * 		the value to be associated in this instance with the specified <tt>key</tt>
	 */
