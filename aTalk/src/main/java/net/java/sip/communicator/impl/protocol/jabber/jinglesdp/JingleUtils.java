...
public class JingleUtils {
	/**
	 * The <tt>Logger</tt> used by the <tt>JingleUtils</tt> class and its instances for logging
	 * output.
	 */
	private static final Logger logger = Logger.getLogger(JingleUtils.class);

	/**
	 * Extracts and returns an {@link RtpDescriptionPacketExtension} provided with <tt>content</tt>
	 * or <tt>null</tt> if there is none.
	 *
	 * @param content the media content that we'd like to extract the {@link RtpDescriptionPacketExtension}
	 * from.
	 * @return an {@link RtpDescriptionPacketExtension} provided with <tt>content</tt> or
	 ...
	 * empty list even if there were actually some formats in the <tt>mediaDesc</tt> if we support
	 ...
	 *
	 * @param desc the {@link RtpDescriptionPacketExtension} that we'd like to probe for a list of
	 * {@link RTPExtension}s
	 ...
	 * @return a <tt>List</tt> of {@link RTPExtension}s advertised in the <tt>mediaDesc</tt>
	 * description.
	 */
	...
	/**
	 * Creates a new {@link ContentPacketExtension} instance according to the specified
