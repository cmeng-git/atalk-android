...
{
    /**
     * The <tt>Logger</tt> used by the <tt>JingleUtils</tt> class and its instances for logging output.
     */
     ...
     *
     * @param content the media content that we'd like to extract the {@link RtpDescriptionPacketExtension} from.
     * @return an {@link RtpDescriptionPacketExtension} provided with <tt>content</tt> or <tt>null</tt> if there is none.
     */
