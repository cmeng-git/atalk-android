...
public abstract class SecurityAccountRegistration implements Serializable
{
	 ...
	 */
	public static final List<String> ENCRYPTION_PROTOCOLS = Collections.unmodifiableList(
			Arrays.asList(SrtpControlType.ZRTP.toString(), SrtpControlType.SDES.toString(),
	 ...
	 *        if we want to set call encryption on as default
	 */
	 ...
	 *
	 * @param sipZrtpAttribute
	 *        include the ZRTP attribute to SIP/SDP or to Jabber/IQ
	 */
	 ...
	 *
	 * @param sdesEnabled
	 *        True to enable SDES. False, otherwise.
	 */
	 ...
	 *
	 * @param cipherSuites
	 *        The list of cipher suites enabled for SDES. Null if no cipher suite is enabled.
	 */
	 ...
	 *        The map between the encryption protocols and their priority order.
	 */
	 ...
	 *
	 * @param encryptionProtocolStatus
	 *        The map between the encryption protocols and their status.
	 */
	 ...
	 * 
	 * @param propertiesMap
	 *        the map that will be used for storing security properties held by this object.
	 */
