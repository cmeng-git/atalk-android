	...
	implements OperationSetPersistentPresence
{
	 ...
	 *        the <tt>ProtocolProviderService</tt> which created the new instance
	 */
	 ...
	 * @param parentGroup
	 *        the group that contains the source contact.
	 * @param oldValue
	 *        the status that the source contact detained before changing it.
	 */
	 ...
	 *
	 * @param source
	 *        the ContactJabberImpl instance that this event is pertaining to.
	 * @param eventID
	 *        the String ID of the event to dispatch
	 * @param oldValue
	 *        the value that the changed property had before the change occurred.
	 * @param newValue
	 ...
	 *        the contact that has caused the event.
	 * @param eventID
	 *        an identifier of the event to dispatch.
	 */
	 ...
	 * @param oldParent
	 *        the group where the contact was located before being moved.
	 * @param newParent
	 *        the group where the contact has been moved.
	 */
