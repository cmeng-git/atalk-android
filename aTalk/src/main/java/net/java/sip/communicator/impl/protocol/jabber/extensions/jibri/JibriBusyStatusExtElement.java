 ...
 */
public class JibriBusyStatusExtElement extends AbstractExtensionElement
{
    /**
     ...
     */
    public JibriBusyStatusExtElement()
    {
    ...
    static public void registerExtensionProvider()
    {
        ProviderManager.addExtensionProvider(
                ELEMENT_NAME,
                NAMESPACE,
                new DefaultExtensionElementProvider<>(JibriBusyStatusExtElement.class)
        );
    }
