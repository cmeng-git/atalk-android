...
public class MessageDeliveryFailedEvent extends EventObject
{
	...
	/**
	 * Contains a human readable message indicating the reason for the failure or null if the reason
	 * is unknown.
	 */
	 ...
	 *        error code
	 */
	public MessageDeliveryFailedEvent(Message source, Contact to, String correctedMessageUID,
		int errorCode)
	{
		this(source, to, errorCode, System.currentTimeMillis(), null);
	 ...
	 *
	 * @param source
	 *        the <tt>Message</tt> whose delivery this event represents.
	 * @param to
	 ...
	 *        an errorCode indicating the reason of the failure.
	 * @param timestamp
	 *        the exact timestamp when it was determined that delivery had failed.
	 * @param reason
	 *        a human readable message indicating the reason for the failure or null if the reason
	 *        is unknown.
	 */
	public MessageDeliveryFailedEvent(Message source, Contact to, int errorCode, long timestamp,
		String reason)
	 ...
	 * sent to.
	 *
	 * @return a reference to the <tt>Contact</tt> that the source failed <tt>Message</tt> wwas sent
	 *         to.
	 */
	...
	/**
	 * Returns a human readable message indicating the reason for the failure or null if the reason
	 * is unknown.
	 *
	 * @return a human readable message indicating the reason for the failure or null if the reason
	 *         is unknown.
	 */
