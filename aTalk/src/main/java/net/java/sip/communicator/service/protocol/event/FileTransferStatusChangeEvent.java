...
/**
 * The <tt>FileTransferStatusChangeEvent</tt> is the event indicating of a change in the state of a
 * file transfer.
 *
...
public class FileTransferStatusChangeEvent extends EventObject
{
	 ...
	 *
	 * @param fileTransfer
	 *        the source file transfer, for which this status change occured
	 * @param oldStatus
	 *        the old status
	 * @param newStatus
	 *        the new status
