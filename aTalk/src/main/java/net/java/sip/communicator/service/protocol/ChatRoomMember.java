...
public interface ChatRoomMember
{
	 ...
	 * our contact list and in function of this to show additional information add additional
	 * functionality.
	 *
	 ...
	 *
	 * @param role
	 * 		<tt>ChatRoomMemberRole</tt> instance indicating the role to set for this member in its
	 * 		containing chat room.
	 */
