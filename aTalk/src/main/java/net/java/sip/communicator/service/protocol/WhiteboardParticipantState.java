...
{
	/**
	 * This constant value indicates a String representation of the UNKNOWN whiteboard state. <br>
	 ...
	 */
	public static final WhiteboardParticipantState UNKNOWN = new WhiteboardParticipantState(
		_UNKNOWN);
	 ...
	 */
	public static final WhiteboardParticipantState INITIATING_WHITEBOARD = new WhiteboardParticipantState(
		_INITIATING_WHITEBOARD);

	/**
	 * This constant value indicates a String representation of the CONNECTING whiteboard state. <br>
	 ...
	 */
	public static final WhiteboardParticipantState CONNECTING = new WhiteboardParticipantState(
		_CONNECTING);
	 ...
	 * ringing).
	 */
	public static final WhiteboardParticipantState INCOMING_WHITEBOARD = new WhiteboardParticipantState(
		_INCOMING_WHITEBOARD);

	/**
	 * This constant value indicates a String representation of the CONNECTED whiteboard state. <br>
	 ...
	 */
	public static final WhiteboardParticipantState CONNECTED = new WhiteboardParticipantState(
		_CONNECTED);

	/**
	 * This constant value indicates a String representation of the DISCONNECTED whiteboard state. <br>
	 ...
	 */
	public static final WhiteboardParticipantState DISCONNECTED = new WhiteboardParticipantState(
		_DISCONNECTED);

	/**
	 * This constant value indicates a String representation of the BUSY whiteboard state. <br>
	 ...
	 */
	public static final WhiteboardParticipantState BUSY = new WhiteboardParticipantState(_BUSY);

	/**
	 * This constant value indicates a String representation of the FAILED whiteboard state. <br>
	 ...
	 * unexpected reason.
	 */
	public static final WhiteboardParticipantState FAILED = new WhiteboardParticipantState(_FAILED);
	 ...
	 * string.
	 * 
	 * @param whiteboardParticipantState
