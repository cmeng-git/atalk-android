...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>UtilActivator</tt> class and its instances for logging
	 * output.
	 */
	...
	{
		logger.error("An uncaught exception occurred in thread=" + thread
				+ " and message was: " + exc.getMessage(), exc);
	}
