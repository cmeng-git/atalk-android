...
public interface CertificateService
{
	 ...
	 */
	public final static String PNAME_ALWAYS_TRUST = "gui.ALWAYS_TRUST_MODE_ENABLED";
	 ...
	 */
	public final static String PNAME_NO_USER_INTERACTION = "tls.NO_USER_INTERACTION";

	/**
	 * The property name prefix of all client authentication configurations.
	 */
	public static final String PNAME_CLIENTAUTH_CERTCONFIG_BASE = "cert.clientauth";

	/**
	 * Property that is being applied to the system property <tt>javax.net.ssl.trustStoreType</tt>
	 */
	public static final String PNAME_TRUSTSTORE_TYPE = "cert.truststore.type";

	/**
	 * Property that is being applied to the system property <tt>javax.net.ssl.trustStore</tt>
	 */
	public static final String PNAME_TRUSTSTORE_FILE = "cert.truststore.file";

	/**
	 * Property that is being applied to the system property
	 * <tt>javax.net.ssl.trustStorePassword</tt>
	 */
	public static final String PNAME_TRUSTSTORE_PASSWORD = "cert.truststore.password";
	 ...
	 */
	public static final String PNAME_REVOCATION_CHECK_ENABLED = "cert.revocation.enabled";

	/**
	 * Property that is being applied to the Security property <tt>ocsp.enable</tt>
	 */
	public static final String PNAME_OCSP_ENABLED = "cert.ocsp.enabled";
	 ...
	 *
	 * @param id
	 * 		The ID ({@link CertificateConfigEntry#getId()}) of the entry to delete.
	 */
	 ...
	 *
	 * @param entry
	 * 		The @see CertificateConfigEntry to save or update.
	 */
	 ...
	 *
	 * @param trustManager
	 * 		The trustManager that will be used by the created SSLContext
	 ...
	 * Get an SSL Context with the specified trustManager.
	 *
	 * @param clientCertConfig
	 * 		The ID of a client certificate configuration entry that is to be used when the server
	 ...
	 *
	 * @param keyManagers
	 * 		The key manager(s) to be used for client authentication
	 * @param trustManager
	 * 		The trustManager that will be used by the created SSLContext
	 * @return An SSL context based on the supplied trust manager.
	 * @throws GeneralSecurityException
	 ...
	 *
	 * @param identitiesToTest
	 * 		when not <tt>null</tt>, the values are assumed to be hostNames for invocations of
	...
	/**
	 * @param identityToTest
	 * 		when not <tt>null</tt>, the value is assumed to be a hostname for invocations of
	...
	/**
	 * @param identityToTest
	 * 		The identity to match against the supplied verifiers.
	 * @param clientVerifier
	 * 		The verifier to use in calls to checkClientTrusted
	 * @param serverVerifier
	 * 		The verifier to use in calls to checkServerTrusted
	 * @return TrustManager to use in an SSLContext
	 * @throws GeneralSecurityException
	 ...
	 *
	 * @param identitiesToTest
	 * 		The identities to match against the supplied verifiers.
	 * @param clientVerifier
	 * 		The verifier to use in calls to checkClientTrusted
	 * @param serverVerifier
	 * 		The verifier to use in calls to checkServerTrusted
	 ...
	 * @param trustMode
	 * 		Whether to trust the certificate permanently or only for the current session.
