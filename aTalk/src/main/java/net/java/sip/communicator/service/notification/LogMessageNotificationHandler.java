...
/**
 * The <code>LogMessageNotificationHandler</code> interface is meant to be implemented by the notification bundle in order
 * to provide handling of log actions.
 *
