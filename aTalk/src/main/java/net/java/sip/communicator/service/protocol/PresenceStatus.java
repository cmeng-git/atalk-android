...
public class PresenceStatus implements Comparable<PresenceStatus>
{
     ...
     * this service should respect the following indications for status values.
    ...
    /**
     * Indicates whether the user is both Online and available (can be reached and is likely to respond) or not.
     *
