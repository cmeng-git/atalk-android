...
public interface OperationSetBasicTelephony<T extends ProtocolProviderService> extends OperationSet
{
	 ...
	 * incoming calls are received. This method is called by the implementation of the PhoneUI
	 * service.
	 * 
	 * @param listener
	 ...
	 * <tt>CallPeer</tt> corresponding the <tt>cd</tt> will be created and added to the returned
	 * <tt>Call</tt>
	 *
	 * @param cd
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> whos mute state is set
	 * @param mute
	 *        <tt>true</tt> to mute the call streams being sent to <tt>peers</tt>; otherwise,
	 *        <tt>false</tt>
	 */
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> which is to be recorded by the returned <tt>Recorder</tt> when the
	 *        latter is started
	 * @return a new <tt>Recorder</tt> which is to record the specified <tt>call</tt> (into a file
	 *         which is to be specified when starting the returned <tt>Recorder</tt>)
	 * @throws OperationFailedException
	 *         if anything goes wrong while creating the new <tt>Recorder</tt> for the specified
	 *         <tt>call</tt>
	 */
