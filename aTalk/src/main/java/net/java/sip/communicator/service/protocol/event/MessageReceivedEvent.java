...
public class MessageReceivedEvent extends EventObject
{
	 ...
	 */
	public static final int CONVERSATION_MESSAGE_RECEIVED = ChatMessage.MESSAGE_IN;

	/**
	 * An event type indicating that the message being received is a system message being sent by
	 * the server or a system administrator.
	 */
	 ...
	 */
	public static final int SMS_MESSAGE_RECEIVED = ChatMessage.MESSAGE_SMS_IN;
	 ...
	 *
	 * @param source
	 *        the <tt>Message</tt> whose reception this event represents.
	 * @param from
	 *        the <tt>Contact</tt> that has sent this message.
	 * @param timestamp
	 ...
	 *        The ID of the message being corrected, or null if this is a new message and not a
	 *        correction.
	 */
	public MessageReceivedEvent(Message source, Contact from, String correctedMessageUID)
	{
		this(source, from, new Date(), CONVERSATION_MESSAGE_RECEIVED);
	 ...
	 *        the <tt>Contact</tt> that has sent this message.
	 * @param fromResource
	 *        the <tt>ContactResource</tt>, from which this message was sent
	 * @param timestamp
	 *        the exact date when the event occurred.
	 * @param correctedMessageUID
	 *        The ID of the message being corrected, or null if this is a new message and not a
	 *        correction.
	 */
	public MessageReceivedEvent(Message source, Contact from, ContactResource fromResource,
		Date timestamp, String correctedMessageUID)
	{
		this(source, from, fromResource, timestamp, CONVERSATION_MESSAGE_RECEIVED);
	 ...
	 *        The ID of the message being corrected, or null if this is a new message and not a
	 *        correction.
	 * @param isPrivateMessaging
	 *        indicates whether the this is private messaging event or not.
	 * @param privateContactRoom
	...
	{
		this(source, from, fromResource, timestamp, CONVERSATION_MESSAGE_RECEIVED,
			isPrivateMessaging, privateContactRoom);
	 ...
	 *        the exact date when the event occurred.
	 * @param eventType
	 *        the type of message event that this instance represents (one of the
	...
	/**
	 * Returns a reference to the <tt>Contact</tt> that has sent the <tt>Message</tt> whose
	 * reception this event represents.
	 *
	 * @return a reference to the <tt>Contact</tt> that has sent the <tt>Message</tt> whose
	 *         reception this event represents.
	 */
