...
public interface WhiteboardObjectListener extends EventListener
{
	 ...
	 *
	 * @param evt
	 *        the <tt>WhiteboardObjectReceivedEvent</tt> containing the newly received
	 ...
	 *
	 * @param evt
	 *        the <tt>WhiteboardObjectDeletedEvent</tt> containing the identification of the deleted
	 *        WhiteboardObject, its sender and other details.
	 */
	 ...
	 *
	 * @param evt
	 *        the <tt>WhiteboardObjectModifiedEvent</tt> containing the modified WhiteboardObject,
	 ...
	 *
	 * @param evt
	 *        the WhiteboardObjectDeliveredEvent containing the id of the WhiteboardObject that has
	 *        caused the event.
	 */
	 ...
	 *
	 * @param evt
	 *        the <tt>WhiteboardObjectDeliveryFailedEvent</tt> containing the ID of the
