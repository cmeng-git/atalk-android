...
public interface OperationSetPersistentPresence extends OperationSetPresence
{
	 ...
	 *
	 * @throws OperationFailedException
	 *         with code NETWORK_FAILURE if creating the group fails because of a network error.
	 * @throws IllegalArgumentException
	 *         if <tt>parent</tt> is not a contact known to the underlying protocol provider
	 * @throws IllegalStateException
	 *         if the underlying protocol provider is not registered/signed on a public service.
	 */
	 ...
	 *
	 * @throws OperationFailedException
	 *         with code NETWORK_FAILURE if deleting the group fails because of a network error.
	 * @throws IllegalArgumentException
	 *         if <tt>parent</tt> is not a contact known to the underlying protocol provider.
	 * @throws IllegalStateException
	 *         if the underlying protocol provider is not registered/signed on a public service.
	 ...
	 * @throws OperationFailedException
	 *         when the operation didn't finished successfully.
	 */
	 ...
	 *
	 * @param listener
	 *        a ServerStoredGroupChangeListener that would receive events upon group changes.
	 */
