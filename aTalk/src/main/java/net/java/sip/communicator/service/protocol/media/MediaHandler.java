...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>MediaHandler</tt> class and its instances for logging
	 * output.
	 */
	 ...
	 * {@link #configureStream(CallPeerMediaHandler, MediaDevice, MediaFormat,
	 * MediaStreamTarget, MediaDirection, List, MediaStream, boolean)} to
	 * {@link CallPeerMediaHandler}s as new instances.
	 */
	 ...
	 *
	 * @param listener
	 * 		the <tt>CsrcAudioLevelListener</tt> to add to the list of
	 * 		<tt>CsrcAudioLevelListener</tt>s to be notified about audio level-related information
	 * 		received from the remote peer(s)
	 */
	 ...
	 *
	 * @param listener
	 * 		the <tt>SimpleAudioLevelListener</tt> to add to the list of
	 ...
	 *
	 * @param lock
	 * 		the <tt>Object</tt> which is to be used to synchronize the access to
	 * 		<tt>listeners</tt>.
	 * @param listeners
	 * 		the list of <tt>SimpleAudioLevelListener</tt>s to forward the notification to
	 * @param level
	 * 		the value of the audio level to notify <tt>listeners</tt> about
	 */
	 ...
	 *
	 * @param audioLevels
	 * 		the audio level-related information received from the remote peer(s)
	 */
	 ...
	 *
	 * @param device
	 * 		the <tt>MediaDevice</tt> to be used by <tt>stream</tt> for capture and playback
	 * @param format
	 * 		the <tt>MediaFormat</tt> that we'd like the new stream to transmit in.
	 * @param target
	 ...
	 * 		if setting the <tt>MediaFormat</tt> or connecting to the specified
	 ...
	 *
	 * @param stream
	 * 		the <tt>MediaStream</tt> that we'd like to register our dynamic payload mappings with.
	 */
	 ...
	 *
	 * @param stream
	 * 		the <tt>MediaStream</tt> that we'd like to register our <tt>RTPExtension</tt>s with.
	 * @param rtpExtensions
	 * 		the list of <tt>RTPExtension</tt>s that should be enabled for <tt>stream</tt>.
	 */
	 ...
	 *
	 * @param listener
	 * 		the <tt>CsrcAudioLevelListener</tt> to remove from the list of
	 * 		<tt>CsrcAudioLevelListener</tt>s to be notified about audio level-related information
	 * 		received from the remote peer(s)
	 */
	 ...
	 *
	 * @param listener
	 * 		the <tt>SimpleAudioLevelListener</tt> to remove from the list of
	 * 		<tt>SimpleAudioLevelListener</tt>s to be notified about changes in the level of the
	 * 		audio sent from the local peer/user to the remote peer(s)
	 */
	 ...
	 *
	 * @param listener
	 * 		the <tt>SimpleAudioLevelListener</tt> to remote from the list of
	 * 		<tt>SimpleAudioLevelListener</tt>s to be notified about changes in the level of the
	 * 		audio sent from the remote peer(s) to the local peer/user
	 */
	 ...
	 *
	 * @param audioStream
	 * 		the <tt>AudioMediaStream</tt> which this instance is to use to send and receive audio
	 */
	 ...
	 *
	 * @param videoStream
	 * 		the <tt>VideoMediaStream</tt> the <tt>KeyFrameControl</tt> of which is to be set as
	 ...
	 *
	 * @param mediaType
	 * 		the <tt>MediaType</tt> of the <tt>MediaStream</tt> to set the last-known local SSRC of
	 * @param localSSRC
	 * 		the last-known local SSRC of the <tt>MediaStream</tt> of the specified
	 * 		<tt>mediaType</tt>
	 */
	 ...
	 *
	 * @param audioStream
	 * 		the <tt>AudioMediaStream</tt> on which a <tt>VolumeControl</tt> from the specified
	 * 		<tt>call</tt> is to be set
	 * @param call
	 * 		the <tt>MediaAwareCall</tt> which provides the <tt>VolumeControl</tt> to be set on the
	 ...
	 *
	 * @param mediaType
	 * 		the <tt>MediaType</tt> of the <tt>MediaStream</tt> to set the last-known remote SSRC
	 * @param remoteSSRC
	 * 		the last-known remote SSRC of the <tt>MediaStream</tt> of the specified
	 * 		<tt>mediaType</tt>
	 */
	 ...
	 *
	 * @param videoStream
	 * 		the <tt>VideoMediaStream</tt> which this instance is to use to send and receive video
	 */
