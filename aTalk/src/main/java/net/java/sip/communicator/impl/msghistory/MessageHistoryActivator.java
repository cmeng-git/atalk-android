...
public class MessageHistoryActivator implements BundleActivator
{
	...
	public static MetaContactListService getContactListService()
	{
		if (metaCListService == null) {
			metaCListService = ServiceUtils.getService(bundleContext, MetaContactListService
					.class);
		}
	 ...
	 * 		the BundleContext
	 * @throws Exception
	 * 		if initializing and starting message history service fails
	 */
			...
			throws Exception
	{
		...
		try {
			...
			bundleContext.registerService(MessageHistoryService.class.getName(), msgHistoryService,
					null);
