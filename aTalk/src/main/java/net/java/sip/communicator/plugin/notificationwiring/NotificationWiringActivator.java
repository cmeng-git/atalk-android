...
public class NotificationWiringActivator implements BundleActivator {
	...
	/**
	 * Returns an instance of the <tt>ImageLoaderService</tt> obtained from the bundle context.
	 *
	 * @return an instance of the <tt>ImageLoaderService</tt> obtained from the bundle context
	 */
