...
/**
 * A utility class containing methods for creating {@link JingleIQ} instances for various
 * situations.
 *
 * @TODO a number of methods in this class have almost identical bodies. please refactor and reuse
 *       code (Emil).
 *
 * @author Emil Ivov
...
public class JinglePacketFactory
{
	 ...
	 *        the {@link JingleIQ} that established the session which the response is going to
	 *        belong to.
	 *
	...
	/**
	 * Creates a {@link JingleIQ} <tt>session-info</tt> packet carrying a the specified payload
	 * type.
	 *
	 * @param from
	 *        our full jid
	 ...
	 *
	 * @return a {@link JingleIQ} <tt>session-info</tt> packet carrying a the specified payload
	 *         type.
	 */
	 ...
	 *        the ID of the Jingle session this IQ will belong to.
	 * @param type
	 *        the exact type (e.g. ringing, hold, mute) of the session info IQ.
	 *
	 * @return a {@link JingleIQ} <tt>session-info</tt> packet carrying a the specified payload
	 *         type.
	 */
	...
	/**
	 * Creates a {@link JingleIQ} <tt>session-terminate</tt> packet carrying a {@link Reason#BUSY}
	 * payload.
	 *
	 * @param from
	 *        our Jid
	 ...
	 *        the destination Jid
	 * @param sid
	 *        the ID of the Jingle session that this message will be terminating.
	 *
	...
	/**
	 * Creates a {@link JingleIQ} <tt>session-terminate</tt> packet with the specified src, dst,
	 * sid, and reason.
	 *
	 * @param from
	 *        our Jid
	 ...
	 * @param reasonText
	 *        a human readable reason for the termination or <tt>null</tt> for none.
	 *
	 ...
	 *        the ID of the Jingle session that this message will be terminating.
	 * @param contentList
	 *        the content elements containing media and transport descriptions.
	 *
	 * @return the newly constructed {@link JingleIQ} <tt>session-accept</tt> packet.
	 */
	public static JingleIQ createSessionAccept(Jid from, Jid to, String sid,
	 ...
	 *        the ID of the Jingle session that this message will be terminating.
	 * @param contentList
	 *        the content elements containing media transport descriptions.
	 *
	 * @return the newly constructed {@link JingleIQ} <tt>transport-info</tt> packet.
	 */
	public static JingleIQ createTransportInfo(Jid from, Jid to, String sid,
		Iterable<ContentPacketExtension> contentList)
	{
		JingleIQ descriptionInfo = new JingleIQ();
	 ...
	 */
	public static JingleIQ createSessionInitiate(Jid from, Jid to, String sid,
	 ...
	 */
	public static JingleIQ createContentAdd(Jid from, Jid to, String sid,
		List<ContentPacketExtension> contentList)
	{
	 ...
	 */
	public static JingleIQ createContentAccept(Jid from, Jid to, String sid,
		Iterable<ContentPacketExtension> contentList)
	{
	 ...
	 */
	public static JingleIQ createContentReject(Jid from, Jid to, String sid,
		Iterable<ContentPacketExtension> contentList)
	{
	 ...
	 *        the ID of the Jingle session that this message will be terminating.
	 * @param content
	 *        the content element containing media and transport description.
	 *
	 * @return the newly constructed {@link JingleIQ} <tt>content-modify</tt> packet.
	 */
	public static JingleIQ createContentModify(Jid from, Jid to, String sid,
	 ...
	 */
	public static JingleIQ createContentRemove(Jid from, Jid to, String sid,
		Iterable<ContentPacketExtension> contentList)
	{
