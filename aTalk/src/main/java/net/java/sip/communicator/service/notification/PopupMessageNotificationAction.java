...
public class PopupMessageNotificationAction extends NotificationAction
{
	...
	/**
	 * Creates an instance of <tt>PopupMessageNotificationHandlerImpl</tt> by specifying the default message to use if
	 ...
	 *        the default message to use if no message is specified
	 * @param timeout
	 *        suggested timeout in ms for hiding the popup if not clicked by the user, -1 for infinity
	 */
	 ...
	 *        suggested timeout in ms for hiding the popup if not clicked by the user, -1 for infinity
	 * @param groupName
	 *        name of the group that will be used for merging popups
	 */
