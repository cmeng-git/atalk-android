...
public class MetaContactGroupEvent extends EventObject
{
	 ...
	 *
	 * @param source
	 * 		the MetaContactGroup instance that is being modified in the MetaContactList
	 * @param provider
	 * 		the ProtocolProviderService instance where this event occurred
	 ...
	 * @param eventID
	 * 		one of the META_CONTACT_XXX static fields indicating the nature of the event.
	 */
	public MetaContactGroupEvent(MetaContactGroup source, ProtocolProviderService provider,
			ContactGroup sourceProtoGroup, int eventID)
	{
		super(source);
