...
public class MUCServiceImpl extends MUCService
{
     ...
     * @param isFirstAttempt is this the first attempt to join room, used to check whether to show some error
     * messages
            ...
            boolean rememberPassword, boolean isFirstAttempt, String subject)
    {
        ...
        if (chatRoom == null) {
            MUCActivator.getAlertUIService().showAlertDialog(
                    ...
                    MUCActivator.getResources().getI18NString("service.gui.CHAT_ROOM_NOT_CONNECTED",
        ...
        if (chatRoom != null) {
            ...
            MUCActivator.getAlertUIService().showAlertDialog(
                    ...
                    MUCActivator.getResources().getI18NString("service.gui.CHAT_ROOM_NOT_EXIST",
                            new String[]{chatRoomName, chatRoomProvider.getProtocolProvider().getAccountID().getService()}));
    }
    ...
    public ChatRoomWrapper createChatRoom(String roomName, ProtocolProviderService protocolProvider,
            Collection<String> contacts, String reason, boolean persistent, boolean isPrivate)
    {
        return createChatRoom(roomName, protocolProvider, contacts, reason, true, persistent, isPrivate);
    }
            ...
            switch (returnCode) {
                case JOIN_AUTHENTICATION_FAILED_PROP:
                    ...
                    AuthenticationWindow authWindow = authWindowsService.create(null, null, null,
                            ...
                            isFirstAttempt ? null : resources.getI18NString("service.gui.AUTHENTICATION_FAILED",
                                    new String[]{chatRoomId}), null);
                ...
                case JOIN_REGISTRATION_REQUIRED_PROP:
                    errorMessage = resources.getI18NString("service.gui.CHAT_ROOM_REGISTRATION_REQUIRED",
