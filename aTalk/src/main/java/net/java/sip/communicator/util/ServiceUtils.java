...
public class ServiceUtils
{
	 ...
	 *
	 * @param <T>
	 * 		the very type of the OSGi service to get
	 * @param bundleContext
	 * 		the <tt>BundleContext</tt> in which the service to get has been registered
	 * @param serviceClass
	 * 		the <tt>Class</tt> with which the service to get has been registered in the
	 * 		<tt>bundleContext</tt>
	 * @return the OSGi service registered in <tt>bundleContext</tt> with the specified
	 * <tt>serviceClass</tt> if such a
	 * service exists there; otherwise, <tt>null</tt>
	 */
	 ...
	 *
	 * @param bundleContext
	 * 		the <tt>BundleContext</tt> in which the services to get have been registered
	 * @param serviceClass
	 * 		the <tt>Class</tt> of the OSGi service references to get
	 * @return the OSGi service references registered in <tt>bundleContext</tt> with the specified
	 * <tt>serviceClass</tt>
	 * if such a services exists there; otherwise, an empty <tt>Collection</tt>
	 */
