...
public interface AdHocChatRoom
{
	 ...
	 *
	 * @param listener
	 * 		the <tt>MessageListener</tt> to remove from this ad-hoc room
	 */
	 ...
	 *
	 * @param userAddress
	 * 		the address of the <tt>Contact</tt> of the user to invite to the ad-hoc room.
	 * @param reason
	 * 		a reason, subject, or welcome message that would tell users why they are being
	 * 		invited.
	 */
	 ...
	 *
	 * @throws OperationFailedException
	 * 		with the corresponding code if an error occurs while joining the ad-hoc room.
	 */
	public void join()
			throws OperationFailedException;
