...
public abstract class MetaContactPropertyChangeEvent extends PropertyChangeEvent
{
	 ...
	 *
	 * @param source
	 * 		the <tt>MetaContact</tt> that this event is about.
	 * @param eventName
	 * 		one of the META_CONTACT_XXXED <tt>String</tt> strings indicating the exact typ of
	 * 		this event.
	 * @param oldValue
	 * 		the value of the changed property before the change had occurred.
	 * @param newValue
	 * 		the value of the changed property after the change has occurred.
	 */
	public MetaContactPropertyChangeEvent(MetaContact source, String eventName,
