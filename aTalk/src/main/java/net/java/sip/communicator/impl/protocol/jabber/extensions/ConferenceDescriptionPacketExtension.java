...
public class ConferenceDescriptionPacketExtension extends AbstractPacketExtension
{
	 ...
	 *
	 * @param uri
	 *        the value to use for the "uri" attribute.
	 */
	 ...
	 *        the value to use for the "uri" attribute.
	 * @param callId
	 *        the value to use for the "callid" attribute.
	 */
	 ...
	 *        the value to use for the "callid" attribute.
	 * @param password
	 *        the value to use for the "auth" attribute.
	 */
	 ...
	 * 
	 * @param cd
	 *        the <tt>ConferenceDescription</tt> which to represent in the new instance.
	 */
	...
	{
		ConferenceDescription conferenceDescription = new ConferenceDescription(getUri(),
			getCallId(), getPassword());
	...
	public static class TransportPacketExtension extends AbstractPacketExtension
	{
		 ...
		 *
		 * @param namespace
		 *        the XML namespace of the "transport" element.
		 */
		public TransportPacketExtension(String namespace)
		{
			super(TRANSPORT_ELEM_NAME, namespace);
		}
	}
	...
	public static class Provider extends
		ExtensionElementProvider<ConferenceDescriptionPacketExtension>
	{
		/**
		...
		@Override
		public ConferenceDescriptionPacketExtension parse(XmlPullParser parser, int depth)
