...
public interface AdHocChatRoomMessageListener extends EventListener
{
	 ...
	 * 
	 * @param evt
	 *        the <tt>AdHocChatRoomMessageReceivedEvent</tt> containing the newly received message,
	 ...
	 * 
	 * @param evt
	 *        the <tt>AdHocChatRoomMessageDeliveredEvent</tt> containing the id of the message that
	 ...
	 * 
	 * @param evt
	 *        the <tt>AdHocChatroomMessageDeliveryFailedEvent</tt> containing the ID of the message
