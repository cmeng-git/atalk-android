...
public class MessageWaitingEvent extends EventObject
{
	 ...
	 *        the message type for this event.
	 * @param source
	 *        the protocol provider from which this event is coming.
	 * @param account
	 *        the account URI we can use to reach the messages.
	 * @param unreadMessages
	 *        the unread messages.
	 * @param readMessages
	 *        the read messages.
	 * @param unreadUrgentMessages
	 *        the unread urgent messages.
	 * @param readUrgentMessages
	 *        the read urgent messages.
	 */
	 ...
	 *        the read urgent messages.
	 * @param messages
	 *        the list of messages that this event is about.
	 */
	public MessageWaitingEvent(ProtocolProviderService source,
		OperationSetMessageWaiting.MessageType messageType, String account, int unreadMessages,
		int readMessages, int unreadUrgentMessages, int readUrgentMessages,
