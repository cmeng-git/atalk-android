...
public interface OperationSetServerStoredAccountInfo extends OperationSet
{
     ...
     * @return a java.util.Iterator over all details that are instances or descendants of the specified class.
     */
    <T extends GenericDetail> Iterator<T> getDetailsAndDescendants(Class<T> detailClass);
     ...
     * AddressDetail.class would return only the AddressDetail instance and not the WorkAddressDetail instance.
     *
     * @param detailClass one of the detail classes defined in the ServerStoredDetails class, indicating the
     * kind of details we're interested in.
     *
     ...
     */
    Iterator<GenericDetail> getDetails(Class<? extends GenericDetail> detailClass);
     ...
     */
    boolean isDetailClassSupported(Class<? extends GenericDetail> detailClass);
     ...
     */
    boolean isDetailClassEditable(Class<? extends GenericDetail> detailClass);

    /**
     * The method returns the number of instances supported for a particular detail type. Some
     * protocols offer storing mutliple values for a particular detail type. Spoken languages are a good example.
     *
     ...
     */
    int getMaxDetailInstances(Class<? extends GenericDetail> detailClass);
     ...
     * the underlying implementation does not support setting details of the corresponding class.
     *
     ...
     * @throws OperationFailedException with code Network Failure if putting the new value back online has failed
     */
