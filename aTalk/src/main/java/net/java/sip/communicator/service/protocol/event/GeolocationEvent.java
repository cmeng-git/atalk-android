...
public class GeolocationEvent extends EventObject
{
	 ...
	 * @param geolocationOpSet
	 *        the operation set that generated this event
	 */
	public GeolocationEvent(Contact sourceContact, ProtocolProviderService sourceProvider,
		Map<String, String> newLocation, OperationSetGeolocation geolocationOpSet)
	{
	...
	/**
	 * Returns the Geolocation of the contact after this event took place. (i.e. at the time the
	 * event is being dispatched).
	 *
	 * @return geolocation stored into a Map indicating the current location of the source Contact
	 *         at the moment the event was dispatched.
	 */
