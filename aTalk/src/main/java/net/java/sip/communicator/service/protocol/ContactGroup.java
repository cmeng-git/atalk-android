 ...
 * directly modified by users of the protocol provider service. In order to add buddies or subgroups
 * to a <tt>ContactGroup</tt> one needs to do so through the <tt>OperationSetPersistentPresence</tt>
 * interface.
 *
 * @author Emil Ivov
...
public interface ContactGroup
{
	 ...
	 */
	public static final String ROOT_GROUP_UID= "RootMetaContactGroup";
	public static final String ROOT_PROTO_GROUP_UID = "ContactListRoot";

	/**
	 * The name of the node that represents the contact list root.
	 */
	public static final String ROOT_NAME = "aTalk";

	/**
	 * The default name of the root contact group
	 */
	public static final String ROOT_GROUP_NAME = "Contacts";

	/**
	 * Returns an iterator over the sub groups that this <tt>ContactGroup</tt> contains.
	 *
	 * @return a java.util.Iterator over the <tt>ContactGroup</tt> children of this group (i.e.
	 *         subgroups).
	 */
	 ...
	 * 
	 * @param index
	 *        the index of the <tt>ContactGroup</tt> to retrieve.
	 ...
	 * 
	 * @param groupName
	 *        the name of the <tt>ContactGroup</tt> to retrieve.
	 * @return the <tt>ContactGroup</tt> with the specified index.
	 */
	 ...
	 * 
	 * @param id
	 *        the address or identifier of the <tt>Contact</tt> we are looking for.
	 ...
	 * 
	 * @return true if the groups may be a parent of other <tt>ContactGroup</tt>s and false
	 *         otherwise.
	 */
	...
	/**
	 * Returns the contact group that currently contains this group or null if this is the root
	 * contact group.
	 * 
	 * @return the contact group that currently contains this group or null if this is the root
	 *         contact group.
	 */
	 ...
	 * way to return a unique identifier in this method and this UID should never change for a given
	 * group.
	 *
	 ...
	 * 
	 * @return true if the group has been resolved (mapped against a server stored group) and false
	 *         otherwise.
	 */
	boolean isResolved();
