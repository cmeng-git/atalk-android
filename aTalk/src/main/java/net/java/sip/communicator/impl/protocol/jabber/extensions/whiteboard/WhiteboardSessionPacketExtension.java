 ...
 */
public class WhiteboardSessionPacketExtension implements ExtensionElement
{
	private Logger logger = Logger.getLogger(WhiteboardSessionPacketExtension.class);

	/**
	 * A type string constant indicating that the user would like to leave the current white board
	 * session.
	 */
	 ...
	 *
	 * @param session
	 *        The WhiteboardSession to be treated
	 * @param contactAddress
	 *        The address of the contact associated with this packet extension
	 * @param action
	 *        The current action associated with the WhiteboardSession.
	 */
	public WhiteboardSessionPacketExtension(WhiteboardSessionJabberImpl session,
		String contactAddress, String action)
	{
	...
	public String toXML()
	{
		...
		return "<" + WhiteboardSessionPacketExtension.ELEMENT_NAME + " xmlns=\""
			+ WhiteboardSessionPacketExtension.NAMESPACE + "\">" + s + "</"
