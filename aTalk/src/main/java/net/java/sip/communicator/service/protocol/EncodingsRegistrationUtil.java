...
public class EncodingsRegistrationUtil implements Serializable
{
	 ...
	 *
	 * @param override
	 *        The value to set the override encoding settings to.
	 */
	...
	/**
	 * Loads encoding properties from given <tt>accountID</tt> into this encodings registration
	 * object.
	 * 
	 * @param accountID
	 *        the <tt>AccountID</tt> to be loaded.
	 * @param mediaService
	 *        the <tt>MediaService</tt> that will be used to create <tt>EncodingConfiguration</tt>.
	 */
	public void loadAccount(AccountID accountID, MediaService mediaService)
	{
		String overrideEncodings = accountID
			.getAccountPropertyString(ProtocolProviderFactory.OVERRIDE_ENCODINGS);
		...
		EncodingConfiguration encodingConfiguration = mediaService
	 ...
	 * 
	 * @param propertiesMap
	 *        the properties map that will be used.
	 */
	public void storeProperties(Map<String, String> propertiesMap)
	{
		propertiesMap.put(ProtocolProviderFactory.OVERRIDE_ENCODINGS,
	...
	/**
	 * Creates new instance of <tt>EncodingConfiguration</tt> reflecting this object's encoding
	 * configuration state.
	 * 
	 * @param mediaService
	 *        the <tt>MediaService</tt> that will be used to create new instance of
