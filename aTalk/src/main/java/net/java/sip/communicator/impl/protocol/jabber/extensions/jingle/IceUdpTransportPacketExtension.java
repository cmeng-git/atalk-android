...
public class IceUdpTransportPacketExtension extends AbstractPacketExtension
{
    ...
    /**
     * Adds <tt>candidate</tt> to the list of {@link CandidatePacketExtension}s registered with this transport.
     *
     * @param candidate the new {@link CandidatePacketExtension} to add to this transport element.
     */
    ...
    /**
     * Removes <tt>candidate</tt> from the list of {@link CandidatePacketExtension}s registered with this transport.
     *
     * @param candidate the <tt>CandidatePacketExtension</tt> to remove from this transport element
     ...
     *
     * @param candidate the new {@link CandidatePacketExtension} to set as an in-use candidate for this session.
     */
    ...
    /**
     * Checks whether an 'rtcp-mux' extension has been added to this <tt>IceUdpTransportPacketExtension</tt>.
     *
     * @return <tt>true</tt> if this <tt>IceUdpTransportPacketExtension</tt> has a child with the 'rtcp-mux' name.
     */
     ...
     *
     * @param src the <tt>IceUdpTransportPacketExtension</tt> to be cloned
     * @param copyDtls if <tt>true</tt> will also copy {@link DtlsFingerprintPacketExtension}.
     * @return a new <tt>IceUdpTransportPacketExtension</tt> instance which has the same run-time
     * type, attributes, namespace, text and candidates as the specified <tt>src</tt>
     */
