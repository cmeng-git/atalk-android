...
public interface OperationSetMultiUserChat extends OperationSet
{
	...
	/**
	 * Returns a list of the chat rooms that <tt>chatRoomMember</tt> has joined and is currently
	 * active in.
	 *
	 * @param chatRoomMember
	 *        the chatRoomMember whose current ChatRooms we will be querying.
	 ...
	 *        properties specifying how the room should be created; <tt>null</tt> for no properties
	 ...
	 * 
	 * @return <tt>true</tt> if the contact address is associated with private messaging contact and
	 *         <tt>false</tt> if not.
	 */
