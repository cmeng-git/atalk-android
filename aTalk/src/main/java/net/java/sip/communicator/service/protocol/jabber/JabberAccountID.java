...
public class JabberAccountID extends AccountID {
    ...
    // Auto-generated resource prefix
    private static final String RESOURCE_PREFIX = "atalk_";
    ...
    public void setResourceAutoGenerated(boolean resourceAutoGenerated) {
        ...
        if (resourceAutoGenerated && (getResource().length() < 10)) {
                SecureRandom random = new SecureRandom();
                String sResource = RESOURCE_PREFIX + new BigInteger(32, random).toString(32);
