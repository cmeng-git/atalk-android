...
public class JabberAccountID extends AccountID
{
	 ...
	 * 
	 * @param id
	 *        the id identifying this account i.e hawk@example.org
	...
	public JabberAccountID(String id, Map<String, String> accountProperties)
	{
		...
		String resource =  getAccountPropertyString(ProtocolProviderFactory.RESOURCE, "atalk");
		String userJid = id + "/" + resource;
		try {
			FullJid fullJid = JidCreate.fullFrom(userJid);
			setFullJid(fullJid);
		}
	...
	{
		return getAccountPropertyBoolean(ProtocolProviderFactory.IS_CALLING_DISABLED_FOR_ACCOUNT,
			false);
	}
	 ...
	 *
	 * @param phoneSuffix
	 *        the phone name suffix (the domain name after the @ sign)
	 */
	 ...
	 *
	 * @param disabled
	 *        True if jingle is disabled for this account. False otherwise.
	 */
	 ...
	 *
	 * @param enabled
	 *        <tt>true</tt> if we are to enable Gmail notification and <tt>false</tt> otherwise.
	 */
	 ...
	 *
	 * @param enabled
	 *        <tt>true</tt> if we are to enable Google Contacts and <tt>false</tt> otherwise.
	 */
	 ...
	 * 
	 * @param resource
	 *        the resource for the jabber account
	 */
	 ...
	 * 
	 * @param isUseIce
	 *        <tt>true</tt> to indicate that ICE should be used for this account, <tt>false</tt> -
	 *        otherwise.
	 */
	 ...
	 * 
	 * @param isAutoDiscover
	 *        <tt>true</tt> to indicate that stun server should be auto-discovered, <tt>false</tt> -
	 *        otherwise.
	 */
	 ...
	 * 
	 * @param isUseDefaultStunServer
	 *        <tt>true</tt> to indicate that default stun server should be used if no others are
	 ...
	 *
	 * @param isAutoDiscover
	 *        <tt>true</tt> to indicate that relay server should be auto-discovered, <tt>false</tt>
	 *        - otherwise.
	 */
	 ...
	 *
	 * @param isUseJingleNodes
	 *        <tt>true</tt> to indicate that Jingle Nodes should be used for this account,
	 ...
	 * 
	 * @param isUseUPNP
	 *        <tt>true</tt> to indicate that UPnP should be used for this account, <tt>false</tt> -
	 *        otherwise.
	 */
	 ...
	 * 
	 * @param isAllowNonSecure
	 *        <tt>true</tt> to indicate that non-TLS is allowed for this account, <tt>false</tt> -
	 *        otherwise.
	 */
	 ...
	 * 
	 * @param isCarbonEnabled
	 *        <tt>true</tt> to indicate that message carbons are allowed for this account,
	 *        <tt>false</tt> - otherwise.
	 */
	 ...
	 *        <tt>true</tt> to indicate that the resource is to be auto generated,
	 *        <tt>false</tt> - otherwise.
	 */
	 ...
	 *
	 * @param serverAddress
	 *        the sms server to set as default
	 */
