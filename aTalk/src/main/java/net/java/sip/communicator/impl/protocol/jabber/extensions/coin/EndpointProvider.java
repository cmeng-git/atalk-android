...
public class EndpointProvider extends ExtensionElementProvider<EndpointPacketExtension>
{
	 ...
	 *
	 * @param parser
	 *        an XML parser positioned at the opening <tt>Endpoint</tt> element.
	 *
			...
			try {
				if (eventType == XmlPullParser.START_TAG) {
					if (elementName.equals(EndpointPacketExtension.ELEMENT_DISPLAY_TEXT)) {
						...
						DefaultPacketExtensionProvider<CallInfoPacketExtension> provider = new DefaultPacketExtensionProvider<CallInfoPacketExtension>(
