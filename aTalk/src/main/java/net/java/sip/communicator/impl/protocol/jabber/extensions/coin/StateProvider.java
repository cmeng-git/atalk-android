 ...
 */
public class StateProvider extends ExtensionElementProvider<StatePacketExtension>
{
	/**
	 * Parses a state extension sub-packet and creates a {@link StatePacketExtension} instance. At
	 ...
	 *
	 * @param parser
	 *        an XML parser positioned at the opening <tt>State</tt> element.
	 *
