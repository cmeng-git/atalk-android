 ...
 * instance, maybe some type of received messages should not be shown in the chat windows. In such
 * cases implementations of this filter would block this message before it is delivered to other IM
 * listeners.
 * <p>
