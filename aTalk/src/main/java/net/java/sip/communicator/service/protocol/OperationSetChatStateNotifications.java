...
public interface OperationSetChatStateNotifications extends OperationSet
{
	 ...
	 * 
	 * @param l
	 *        the <tt>ChatStateNotificationsListener</tt> listener that we'd like to add
	 */
	public void addChatStateNotificationsListener(ChatStateNotificationsListener l);
	 ...
	 * 
	 * @param l
	 *        the <tt>ChatStateNotificationsListener</tt> listener that we'd like to remove
	 */
	public void removeChatStateNotificationsListener(ChatStateNotificationsListener l);
	 ...
	 * @param chatState
	 *        the chat state as defined in ChatState that we have entered.
	 *
	 ...
	 *         implementation.
	 */
	public void sendChatStateNotification(Contact notifiedContact, ChatState chatState)
