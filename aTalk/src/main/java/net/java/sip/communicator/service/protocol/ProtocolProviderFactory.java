...
public abstract class ProtocolProviderFactory
{
	 ...
	 *
	 * @param bundleContext
	 * 		the bundle context reference of the service
	 * @param protocolName
	 ...
	 *
	 * @param userID
	 * 		the user identifier uniquely representing the newly created account within the
	 * 		protocol namespace.
	 * @param accountProperties
	 * 		a set of protocol (or implementation) specific properties defining the new account.
	 * @return the AccountID of the newly created account.
	 * @throws java.lang.IllegalArgumentException
	 * 		if userID does not correspond to an identifier in the context of the underlying
	 * 		protocol or if accountProperties does not contain a complete set of account
	 * 		installation properties.
	 * @throws java.lang.IllegalStateException
	 * 		if the account has already been installed.
	 ...
	 * 		the protocol provider service corresponding to the modified account.
	 * @param accountProperties
	 * 		a set of protocol (or implementation) specific properties defining the new account.
	 * @throws java.lang.NullPointerException
	 * 		if any of the arguments is null.
	 ...
	 *
	 * @param accountID
	 * 		the accountID of the protocol provider we'd like to get
	 ...
	 * account corresponding to the specified ID will not be loaded during future runs of the
	 * project.
	 *
	 * @param accountID
	 ...
	 *
	 * @param accountID
	 * 		the AccountID corresponding to the account that we would like to store.
	 */
	 ...
	 * 		if <tt>false</tt> there must be no such already loaded account, it <tt>true</tt> ist
	...
	protected void storeAccount(AccountID accountID, boolean isModification)
	{
		if (!isModification && getAccountManager().getStoredAccounts().contains(accountID)) {
			throw new IllegalStateException("An account for id " + accountID.getUserID()
					+ " was already loaded!");
		}
		try {
	 ...
	 *
	 * @param accountID
	 * 		the AccountID for the account whose password we're storing
	 * @param password
	 * 		the password itself
	 * @throws IllegalArgumentException
	 * 		if no account corresponding to <code>accountID</code> has been previously stored
	 */
	 ...
	 * @param accountID
	 * 		the <tt>AccountID</tt> of the account whose password is to be stored
	 * @param password
	 * 		the password to be stored
	 * @throws IllegalArgumentException
	 * 		if no account corresponding to <tt>accountID</tt> has been previously stored.
	 * @throws OperationFailedException
	 * 		if anything goes wrong while storing the specified <tt>password</tt>
	 */
	 ...
	 *
	 * @param accountID
	 * 		the AccountID for the account whose password we're looking for
	 ...
	 *
	 * @param userID
	 * 		the user ID of the new instance
	 * @param accountProperties
	 * 		the set of properties to be represented by the new instance
	 ...
	 * @param accountID
	 * 		the <code>AccountID</code> to be represented by the new instance
	 ...
	 * 		a currently valid bundle context.
	 * @param accountID
	 * 		the AccountID of the account whose properties we're looking for.
	 * @param sourcePackageName
	 * 		a String containing the package name of the concrete factory class that extends us.
	 ...
	 * this factory.
	 *
	 * @param registeredAccount
	 * 		the <code>ServiceRegistration</code> of the <code>ProtocolProviderService</code>
	...
	{
		ProtocolProviderService protocolProviderService = getBundleContext().getService(
	 ...
	 *
	 * @param bundleContext
	 * 		the OSGI bundle context that will be used.
	 * @param protocolName
	 * 		the protocol name.
	 * @return Registered <tt>ProtocolProviderFactory</tt> for given protocol name or <tt>null</tt>
	 * if no provider was found.
	 */
	public static ProtocolProviderFactory getProtocolProviderFactory(BundleContext bundleContext,
			String protocolName)
	{
