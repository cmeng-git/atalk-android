...
public class OperationSetExtendedAuthorizationsJabberImpl implements OperationSetExtendedAuthorizations
{
	 ...
	 * 
	 * @param contact
	 *        the <tt>Contact</tt> whom we're granting authorization prior to receiving a request.
	 ...
	 *
	 * @param request
	 *        the <tt>AuthorizationRequest</tt> that we'd like the protocol provider to send to
	 *        <tt>contact</tt>.
	 * @param contact
	 *        the <tt>Contact</tt> who we'd be asking for an authorization.
	 * @throws OperationFailedException
	 *         if we fail sending the authorization request.
	 */
