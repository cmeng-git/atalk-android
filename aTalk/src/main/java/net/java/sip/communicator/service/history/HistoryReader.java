...
public interface HistoryReader
{
	 ...
	 * 		Thrown if an exception occurs during the execution of the query, such as internal IO
	 * 		error.
	 */
	 ...
	 * 		error.
	 */
	public QueryResultSet<HistoryRecord> findByKeyword(String keyword, String field)
			throws RuntimeException;
	 ...
	 * 		error.
	 */
	public QueryResultSet<HistoryRecord> findByKeyword(String keyword, String field, boolean
			caseSensitive)
			throws RuntimeException;
	 ...
	 * 		error.
	 */
	public QueryResultSet<HistoryRecord> findByKeywords(String[] keywords, String field)
			throws RuntimeException;
	 ...
	 * 		error.
	 */
	public QueryResultSet<HistoryRecord> findByKeywords(String[] keywords, String field, boolean
			caseSensitive)
			throws RuntimeException;
	 ...
	 * 		error.
	 */
	public QueryResultSet<HistoryRecord> findByPeriod(Date startDate, Date endDate, String[]
