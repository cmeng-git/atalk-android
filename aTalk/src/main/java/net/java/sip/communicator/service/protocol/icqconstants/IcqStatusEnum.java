...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>IcqStatusEnum</tt> class and its instances for logging
	 * output.
	 */
	 ...
	 */
	public static final IcqStatusEnum FREE_FOR_CHAT = new IcqStatusEnum(85, "Free For Chat",
	 ...
	 */
	public static final IcqStatusEnum AWAY = new IcqStatusEnum(48, "Away",
	 ...
	 */
	public static final IcqStatusEnum INVISIBLE = new IcqStatusEnum(45, "Invisible",
	 ...
	 *
	 */
	public static final IcqStatusEnum NOT_AVAILABLE = new IcqStatusEnum(35, "Not Available",
	 ...
	 */
	public static final IcqStatusEnum DO_NOT_DISTURB = new IcqStatusEnum(30, "Do Not Disturb",
	 ...
	 */
	public static final IcqStatusEnum OCCUPIED = new IcqStatusEnum(25, "Occupied",
	 ...
	 */
	public static final ArrayList<IcqStatusEnum> icqStatusSet = new ArrayList<IcqStatusEnum>();
	static {
	 ...
	 * 
	 * @param status
	 *        the connectivity coefficient for the specified status
	 * @param statusName
	 *        String
	 * @param statusIcon
