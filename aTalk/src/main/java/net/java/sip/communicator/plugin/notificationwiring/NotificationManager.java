		...
		ChatStateNotificationsListener
{
	 ...
	 * 		the chat contact to which the chat message corresponds; the chat contact could be a
	 * 		Contact or a ChatRoom.
	 * @param eventType
	 * 		the event type for which we fire a notification
	 * @param messageTitle
	 ...
	 *
	 * @param eventType
	 * 		the event type for which we want to fire a notification
	 */
	 ...
	 * 		the event type for which we want to fire a notification
	 * @param loopCondition
	 * 		the method which will determine whether any sounds played as part of the specified
	 ...
	 *
	 * @param eventType
	 * 		the event type of the notification to be fired
	 * @param messageTitle
	 * 		the title of the message to be displayed by the notification to be fired if such a
	 * 		display is supported
	 * @param message
	 * 		the message to be displayed by the notification to be fired if such a display is
	 * 		supported
	 */
	 ...
	 *
	 * @param weakPeer
	 * 		the <tt>CallPeer</tt> for which it is to be determined whether the <tt>DIALING</tt>
	 ...
	 *
	 * @param evt
	 * 		the <tt>CallPeerEvent</tt> that notifies us for the change
	 */
	 ...
	 *
	 * @param evt
	 * 		the <tt>CallPeerEvent</tt> that has been triggered
	 */
	 ...
	 *
	 * @param event
	 * 		<tt>FileTransferRequestEvent</tt>
	...
	private void handleProviderAdded(ProtocolProviderService protocolProvider)
	{
		...
		if (supportedOperationSets.containsKey(smsOpSetClassName)) {
			OperationSetSmsMessaging sms = (OperationSetSmsMessaging)
...
//								nickname.substring(0, atIx).toLowerCase()));
	 ...
	 *
	 * @param evt
	 * 		the <tt>MessageReceivedEvent</tt> containing details on the received message
	 */
	 ...
	 *
	 * @param data
	 * 		the event type for which we should stop sounds. One of the static event types defined
	 * 		in this class.
	 */
