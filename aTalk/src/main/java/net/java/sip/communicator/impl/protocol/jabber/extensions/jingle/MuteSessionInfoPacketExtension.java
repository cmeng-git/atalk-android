...
public class MuteSessionInfoPacketExtension extends SessionInfoPacketExtension
{
	...
	/**
	 * Creates a <tt>SessionInfoPacketExtension</tt> instance corresponding to either the
	 * {@link SessionInfoType#mute} or {@link SessionInfoType#unmute} types according to the value
	 * of the <tt>mute</tt> parameter.
	 *
	 * @param mute
	 *        <tt>true</tt> if the new instance is to be of the {@link SessionInfoType#mute} type
	 *        and <tt>false</tt> for a {@link SessionInfoType#unmute}
	 * @param name
	 *        the name of the session to be muted or <tt>null</tt> if the element pertains to all
	 *        active sessions
	 */
	 ...
	 *
	 * @return <tt>true</tt> if this packet represents a {@link SessionInfoType#mute} and
