 ...
 * <code>CallPeerConferenceListener</code>s about changes in its conference-related information such
...
public class CallPeerConferenceEvent extends EventObject
{
	...
	/**
	 * The ID of <code>CallPeerConferenceEvent</code> which notifies about an addition to the list
	 * of <code>ConferenceMember</code>s managed by a specific <code>CallPeer</code>. The
	 * <code>conferenceMember</code> property specifies the <code>ConferenceMember</code> which was
	 * added and thus caused the event to be fired.
	 */
	public static final int CONFERENCE_MEMBER_ADDED = 2;

	/**
	 * The ID of <code>CallPeerConferenceEvent</code> which notifies about a removal from the list
	 * of <code>ConferenceMember</code>s managed by a specific <code>CallPeer</code>. The
	 * <code>conferenceMember</code> property specifies the <code>ConferenceMember</code> which was
	...
	/**
	 * The ID of this event which may be one of {@link #CONFERENCE_FOCUS_CHANGED},
	 * {@link #CONFERENCE_MEMBER_ADDED}, {@link #CONFERENCE_MEMBER_ERROR_RECEIVED} and
	 ...
	 * not including a change pertaining to a specific <code>ConferenceMember</code>.
	 *
	 * @param sourceCallPeer
	 *        the <code>CallPeer</code> which is to fire the new event
	 * @param eventID
	 *        the ID of this event which may be {@link #CONFERENCE_FOCUS_CHANGED} and indicates the
	 ...
	 */
	public CallPeerConferenceEvent(CallPeer sourceCallPeer, int eventID,
		ConferenceMember conferenceMember, String errorString)
	{
	...
	/**
	 * Gets the <code>ConferenceMember</code> which has been changed (e.g. added to or removed from
	...
	/**
	 * Gets the ID of this event which may be one of {@link #CONFERENCE_FOCUS_CHANGED},
	 * {@link #CONFERENCE_MEMBER_ADDED} and {@link #CONFERENCE_MEMBER_REMOVED} and indicates the
	 * specifics of the change in the conference-related information and the details this event
	 * carries.
	 *
	 * @return the ID of this event which may be one of {@link #CONFERENCE_FOCUS_CHANGED},
	 *         {@link #CONFERENCE_MEMBER_ADDED} and {@link #CONFERENCE_MEMBER_REMOVED} and indicates
	...
	/**
	 * Gets the <code>CallPeer</code> which is the source of/fired the event.
	 *
	 * @return the <code>CallPeer</code> which is the source of/fired the event
	 */
