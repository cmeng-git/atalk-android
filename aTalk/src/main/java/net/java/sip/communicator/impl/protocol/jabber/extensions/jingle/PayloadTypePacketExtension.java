...
public class PayloadTypePacketExtension extends AbstractPacketExtension
{
     ...
     * @return the copy.
     */
    public static PayloadTypePacketExtension clone(PayloadTypePacketExtension source)
    {
        PayloadTypePacketExtension destination = AbstractPacketExtension.clone(source);
