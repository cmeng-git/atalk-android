...
{
	/**
	 * An event id value indicating that this event has been triggered as a result of a call being
	 * ended (all its peers have left).
	 */
	public static final int CALL_ENDED = 3;

	/**
	 * An event id value indicating that this event has been triggered as a result of an outgoing
	 * call.
	 */
	public static final int CALL_INITIATED = 1;

	/**
	 * An event id value indicating that this event has been triggered as a result of an incoming
	 * call.
	 */
	...
	/**
	 * The conference of the call for this event. Must be set when creating this event, because when
	 * a call ends, the call conference may be released just after creating this event, but its
	 * reference will still be necessary in the futur for the UI (i.e to release the call panel),
	 */
	 ...
	 *
	 * @param call
	 *        the call that triggered this event.
	 * @param eventID
	 *        determines whether this is an incoming or an outgoing call.
	 */
	 ...
	 * @param eventID
	 *        the indicator which determines whether the new instance will represent an event
	 *        notifying that an incoming <tt>Call</tt> was received, an outgoing <tt>Call</tt> was
	 *        initiated, or a <tt>Call</tt> ended
	...
	/**
	 * Returns an event ID int indicating whether this event was triggered by an outgoing or an
	 * incoming call.
	 *
