 ...
 * will change to ALERTING_REMOTE_SIDE, and when she replies she will enter a CONNCECTED state.
 *
 * <p>
 * Though not mandatory CallPeerState would generally have one of the following life cycles
 *
 * <p>
 * In the case with your grand mother that we just described we have: <br>
 * INITIATING_CALL -> CONNECTING -> ALERTING_REMOTE_USER -> CONNECTED -> DISCONNECTED
 *
 * <p>
 * If your granny was already on the phone we have: <br>
 * INITIATING_CALL -> CONNECTING -> BUSY -> DISCONNECTED
 *
 * <p>
 * Whenever someone tries to reach you: <br>
 ...
 *
 * <p>
 * Information on call peer is shown in the phone user interface until they enter the DISCONNECTED
 * state. At that point call peer information is automatically removed from the user interface and
 * the call is considered terminated.
 *
 * @author Emil Ivov
...
{
	/**
	 * This constant value indicates a String representation of the UNKNOWN call state. <br>
	 * This constant has the String value "Unknown".
	 */
	public static final String _UNKNOWN = "Unknown";

	/**
	 * This constant value indicates that the state of the call peer is is UNKNOWN - which means
	 ...
	 */
	public static final CallPeerState UNKNOWN = new CallPeerState(_UNKNOWN,
		ProtocolProviderActivator.getResourceService().getI18NString("service.gui.UNKNOWN_STATUS"));

	/**
	 * This constant value indicates a String representation of the INITIATING_CALL call state. <br>
	 * This constant has the String value "Initiating Call".
	 */
	public static final String _INITIATING_CALL = "Initiating Call";

	/**
	 * This constant value indicates that the state of the call peer is is INITIATING_CALL - which
	...
	/**
	 * This constant value indicates a String representation of the CONNECTING call state. <br>
	...
	/**
	 * This constant value indicates a String representation of the CONNECTING call state but in
	 * cases where early media is being exchanged. <br>
	 * This constant has the String value "Connecting".
	 */
	...
	public static final CallPeerState CONNECTING_WITH_EARLY_MEDIA = new CallPeerState(
		_CONNECTING_WITH_EARLY_MEDIA, ProtocolProviderActivator.getResourceService().getI18NString(
	 ...
	 * process before hearing the other peer we can still can hear media coming from the server for
	 * example.
	 */
	...
	/**
	 * This constant value indicates a String representation of the ALERTING_REMOTE_SIDE call state. <br>
	...
	/**
	 * This constant value indicates that the state of the call peer is is ALERTING_REMOTE_SIDE -
	...
	public static final CallPeerState ALERTING_REMOTE_SIDE = new CallPeerState(
		_ALERTING_REMOTE_SIDE, ProtocolProviderActivator.getResourceService().getI18NString(
			"service.gui.RINGING_STATUS"));

	/**
	 * This constant value indicates a String representation of the INCOMING_CALL call state. <br>
	 * This constant has the String value "Incoming Call".
	 */
	public static final String _INCOMING_CALL = "Incoming Call";

	/**
	 * This constant value indicates that the state of the call peer is is INCOMING_CALL - which
	...
	/**
	 * This constant value indicates a String representation of the CONNECTED call state. <br>
	 * This constant has the String value "Connected".
	 */
	public static final String _CONNECTED = "Connected";

	/**
	 * This constant value indicates that the state of the call peer is is CONNECTED - which means
	...
	public static final CallPeerState CONNECTED = new CallPeerState(_CONNECTED,
		ProtocolProviderActivator.getResourceService()
			.getI18NString("service.gui.CONNECTED_STATUS"));

	/**
	 * This constant value indicates a String representation of the DISCONNECTED call state. <br>
	 * This constant has the String value "Disconnected".
	 */
	public static final String _DISCONNECTED = "Disconnected";

	/**
	 * This constant value indicates that the state of the call peer is is DISCONNECTED - which
	 * means that this peer is not participating :) in the call any more.
	 */
	...
	/**
	 * This constant value indicates a String representation of the REFERRED call state. <br>
	 * This constant has the String value "Referred".
	 */
	public static final String _REFERRED = "Referred";

	/**
	 * This constant value indicates that the state of the call peer is is REFERRED - which means
	 * that this peer has transfered us to another peer.
	 */
	public static final CallPeerState REFERRED = new CallPeerState(_REFERRED,
		ProtocolProviderActivator.getResourceService().getI18NString("service.gui.REFERRED_STATUS"));

	/**
	 * This constant value indicates a String representation of the BUSY call state. <br>
	 * This constant has the String value "Busy".
	 */
	public static final String _BUSY = "Busy";

	/**
	 * This constant value indicates that the state of the call peer is is BUSY - which means that
	 ...
	 */
	public static final CallPeerState BUSY = new CallPeerState(_BUSY, ProtocolProviderActivator
		.getResourceService().getI18NString("service.gui.BUSY_STATUS"));

	/**
	 * This constant value indicates a String representation of the FAILED call state. <br>
	 * This constant has the String value "Failed".
	 */
	public static final String _FAILED = "Failed";
	/**
	 * This constant value indicates that the state of the call peer is is ON_HOLD - which means
	 * that an attempt to establish a call with that peer has failed for an unexpected reason.
	 */
	public static final CallPeerState FAILED = new CallPeerState(_FAILED, ProtocolProviderActivator
		.getResourceService().getI18NString("service.gui.FAILED_STATUS"));
	 ...
	 *
	 * @param state
	 *        the <tt>CallPeerState</tt> value to be checked whether it signals a call hold
	 * @return <tt>true</tt> if the specified <tt>state</tt> signals a call hold; <tt>false</tt>,
	 *         otherwise
	 */
	...
	/**
	 * A string representation of this peer's Call State. Could be _CONNECTED, _FAILED, _CALLING and
	 * etc.
	 */
	 ...
	 * @param callStateLocalizedStr
	 *        the localized string representing this state
	 */
