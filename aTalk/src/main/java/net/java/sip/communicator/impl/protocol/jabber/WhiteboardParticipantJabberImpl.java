...
public class WhiteboardParticipantJabberImpl implements WhiteboardParticipant
{
	...
	/**
	 * A byte array containing the image/photo representing the whiteboard participant.
	 */
	private byte[] image;
	...
	/**
	 * Creates a new whiteboard participant with address <tt>participantAddress</tt>.
	 *
	 * @param participant
	 *        the JAIN SIP <tt>Address</tt> of the new whiteboard participant.
	 *
	 * @param owningWhiteboard
	 *        the whiteboard that contains this whiteboard participant.
	 */
	...
	/**
	 * Causes this WhiteboardParticipant to enter the specified state. The method also sets the
	 * currentStateStartDate field and fires a WhiteboardParticipantChangeEvent.
	 *
	 * @param newState
	 *        the state this whiteboard participant should enter.
	 * @param reason
	...
	protected void setState(WhiteboardParticipantState newState, String reason)
	{
		...
		fireWhiteboardParticipantChangeEvent(
			WhiteboardParticipantChangeEvent.WHITEBOARD_PARTICIPANT_STATE_CHANGE, oldState,
			newState);
	}
	 ...
	 *
	 * @return a java.util.Date object containing the date when this whiteboard participant entered
	 *         its current state.
	 */
	...
	protected void setDisplayName(String displayName)
	{
		 ...
		 * //couldn't happen logger.error(ex.getMessage(), ex); throw new
		 * IllegalArgumentException(ex.getMessage()); }
		 */
		// Fire the Event
		fireWhiteboardParticipantChangeEvent(
			WhiteboardParticipantChangeEvent.WHITEBOARD_PARTICIPANT_DISPLAY_NAME_CHANGE, oldName,
			displayName);
	}
	...
	/**
	 * Sets the byte array containing an image representation (photo or picture) of the whiteboard
	 * participant.
	 *
	 * @param image
	...
	protected void setImage(byte[] image)
	{
		...
		// Fire the Event
		fireWhiteboardParticipantChangeEvent(
			WhiteboardParticipantChangeEvent.WHITEBOARD_PARTICIPANT_IMAGE_CHANGE, oldImage, image);
	}
	 ...
	 *
	 * @param participantID
	 *        the ID of this whiteboard participant.
	 */
	 ...
	 *
	 * @param whiteboard
	 *        the whiteboard that this whiteboard participant is partdicipating in.
	 */
	...
	/**
	 * Returns the contact corresponding to this participant or null if no particular contact has
	 * been associated.
	 * <p>
	 *
	 * @return the <tt>Contact</tt> corresponding to this participant or null if no particular
	...
	/**
	 * Constructs a <tt>WhiteboardParticipantChangeEvent</tt> using this whiteboard participant as
	 * source, setting it to be of type <tt>eventType</tt> and the corresponding <tt>oldValue</tt>
	 * and <tt>newValue</tt>,
	 *
	 * @param eventType
	 ...
	 */
	protected void fireWhiteboardParticipantChangeEvent(String eventType, Object oldValue,
		Object newValue)
	{
	...
	{
		WhiteboardParticipantChangeEvent evt = new WhiteboardParticipantChangeEvent(this,
			eventType, oldValue, newValue, reason);

		if (logger.isDebugEnabled())
			logger
				.debug("Dispatching a WhiteboardParticipantChangeEvent event to "
