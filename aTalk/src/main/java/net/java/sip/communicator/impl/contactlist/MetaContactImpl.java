...
public class MetaContactImpl extends DataObject implements MetaContact
{
	...
	/**
	 * Returns the number of protocol specific <tt>Contact</tt>s that this <tt>MetaContact</tt>
	 * contains.
	 *
	 * @return an int indicating the number of protocol specific contacts merged in this
	 * <tt>MetaContact</tt>
	 */
	 ...
	 *
	 * @param provider
	 * 		a reference to the <tt>ProtocolProviderService</tt>
	 ...
	 * 		the address of the contact who we're looking for.
	 * @param ownerProvider
	 ...
	 * the specified address and originating from the specified ownerProvider or null if
	 ...
	 * 		the address of the contact who we're looking for.
	 * @param accountID
	 * 		the identifier of the provider that the contact we're looking for must belong to.
	 ...
	 * 		the <tt>Contact</tt> we're looking for
	 ...
	 *
	 * @return the default <tt>Contact</tt> to use when communicating with this
	 * <tt>MetaContact</tt>
	 */
	 ...
	 * <tt>MetaContact</tt> in
	 * that uniquely represents the containing <tt>MetaContactList</tt>
	 *
	 ...
	 * then display name equalities) be the fairly random meta contact metaUID.
	 * <p/>
	 *
	 * @param o
	 * 		the <code>MetaContact</code> to be compared.
	 * @return a negative integer, zero, or a positive integer as this object
	 * is less than, equal to, or greater than the specified object.
	 * @throws ClassCastException
	 * 		if the specified object is not a MetaContactListImpl
	 */
	 ...
	 *
	 * @param value
	 * 		control whether display name is user defined
	 */
	 ...
	 *
	 * @param contact
	 * 		the protocol <tt>Contact</tt> to query for its avatar
	 ...
	 *
	 * @param isLazy
	 * 		Indicates if this method should return the locally stored avatar or it should
	 ...
	 *
	 * @param displayName
	 * 		a human readable String representing this <tt>MetaContact</tt>
	 */
	 ...
	 *
	 * @param contact
	 * 		the protocol specific Contact to add.
	 */
	 ...
	 *
	 * @param provider
	 * 		the provider whose contacts we want removed.
	 ...
	 *
	 * @param parentGroup
	 * 		the <tt>MetaContactGroupImpl</tt> that is currently a parent of this meta contact.
	 * @throws NullPointerException
	 * 		if <tt>parentGroup</tt> is null.
	 */
	 ...
	 *
	 * @param parentGrp
	 * 		the <tt>MetaContactGroupImpl</tt> that we don't want considered as a parent of this
	 * 		contact any more.
	 */
	 ...
	 * @param value
	 * 		value of the detail to be removed.
	 */
	 ...
	 *
	 * @param name
	 * 		of the detail to be changed.
	 * @param oldValue
	 * 		the old value of the detail.
	 * @param newValue
	 ...
	 *
	 * @param name
	 * 		the name of the details we are searching for
	 ...
	 * a specific name of this
	 * <tt>MetaContact</tt> which has caused a property value change from a specific
	 * <tt>oldValue</tt> to a specific <tt>newValue</tt>.
	 *
	 * @param modificationName
	 * 		the name of the modification which has caused a new <tt>MetaContactModifiedEvent</tt>
	 * 		to be fired
	 * @param oldValue
	 * 		the value of the property before the modification
	 * @param newValue
	 * 		the value of the property after the modification
	 */
	 ...
	 *
	 * @param protoContact
	 * 		The contact in which we store the avatar.
	 * @param avatarBytes
	 ...
	 *
	 * @param contact
	 * 		the <tt>Contact</tt>, which capabilities have changed
	 * @param opSets
	 ...
	 *
	 * @param contact
	 * 		the <tt>Contact</tt>, which capabilities we remove
	 * @param opSets
	 * 		the new updated set of operation sets
	 */
	 ...
	 *
	 * @param contact
	 * 		the <tt>Contact</tt>, which capabilities we add
	 * @param opSets
	 * 		the map of operation sets supported by the contact
	 */
