...
/**
 * The <tt>PopupMessageNotificationHandler</tt> interface is meant to be implemented by the notification bundle in order
 * to provide handling of popup message actions.
 *
...
public interface PopupMessageNotificationHandler extends NotificationHandler
{
	 ...
	 * @param tag
	 *        additional info to be used by the notification handler
	 */
