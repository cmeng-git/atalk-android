 ...
 * <br/>
 *
 * Given array of <tt>long</tt> are the duration for which to turn on or off the vibrator in miliseconds. The first
 * value indicates the number of miliseconds to wait before turning the vibrator on. The next value indicates the number
 * of miliseconds for which to keep the vibrator on before turning it off and so on.<br/>
 * <br/>
 *
...
public class VibrateNotificationAction extends NotificationAction
{
	 ...
	 * @param milis
	 *        the number of miliseconds to vibrate.
	 */
	 ...
	 * @param patter
	 *        the array containing vibrate pattern intervals.
	 * @param repeat
	 *        the index into the patter at which it will be looped (-1 to disable repeat).
	 *
