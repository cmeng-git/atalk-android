 ...
 * <p>
 * WhiteboardObjectJabberImpl are created through the <tt>WhiteboardSession</tt> session.
 * <p>
 *
...
public abstract class WhiteboardObjectJabberImpl implements WhiteboardObject
{
	...
	/**
	 * An integer indicating the thickness (represented as number of pixels) of this whiteboard
	 * object (or its border).
	 */
	 ...
	 *        A String that uniquely identifies this WhiteboardObject.
	 * @param thickness
	 *        An integer indicating the thickness (number of pixels).
	 * @param color
	 *        The RGB value of the color of this object.
	 */
