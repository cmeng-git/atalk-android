...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>ProtocolMediaActivator</tt> class and its instances for
	 * logging output.
	 */
	private static final Logger logger = Logger.getLogger(ProtocolMediaActivator.class);
