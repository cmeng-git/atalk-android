...
public class ComponentVersionsExtension extends AbstractPacketExtension
{
	 ...
	 *
	 * @param componentName
	 *        the name of the component for which child {@link Component} extension will be added.
	 * @param versionStr
	 *        human readable string that describes component's version.
	 */
	...
	public class Component extends AbstractPacketExtension
	{
		 ...
		 * 
		 * @param name
		 *        a <tt>String</tt> which describes the name of video conferencing system component.
		 */
