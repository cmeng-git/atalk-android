...
public abstract class CallPeerSecurityStatusEvent extends EventObject
{
    ...
    /**
     * Session type of the event {@link #AUDIO_SESSION} or {@link #VIDEO_SESSION}.
     */
     ...
     * @param sessionType either <code>AUDIO_SESSION</code> or <code>VIDEO_SESSION</code> to indicate the type
     * of the session
     */
