 ...
 * <p>
 * WhiteboardObjectRectJabberImpl are created through the <tt>WhiteboardSession</tt> session.
 * <p>
 *
 ...
 */
public class WhiteboardObjectRectJabberImpl extends WhiteboardObjectJabberImpl implements
	WhiteboardObjectRect
{
	 ...
	 * @param color
	 *        WhiteboardObjectRectJabberImpl's color (or rather it's border)
	 * @param backColor
	 *        background color of this WhiteboardObjectRectJabberImpl
	 ...
	 *        True is filled, false is unfilled
	 */
	public WhiteboardObjectRectJabberImpl(String id, int thickness, int color, int backColor,
		WhiteboardPoint whiteboardPoint, double width, double height, boolean fill)
	{
	 ...
	 *
	 * @param xml
	 *        the XML string object to parse.
	 */
	...
	/**
	 * Sets the fill state of the WhiteboardShapeRect. True is filled, false is unfilled.
	 *
	 * @param fill
	 *        The new fill state.
	 */
	 ...
	 * @todo Implement this org.jivesoftware.smack.packet.ExtensionElement method
	 */
	@Override
	public String toXML()
	{
