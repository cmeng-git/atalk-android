 ...
 * state, the call would enter the CALL_IN_PROGRESS state. When the last call peer enters a
 * DISCONNECTED state the call itself would go into the CALL_ENDED state and will be ready for
 * garbage collection.
 *
 * @author Emil Ivov
 */
public class CallState
{
	...
	/**
	 * This constant value indicates that the associated call is currently in an initialization
	 * state.
	 */
	...
	/**
	 * A string representation of this Call State. Could be _CALL_INITIALIZATION, _CALL_IN_PROGRESS,
	 * _CALL_ENDED.
	 */
	 ...
	 * following format: "CallState:<STATE_STRING>" and are meant to be used for logging/debugging
	 * purposes.
	 *
