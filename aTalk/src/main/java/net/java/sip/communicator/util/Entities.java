...
class Entities
{
    ...
    static class IntHashMap
    {
         ...
         * This operation is more expensive than the <code>containsKey</code> method.</p>
         *
         ...
         * hashtable, in order to accommodate and access its entries more efficiently.</p>
         *
         * <p>This method is called automatically when the number of keys
         * in the hashtable exceeds this hashtable's capacity and load factor.</p>
         */
