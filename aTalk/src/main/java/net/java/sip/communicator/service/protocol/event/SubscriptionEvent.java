...
public class SubscriptionEvent extends EventObject
{
	 ...
	 */
	public SubscriptionEvent(Contact source, ProtocolProviderService provider,
		ContactGroup parentGroup, int eventID)
	{
	 ...
	 */
	public SubscriptionEvent(Contact source, ProtocolProviderService provider,
		ContactGroup parentGroup, int eventID, int errorCode, String errorReason)
	{
		super(source);
