 ...
 * processing a geolocation event implements this interface, and the object created with that class
 * is registered with the geolocation operation set, using its <code>addGeolocationListener</code>
