...
/**
 * <tt>ChatRoomInvitationReceivedEvent</tt>s indicate reception of an invitation to join a chat
 * room.
 *
 * @author Emil Ivov
...
public class ChatRoomInvitationReceivedEvent extends EventObject
{
	 ...
	 *        the <tt>OperationSetMultiUserChat</tt>, which dispatches this event
	 * @param invitation
	 *        the <tt>ChatRoomInvitation</tt> that this event is for
	 * @param timestamp
