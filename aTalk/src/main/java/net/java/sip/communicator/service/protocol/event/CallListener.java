...
/**
 * Instances of this class are used for listening for notifications coming out of a telephony
 * Provider - such as an incoming Call for example. Whenever a telephony Provider receives an
 * invitation to a call from a particular
 *
 * @author Emil Ivov
 */
public interface CallListener extends EventListener
{
	 ...
	 *
	 * @param event
	 *        a CallEvent instance describing the new incoming call
	 */
	 ...
	 *
	 * @param event
	 *        a CalldEvent instance describing the new incoming call.
	 */
	public void outgoingCallCreated(CallEvent event);

	/**
	 * Indicates that all peers have left the source call and that it has been ended. The event may
