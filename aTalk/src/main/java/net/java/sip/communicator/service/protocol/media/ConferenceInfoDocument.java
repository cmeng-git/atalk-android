...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>ConferenceInfoDocument</tt> class and its instances for
	 * logging output.
	 */
	 ...
	 *
	 * @throws XMLException
	 *         if a document failed to be created.
	 */
	 ...
	 * 
	 * @param version
	 *        the value to set the <tt>version</tt> attribute of the <tt>conference-info</tt>
	 *        element to.
	 */
	 ...
	 * 
	 * @param state
	 *        the value to set the <tt>state</tt> attribute of the <tt>conference-info</tt> element
	 *        to.
	 */
	 ...
	 *
	 * @param sid
	 *        the value to set the <tt>sid</tt> attribute of the <tt>conference-info</tt> element
	 *        to.
	 */
	 ...
	 * 
	 * @param entity
	 *        the value to set the <tt>entity</tt> attribute of the <tt>conference-info</tt>
	 *        document to.
	 */
	 ...
	 * 
	 * @param entity
	 *        The value of the <tt>entity</tt> attribute to search for.
	 ...
	 * 
	 * @param entity
	 *        The value to use for the <tt>entity</tt> attribute of the new <tt>User</tt>.
	 ...
	 * 
	 * @param entity
	 *        the entity of the <tt>User</tt> to remove.
	 */
	 ...
	 * 
	 * @param element
	 *        The <tt>Element</tt> for which to set the "state" attribute of.
	 * @param state
	 *        the <tt>State</tt> which to set.
	 */
	 ...
	 * 
	 * @param element
	 *        the <tt>Element</tt> for which to set the <tt>status</tt> child element.
	 * @param statusString
	 *        the <tt>String</tt> to use for the text content of the <tt>status</tt> element
	 */
	...
	public class User
	{
		 ...
		 * 
		 * @param entity
		 *        the value to set for the <tt>entity</tt> attribute.
		 */
		public void setEntity(String entity)
		{
			if (entity == null || entity.equals(""))
		 ...
		 * 
		 * @param state
		 *        the value to use for the <tt>state</tt> attribute.
		 */
		public void setState(State state)
		{
		 ...
		 * 
		 * @param text
		 *        the text content to use for the <tt>display-text</tt> element.
		 */
		 ...
		 * 
		 * @param entity
		 *        The value to use for the <tt>entity</tt> attribute of the new <tt>Endpoint</tt>.
		 ...
		 * 
		 * @param endpoint
		 *        the <tt>Endpoint</tt> to add a copy of
		 */
		 ...
		 * 
		 * @param entity
		 *        the <tt>entity</tt> of the <tt>Endpoint</tt> to remove
		 */
	...
	public class Endpoint
	{
		 ...
		 * 
		 * @param status
		 *        the value to be used for the text content of the <tt>status</tt> element.
		 */
		 ...
		 * 
		 * @param id
		 *        The value of the <tt>id</tt> attribute to search for.
		 ...
		 * 
		 * @param id
		 *        The value to use for the <tt>id</tt> attribute of the new <tt>Media</tt>'s
		 *        element.
		 ...
		 * 
		 * @param media
		 *        the <tt>Media</tt> to add a copy of
		 */
		 ...
		 * 
		 * @param id
		 *        the <tt>id</tt> of the <tt>Media</tt> to remove.
		 */
	...
	public class Media
	{
		 ...
		 * 
		 * @param srcId
		 *        the value to be used for the text content of the <tt>src-id</tt> element.
		 */
		 ...
		 * 
		 * @param type
		 *        the value to be used for the text content of the <tt>type</tt> element.
		 */
	...
	public enum EndpointStatusType {
		 ...
		 *
		 * @param typeStr
		 *        the <tt>String</tt> that we'd like to parse.
		 * @return an EndPointType.
		 *
		 * @throws IllegalArgumentException
		 *         in case <tt>typeStr</tt> is not a valid <tt>EndPointType</tt>.
		 */
