...
public abstract class AbstractContact implements Contact
{
	...
	public boolean equals(Object obj)
	{
		if (obj == null)
			...
			if ((protocolProvider == null) ? (thisProtocolProvider == null)
	...
	/**
	 * Returns a collection of resources supported by this contact or null if it doesn't support
	 * resources.
	 * <p>
	 * This default implementation indicates no support for contact resources.
	 *
	 * @return a collection of resources supported by this contact or null if it doesn't support
	 * resources
	 */
	...
	/**
	 * Adds the given <tt>ContactResourceListener</tt> to listen for events related to contact
	 * resources changes.
	 *
	 * @param l
	 * 		the <tt>ContactResourceListener</tt> to add
	 */
	...
	/**
	 * Removes the given <tt>ContactResourceListener</tt> listening for events related to contact
	 * resources changes.
	 *
	 * @param l
	 * 		the <tt>ContactResourceListener</tt> to remove
	 */
