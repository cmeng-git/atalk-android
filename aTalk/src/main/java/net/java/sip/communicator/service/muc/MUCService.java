...
public abstract class MUCService
{
	 ...
	 */
	public static void setChatRoomAutoOpenOption(ProtocolProviderService pps, String chatRoomId,
			String value)
	{
		ConfigurationUtils.updateChatRoomProperty(pps, chatRoomId, AUTO_OPEN_CONFIG_KEY, value);
	}
	 ...
	 * 		the contacts invited when creating the chat room.
	 * @param reason
	 * 		the reason for the muc creation
	 * @param join
	 ...
	 * 		the chat room.
	 * @param create
	 * 		if <tt>true</tt> and the chat room wrapper is not found new
			...
			ProtocolProviderService protocolProvider)
	{
		...
		return (opSet instanceof OperationSetMultiUserChat)
				? (OperationSetMultiUserChat) opSet : null;
	}
	 ...
	 */
	public abstract void destroyChatRoom(ChatRoomWrapper chatRoomWrapper, String reason,
