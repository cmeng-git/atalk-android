...
public abstract class MUCService
{
     ...
     */
    public abstract void fireChatRoomListChangedEvent(ChatRoomWrapper chatRoomWrapper, int eventID);
     ...
     */
    public abstract void addChatRoomProviderWrapperListener(ChatRoomProviderWrapperListener listener);
