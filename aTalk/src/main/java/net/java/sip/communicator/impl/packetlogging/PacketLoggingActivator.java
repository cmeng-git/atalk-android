...
/**
 * Creates and registers Packet Logging service into OSGi. Also handles saving and retrieving
 * configuration options for the service and is used from the configuration form.
 *
