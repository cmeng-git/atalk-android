...
public class ContactResourceEvent extends EventObject
{
	...
	/**
	 * Indicates that the <tt>ContactResourceEvent</tt> instance was triggered by the add of a
	 * <tt>ContactResource</tt>.
	 */
	public static final int RESOURCE_ADDED = 0;

	/**
	 * Indicates that the <tt>ContactResourceEvent</tt> instance was triggered by the removal of a
	 * <tt>ContactResource</tt>.
	 */
	 ...
	 *
	 * @param source
	 *        the source where this event occurred
	 * @param contactResource
	 *        the <tt>ContactResource</tt> that is concerned by the change
	 * @param eventType
	 *        an integer representing the type of this event. One of the types defined in this
