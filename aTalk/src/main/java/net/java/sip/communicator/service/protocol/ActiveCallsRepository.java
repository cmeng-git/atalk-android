...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>ActiveCallsRepository</tt> class and its instances for
	 * logging output.
	 */
	 ...
	 *
	 * @param opSet
	 *        a reference to the <tt>AbstractOperationSetBasicTelephony</tt> extension that created
	 *        us.
	 */
	...
	public void callStateChanged(CallChangeEvent evt)
	{
		if (evt.getEventType().equals(CallChangeEvent.CALL_STATE_CHANGE)
			...
			if (logger.isTraceEnabled()) {
				logger.trace("Removing call " + sourceCall + " from the list of active calls"
