 ...
 *
 * @param <T>
 *        the implementation specific telephony operation set class like for example
 ...
 * @param <V>
 *        the <tt>MediaAwareCall</tt> implementation like <tt>CallSipImpl</tt> or
 *        <tt>CallJabberImpl</tt>.
 * @param <W>
 *        the <tt>MediaAwarePeerCall</tt> implementation like <tt>CallPeerSipImpl</tt> or
	...
	implements OperationSetVideoTelephony
{
	 ...
	 * telephony-related functionality of a specific <tt>OperationSetBasicTelephony</tt>
	 * implementation.
	 *
	 * @param basicTelephony
	 *        the <tt>OperationSetBasicTelephony</tt> the new extension should build upon
	 */
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> that we will be registering <tt>listener</tt> with.
	 * @param listener
	 *        the <tt>VideoListener</tt> that we'd like to register.
	 */
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> that we are sending our local video to.
	 * @return the <tt>Component</tt> containing the local video.
	 * @throws OperationFailedException
	 *         if we fail extracting the local video.
	 */
	@SuppressWarnings("unchecked")
	// work with MediaAware* in media package
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> whose video is to be retrieved
	...
	/**
	 * Gets the visual/video <tt>Component</tt>s available in this telephony for a specific
	 * <tt>CallPeer</tt>.
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> whose videos are to be retrieved
	 * @return the visual/video <tt>Component</tt>s available in this telephony for the specified
	 *         <tt>peer</tt>
	 */
	@SuppressWarnings("unchecked")
	// work with MediaAware* in media package
	 ...
	 *
	 * @param peer
	 *        the parent <tt>CallPeer</tt>
	 * @param visualComponent
	 *        the visual <tt>Component</tt>, which corresponding <tt>ConferenceMember</tt> we're
	 *        looking for
	 ...
	 *
	 * @param peer
	 *        the <tt>CallPeer</tt> that we'd like to unregister our <tt>VideoListener</tt> from.
	 * @param listener
	 *        the <tt>VideoListener</tt> that we'd like to unregister.
	 */
	@SuppressWarnings("unchecked")
	// work with MediaAware* in media package
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> whose video transmission we are interested in.
	 *
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> to start listening to the changes of the property values of
	 * @param listener
	 ...
	 *
	 * @param call
	 *        the <tt>Call</tt> to stop listening to the changes of the property values of
	 * @param listener
	 *        the <tt>PropertyChangeListener</tt> to no longer be notified when the properties
	...
	/**
	 * Returns the quality control for video calls if any. Return null so protocols who supports it
	 * to override it.
	 * 
	 * @param peer
	 ...
	 * @param qualityPreferences
	 *        the quality preset we will use establishing the video call, and we will expect from
	 ...
	 *         if <tt>callee</tt> is not a valid sip address string.
	 */
