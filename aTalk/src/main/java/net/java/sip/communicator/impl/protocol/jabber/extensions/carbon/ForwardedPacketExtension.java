...
public class ForwardedPacketExtension extends AbstractPacketExtension
{
	 ...
	 */
	public static class Provider extends ExtensionElementProvider<ForwardedPacketExtension>
	{
		/**
		 * Creates a <tt>ForwardedPacketExtension</tt> by parsing an XML document.
		 * 
		 * @param parser
		 *        the parser to use.
		 ...
		 */
		@Override
		public ForwardedPacketExtension parse(XmlPullParser parser, int depth)
				throws Exception
		{
