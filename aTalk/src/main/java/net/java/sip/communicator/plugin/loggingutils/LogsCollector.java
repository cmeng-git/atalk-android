...
public class LogsCollector
{
	 ...
	 *
	 * @param destination
	 * 		the possible destination archived file
	 * @param optional
	 * 		an optional file to be added to the archive.
	 ...
	 * @param files
	 * 		files to check.
	 * @param filterStartsWith
	 * 		a prefix for the files, can be null if no
