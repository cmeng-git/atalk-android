 ...
 * <p>
 * WhiteboardObjectPolygonJabberImpl are created through the <tt>WhiteboardSession</tt> session.
 * <p>
 *
 ...
 */
public class WhiteboardObjectPolygonJabberImpl extends WhiteboardObjectJabberImpl implements
	WhiteboardObjectPolygon
{
	 ...
	 */
	private List<WhiteboardPoint> listPoints = new LinkedList<WhiteboardPoint>();
	...
	/**
	 * Converts a String in a "1,3 4,5 5,5 6,6" format into List of <tt>WhiteboardPoint</tt>.
	 *
	 * @param points
	 *        the String to be converted to a List of <tt>WhiteboardPoint</tt>.
	...
	private List<WhiteboardPoint> getPolyPoints(String points)
	{
		...
		while (tokenizer.hasMoreTokens()) {
			...
			WhiteboardPoint p = new WhiteboardPoint(Double.parseDouble(coords[0]),
