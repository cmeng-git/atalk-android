...
public abstract class AbstractPacketExtension implements ExtensionElement {
	...
	/**
	 * Creates an {@link AbstractPacketExtension} instance for the specified <tt>namespace</tt> and
	 * <tt>elementName</tt> .
	 *
	 * @param namespace
	...
	/**
	 * Returns the XML namespace for this element or <tt>null</tt> if the element does not live in a
	 * namespace of its own.
	 *
	 * @return the XML namespace for this element or <tt>null</tt> if the element does not live in a
	 * namespace of its own.
	 */
	...
	/**
	 * Returns all sub-elements for this <tt>AbstractPacketExtension</tt> or <tt>null</tt> if there
	 * aren't any.
	 * <p>
	 ...
	 * @param value
	 * 		an {@link Object} whose <tt>toString()</tt> method returns the XML value of the
	 * 		attribute we are setting or <tt>null</tt> if we'd like to remove the attribute with
	 ...
	 * 		the name of the attribute that we'd like to retrieve
	 * @param defaultValue
	 * 		the <tt>int</tt> to be returned as the value of the specified attribute if no such
	 * 		attribute is currently registered with this extension
	...
	/**
	 * Returns the text content of this extension or <tt>null</tt> if no text content has been
	 * specified so far.
	 *
	 * @return the text content of this extension or <tt>null</tt> if no text content has been
	 * specified so far.
	 */
	 ...
	 *
	 * @param <T>
	 * 		the specific type of <tt>ExtensionElement</tt> to be returned
	 * @param type
	 ...
	 *
	 * @param <T>
	 * 		the specific <tt>ExtensionElement</tt> type of child extensions to be returned
	 * @param type
	 * 		the <tt>Class</tt> of the extension we are looking for.
	 ...
	 *
	 * @param src
	 * 		the <tt>AbstractPacketExtension</tt> to be cloned
	 ...
	 * @throws Exception
	 * 		if an error occurs during the cloning of the specified <tt>src</tt>
	 */
	@SuppressWarnings("unchecked")
