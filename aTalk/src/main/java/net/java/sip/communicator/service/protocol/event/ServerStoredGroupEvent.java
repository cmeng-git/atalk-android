...
public class ServerStoredGroupEvent extends EventObject
{
	 ...
	 */
	public ServerStoredGroupEvent(ContactGroup sourceGroup, int eventID, ContactGroup parentGroup,
		ProtocolProviderService sourceProvider, OperationSetPersistentPresence opSet)
	{
		super(sourceGroup);
	...
	{
		StringBuffer buff = new StringBuffer("ServerStoredGroupEvent:[EventID= ");
