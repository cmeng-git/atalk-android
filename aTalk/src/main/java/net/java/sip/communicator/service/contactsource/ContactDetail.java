...
public class ContactDetail
{
	...
	public enum Category
	{
		...
		/**
		 * The standard/well-known category of a <tt>ContactDetail</tt> representing an e-mail
		 * address.
		 */
		Email("Email"),

		/**
		 * The standard/well-known category of a <tt>ContactDetail</tt> representing a contact
		 * address for instant messaging.
		 */
		InstantMessaging("InstantMessaging"),

		/**
		 * The standard/well-known category of a <tt>ContactDetail</tt> representing a phone number.
		 */
		Phone("Phone"),

		/**
		 * The standard/well-known category of a <tt>ContactDetail</tt> representing a postal
		 * address.
		 */
		Address("Address");
	...
	public enum SubCategory
	{
		...
		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a last name.
		 */
		LastName("LastName"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a nickname.
		 */
		Nickname("Nickname"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a postal code.
		 */
		HomePage("HomePage"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing an address of a
		 * contact at their home.
		 */
		Home("Home"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a mobile
		...
		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a fax number.
		 */
		Fax("Fax"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a different
		 * number.
		 */
		Other("Other"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing an IM network
		...
		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a country name.
		 */
		Country("Country"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a state name.
		 */
		State("State"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a city name.
		 */
		City("City"),

		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a street address.
		 */
		Street("Street"),
		...
		/**
		 * The standard/well-known label of a <tt>ContactDetail</tt> representing a job title.
		 */
		JobTitle("JobTitle");
	 ...
	 * could be reached by one of the supported <tt>OperationSet</tt>s (e.g. by IM, call).
	 */
	...
	/**
	 * A mapping of <tt>OperationSet</tt> classes and preferred protocol providers for them.
	 */
	private Map<Class<? extends OperationSet>, ProtocolProviderService> preferredProviders;

	/**
	 * A mapping of <tt>OperationSet</tt> classes and preferred protocol name for them.
	 */
	...
	/**
	 * Creates a <tt>ContactDetail</tt> by specifying the contact address, corresponding to this
	 * detail.
	 *
	 * @param contactDetailValue
	 * 		the contact detail value corresponding to this detail
	 */
	...
	/**
	 * Initializes a new <tt>ContactDetail</tt> instance which is to represent a specific contact
	 * address and which is to be optionally labeled with a specific set of labels.
	 *
	 * @param contactDetailValue
	 * 		the contact detail value to be represented by the new <tt>ContactDetail</tt> instance
	 * @param category
	 */
	public ContactDetail(String contactDetailValue,
			Category category)
	 ...
	 * @param category
	 * @param subCategories
	 * 		the set of sub categories with which the new <tt>ContactDetail</tt> instance is to be
	 * 		labeled.
	 */
	public ContactDetail(String contactDetailValue,
			Category category,
	...
	/**
	 * Sets a mapping of preferred <tt>ProtocolProviderServices</tt> for a specific
	 * <tt>OperationSet</tt>.
	 *
	 * @param preferredProviders
	 * 		a mapping of preferred <tt>ProtocolProviderService</tt>s for specific
	 ...
	 * 		<tt>ProtocolProviderService</tt>s for specific <tt>OperationSet</tt> classes
	 */
	 ...
	 * making a call, etc.)
	 *
	 * @param supportedOpSets
	 * 		a list of all <tt>supportedOpSets</tt>, indicating what are the supporting actions
	 ...
	 *
	 * @param supportedOpSet
	 * 		the OpSet to support.
	 */
