...
public class ContactDetail
{
     ...
     *
     * @param contactDetailValue the contact detail value to be represented by the new <tt>ContactDetail</tt> instance
     * @param category
     */
    public ContactDetail(String contactDetailValue,
            Category category)
     ...
     * @param contactDetailValue the contact detail value to be represented by the new <tt>ContactDetail</tt> instance
     * @param category
     * @param subCategories the set of sub categories with which the new <tt>ContactDetail</tt> instance is to be
     * labeled.
     */
    public ContactDetail(String contactDetailValue,
            Category category,
     ...
     * <tt>OperationSet</tt>.
     *
     * @param preferredProviders a mapping of preferred <tt>ProtocolProviderService</tt>s for specific
     ...
     * making a call, etc.)
     *
     * @param supportedOpSets a list of all <tt>supportedOpSets</tt>, indicating what are the supporting actions
