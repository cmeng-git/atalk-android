 ...
 */
public class CryptoExtensionElement extends AbstractExtensionElement
{
    /**
    ...
    /**
     * Creates a new {@link CryptoExtensionElement} instance with the proper element name and
     * namespace.
     */
    ...
    /**
     * Creates a new {@link CryptoExtensionElement} instance with the proper element name and
     * namespace and initialises it with the parameters contained by the cryptoAttribute.
     *
     * @param cryptoAttribute The cryptoAttribute containing the crypto-suite, key-params, session-params and key
     * information.
     */
    public CryptoExtensionElement(SrtpCryptoAttribute cryptoAttribute)
    {
        this();
    ...
    public boolean equalsCryptoSuite(String cryptoSuite)
    {
        ...
        return CryptoExtensionElement.equalsStrings(currentCryptoSuite, cryptoSuite);
    }
     ...
     *
     * @return a <tt>String</tt> that provides one or more sets of keying material for the
     * crypto-suite in question).
     */
    ...
    public boolean equalsKeyParams(String keyParams)
    {
        ...
        return CryptoExtensionElement.equalsStrings(currentKeyParams, keyParams);
    }
     ...
     *
     * @param sessionParams a <tt>String</tt> that provides transport-specific parameters for SRTP negotiation.
     * @return True if the current session params equals the one given in parameter. False,
     * otherwise.
     */
    public boolean equalsSessionParams(String sessionParams)
    {
        String currentSessionParams = this.getSessionParams();
        return CryptoExtensionElement.equalsStrings(currentSessionParams, sessionParams);
    }
     ...
     *
     * @return a <tt>String</tt> containing a decimal number used as an identifier for a particular
     * crypto element.
     */
    ...
    public boolean equalsTag(String tag)
    {
        ...
        return CryptoExtensionElement.equalsStrings(currentTag, tag);
    }
     ...
     * @return True if both strings are null, or if they represent the same sequane of characters.
     * False, otherwise.
     */
     ...
     * (crypto-suite, key-params, session-params and tag) corresponding to the current one.
     * False, otherwsise.
     */
    @Override
    public boolean equals(Object obj)
    {
        if (obj instanceof CryptoExtensionElement) {
            CryptoExtensionElement crypto = (CryptoExtensionElement) obj;
