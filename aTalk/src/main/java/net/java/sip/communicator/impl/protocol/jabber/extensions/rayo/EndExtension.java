...
public class EndExtension extends AbstractPacketExtension
{
	 ...
	 * 
	 * @param newReason
	 *        the new {@link ReasonExtension} to set.
	 */
	 ...
	 * 
	 * @param from
	 *        source JID of this event.
	 * @param to
	 *        destination JID.
	 * @param reason
	 *        call end reason string. One of {@link ReasonExtension} static constants.
