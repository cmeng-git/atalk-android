		...
		ChatRoomProviderWrapperListener
{
	...
	{
		super(contactSource, Pattern.compile(queryString,
				Pattern.CASE_INSENSITIVE | Pattern.LITERAL), true);
	 ...
	 * 		indicates whether we should add the chat room to the query results or fire an event
	 ...
	 *
	 * @param evt
	 * 		the <tt>LocalUserChatRoomPresenceChangeEvent</tt> instance containing the chat room
	...
	public void localUserPresenceChanged(LocalUserChatRoomPresenceChangeEvent evt)
	{
		...
		if (LocalUserChatRoomPresenceChangeEvent.LOCAL_USER_JOINED.equals(eventType)) {
			if (existingContact) {
				...
				ChatRoomWrapper chatRoom = MUCActivator.getMUCService()
	...
	{
		if ((queryString == null)
				|| ((chatRoomName.contains(queryString)
