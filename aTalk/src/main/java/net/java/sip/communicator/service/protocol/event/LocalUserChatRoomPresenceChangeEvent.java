 ...
 * occured. Changes may include us being kicked, join, left, etc.
 *
 * @author Emil Ivov
...
public class LocalUserChatRoomPresenceChangeEvent extends EventObject
{
	...
	/**
	 * Indicates that this event was triggered as a result of the local participant joining a chat
	 * room.
	 */
	...
	/**
	 * Indicates that this event was triggered as a result of the local participant leaving a chat
	 * room.
	 */
	 ...
	 * participant presence in the source chat room has occured.
	 *
	 * @param source
	 *        the <tt>OperationSetMultiUserChat</tt>, which produced this event
	 * @param chatRoom
	 *        the <tt>ChatRoom</tt> that this event is about
	 * @param eventType
	 *        the type of this event.
	 * @param reason
	...
	{
		return "ChatRoomLocalUserPresenceChangeEvent[type=" + getEventType() + " sourceRoom="
			+ getChatRoom() + "]";
	}
}
