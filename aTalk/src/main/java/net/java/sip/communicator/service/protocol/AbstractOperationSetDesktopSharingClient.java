	...
	implements OperationSetDesktopSharingClient
{
	 ...
	 *        the <tt>ProtocolProviderService</tt> implementation which is creating the new instance
	 ...
	 *
	 * @param listener
	 *        the <tt>RemoteControlListener</tt> to add
	 */
	...
	/**
	 * Gets a list of <tt>RemoteControlListener</tt>s to be notified of remote control access
	 * changes.
	 *
	 * @return a list of <tt>RemoteControlListener</tt>s to be notifed of remote control access
	 *         changes
	 */
	 ...
	 *
	 * @param revokedPeerID
	 *        The ID of the revoked peer. May be null to only clear null instances from the granted
	 *        control peer list.
	 *
	 ...
	 *
	 * @param callPeer
	 *        the <tt>CallPeer</tt> to get the corresponding <tt>RemoteControlListener</tt> of
