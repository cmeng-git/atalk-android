...
public class ReasonPacketExtension implements ExtensionElement
{
	...
	/**
	 * The content of the text element (if any) providing human-readable information about the
	...
	/**
	 * Creates a new <tt>ReasonPacketExtension</tt> instance with the specified reason String.
	 *
	 * @param reason
	 *        the reason string that we'd like to transport in this packet extension, which may or
	 *        may not be one of the static strings defined here.
	 * @param text
	 *        an element providing human-readable information about the reason for the action or
	 *        <tt>null</tt> if no such information is currently available.
	 * @param packetExtension
	 *        any other element that MAY be providing further information or <tt>null</tt> if no
	 *        such element has been specified.
	 */
	public ReasonPacketExtension(Reason reason, String text, ExtensionElement packetExtension)
	{
		this.reason = reason;
		this.text = text;
	 ...
	 *
	 * @param text
	 *        the human-readable information about the reason for the action or <tt>null</tt> if no
	 *        such information is currently available
	 */
	 ...
	 *        the extra extension containing further info about this action or <tt>null</tt> if no
	 *        such extension has been specified
	 */
