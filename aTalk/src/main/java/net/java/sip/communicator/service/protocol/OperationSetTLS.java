...
/**
 * An <tt>OperationSet</tt> that allows access to information about TLS used by the protocol
 * provider.
 *
 * @author Markus Kilas
 */
public interface OperationSetTLS extends OperationSet
{
	 ...
	 *
	 * @return The cipher suite name used for instance "TLS_RSA_WITH_AES_256_CBC_SHA" or null if TLS
	 *         is not used.
	 */
