...
{
	/**
	 * The <tt>BundleContext</tt> in which the configuration bundle has been started and has not
	 * been stopped yet.
	 */
	 ...
	 *
	 * @param bundleContext
	 * 		the <tt>BundleContext</tt> as provided by the OSGi framework.
	 * @throws Exception
	 ...
	 * 		<tt>BundleContext</tt>
	 * @throws Exception
	 * 		if anything goes wrong while storing the properties managed by the
