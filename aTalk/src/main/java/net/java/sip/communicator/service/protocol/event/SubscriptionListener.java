...
public interface SubscriptionListener extends EventListener
{
	 ...
	 * 
	 * @param evt
	 *        the SubscriptionEvent containing the corresponding contact
	 */
	 ...
	 *
	 * @param evt
	 *        a reference to the SubscriptionMovedEvent containing previous and new parents as well
	 ...
	 * 
	 * @param evt
	 *        the <tt>ContactPropertyChangeEvent</tt> containing the source contact and the old and
