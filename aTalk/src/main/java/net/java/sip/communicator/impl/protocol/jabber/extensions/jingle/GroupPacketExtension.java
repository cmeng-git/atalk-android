...
public class GroupPacketExtension extends AbstractPacketExtension
{
	...
	/**
	 * Creates new <tt>GroupPacketExtension</tt> for BUNDLE semantics initialized with given
	 * <tt>contents</tt> list.
	 *
	 * @param contents
	 * 		the list that contains the contents to be bundled.
	 * @return new <tt>GroupPacketExtension</tt> for BUNDLE semantics initialized with given
	 * <tt>contents</tt> list.
	 */
