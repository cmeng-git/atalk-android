...
public class DefaultLanguagePackImpl implements LanguagePack
{
	 ...
	 *
	 * @param locale
	 *        The <tt>Locale</tt> we're looking for.
	 ...
	 * 
	 * @param locale
	 *        the locale for which the keys are requested
	...
	/**
	 * Fills the given resource map with all (key,value) pairs obtained from the given <tt>ResourceBundle</tt>. This method will look in the
	 * properties files for references to other properties files and will include in the final map data from all referenced files.
	 *
	 * @param resourceBundle
	 *        The initial <tt>ResourceBundle</tt>, corresponding to the "main" properties file.
	 * @param resources
	 *        A <tt>Map</tt> that would store the data.
	 */
