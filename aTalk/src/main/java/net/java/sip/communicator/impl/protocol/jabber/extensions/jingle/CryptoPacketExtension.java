...
public class CryptoPacketExtension extends AbstractPacketExtension
{
	...
	/**
	 * Creates a new {@link CryptoPacketExtension} instance with the proper element name and
	 * namespace.
	 */
	 ...
	 *        The cryptoAttribute containing the crypto-suite, key-params, session-params and key
	 *        information.
	 */
	 ...
	 *
	 * @param cryptoSuite
	 *        a <tt>String</tt> that describes the encryption and authentication algorithms.
	 */
	 ...
	 *
	 * @param keyParams
	 *        a <tt>String</tt> that provides one or more sets of keying material for the
	 ...
	 *
	 * @param sessionParams
	 *        a <tt>String</tt> that provides transport-specific parameters for SRTP negotiation.
	 */
	 ...
	 *
	 * @param tag
	 *        a <tt>String</tt> containing a decimal number used as an identifier for a particular
	 *        crypto element.
	 */
