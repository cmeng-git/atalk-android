...
/**
 * The <code>ChatRoomMemberPropertyChangeListener</code> receives events notifying interested parties
 ...
 */
public interface ChatRoomMemberPropertyChangeListener extends EventListener
{
    /**
     * Called to indicate that a chat room member property has been modified.
     *
     * @param event the <code>ChatRoomMemberPropertyChangeEvent</code> containing the name of
