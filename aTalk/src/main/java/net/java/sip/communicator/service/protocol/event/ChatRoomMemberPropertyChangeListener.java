...
/**
 * The <tt>ChatRoomMemberPropertyChangeListener</tt> receives events notifying interested parties
...
public interface ChatRoomMemberPropertyChangeListener extends EventListener
{
	 ...
	 *
	 * @param event
	 *        the <tt>ChatRoomMemberPropertyChangeEvent</tt> containing the name of the property
