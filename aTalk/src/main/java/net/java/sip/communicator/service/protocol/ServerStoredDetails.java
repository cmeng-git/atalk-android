...
public class ServerStoredDetails
{
    ...
    public static class GenericDetail
    {
         ...
         *
         * @param detailDisplayName a display name that may be used as a description when visualizing the value of the
         * detail
        ...
        public boolean equals(Object obj)
        {
            ...
            if (this.value != null && other.getDetailValue() != null) {
                if (this.value instanceof Calendar) {
                    boolean yearEquals = ((Calendar) this.value).get(Calendar.YEAR)
                            == ((Calendar) other.value).get(Calendar.YEAR);
                    boolean monthEquals = ((Calendar) this.value).get(Calendar.MONTH)
