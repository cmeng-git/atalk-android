...
{
	/**
	 * A generic detail used as the root of all other server stored details. This class should be
	 * extended or instantiated by implementors with the purpose of representing details not defined
	 * here.
	 */
	public static class GenericDetail
	{
		 ...
		 *        a display name that may be used as a description when visualizing the value of the
		 *        detail
		 * @param value
		 ...
		 *
		 * @param obj
		 *        Object expected GenericDetail otherwise return false
	...
	public static class URLDetail extends GenericDetail
	{
		 ...
		 *
		 * @param obj
		 *        Object expected URLDetail otherwise return false
		...
		public boolean equals(Object obj)
		{
			...
			boolean equalsDisplayName = (this.detailDisplayName != null)
					&& (other.getDetailDisplayName() != null)
					&& this.detailDisplayName.equals(other.getDetailDisplayName());
			boolean equalValues = (this.value != null)
	...
	public static class BinaryDetail extends GenericDetail
	{
		 ...
		 *
		 * @param obj
		 *        Object expected BinaryDetail otherwise return false
		 * @return <tt>true</tt> if this object has the same display name and value as <tt>obj</tt>
		 *         and false otherwise
		 */
		@Override
		public boolean equals(Object obj)
		{
			...
			boolean equalsDisplayName = (this.detailDisplayName != null)
					&& (other.getDetailDisplayName() != null)
					&& this.detailDisplayName.equals(other.getDetailDisplayName());
			boolean equalsNotNull = (this.value != null)
					&& (other.getDetailValue() != null)
					&& Arrays.equals(this.getBytes(), other.getBytes());
			boolean nullOrEmpty = (this.value == null || this.getBytes().length == 0)
					&& (other.getDetailValue() == null || other.getBytes().length == 0);
	...
	public static class BirthDateDetail extends CalendarDetail
	{
		 ...
		 *
		 * @param obj
		 *        Object expected BirthDateDetail otherwise return false
		 * @return <tt>true</tt> if this object has the same value as <tt>obj</tt> and false
		 *         otherwise
		 */
		@Override
		public boolean equals(Object obj)
		{
			...
			if (this.value != null && other.getDetailValue() != null) {
				boolean yearEquals = ((Calendar) this.value).get(Calendar.YEAR) == ((Calendar) other.value)
					.get(Calendar.YEAR);
				boolean monthEquals = ((Calendar) this.value).get(Calendar.MONTH) == ((Calendar) other.value)
					.get(Calendar.MONTH);
				boolean dayEquals = ((Calendar) this.value).get(Calendar.DAY_OF_MONTH) == ((Calendar) other.value)
