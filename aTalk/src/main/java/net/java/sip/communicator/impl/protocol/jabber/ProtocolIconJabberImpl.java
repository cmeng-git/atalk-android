...
{
	/**
	 * The <tt>Logger</tt> used by the <tt>ProtocolIconJabberImpl</tt> class and its instances for
	 * logging output.
	 */
	 ...
	 */
	private final Hashtable<String, byte[]> iconsTable = new Hashtable<String, byte[]>();

	/**
	 * A hash table containing the path to the protocol icon in different sizes.
	 */
	private final Hashtable<String, String> iconPathsTable = new Hashtable<String, String>();

	/**
	 * Creates an instance of this class by passing to it the path, where all protocol icons are
	 * placed.
	 *
	 * @param iconPath
	...
	public ProtocolIconJabberImpl(String iconPath)
	{
		...
		iconsTable
			.put(ProtocolIcon.ICON_SIZE_16x16, loadIcon(iconPath + "/status16x16-online.png"));
	 ...
	 * 
	 * @param iconSize
	 *        the icon size; one of ICON_SIZE_XXX constants
	 */
