...
/**
 * The <tt>RedirectProvider</tt> parses "redirect" elements into {@link RedirectPacketExtension}
 * instances.
 *
 * @author Sebastien Vincent
 * @author Eng Chong Meng
 */
public class RedirectProvider extends DefaultPacketExtensionProvider<RedirectPacketExtension>
{
	public RedirectProvider(Class RedirectProvider)
	{
		super(RedirectProvider);
	}
	 ...
	 *
	 * @param parser
	 *        an XML parser positioned at the opening <tt>redirect</tt> element.
	 *
