...
#include "org_atalk_sctp4j_Sctp.h"
...
#define SCTP_CLASSNAME "org/atalk/sctp4j/Sctp"
...
/*
 * Class:     org_atalk_sctp4j_Sctp
 * Method:    on_network_in
 * Signature: (J[BII)V
 */
JNIEXPORT void JNICALL
Java_org_atalk_sctp4j_Sctp_on_1network_1in
...
Java_org_atalk_sctp4j_Sctp_usrsctp_1accept
 ...
 */
JNIEXPORT void JNICALL
Java_org_atalk_sctp4j_Sctp_usrsctp_1close
    (JNIEnv *env, jclass clazz, jlong ptr)
{
    SctpSocket *sctpSocket;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_org_atalk_sctp4j_Sctp_usrsctp_1connect
 ...
 */
JNIEXPORT jboolean JNICALL
Java_org_atalk_sctp4j_Sctp_usrsctp_1finish
 ...
 */
JNIEXPORT jboolean JNICALL
Java_org_atalk_sctp4j_Sctp_usrsctp_1init
    (JNIEnv *env, jclass clazz, jint port)
{
     ...
     * AF_CONN use of SCTP.
     */
    debugSctpPrintf("=====>: org_atalk_sctp4j_Sctp.c calling init\n");
    usrsctp_init((uint16_t) port, onSctpOutboundPacket, debugSctpPrintf);

    debugSctpPrintf("=====>: org_atalk_sctp4j_Sctp.c about to set SCTP_DEBUG_ALL\n");
#ifdef SCTP_DEBUG
    debugSctpPrintf("=====>: org_atalk_sctp4j_Sctp.c setting SCTP_DEBUG_ALL\n");
 ...
 */
JNIEXPORT void JNICALL
Java_org_atalk_sctp4j_Sctp_usrsctp_1listen
    (JNIEnv *env, jclass clazz, jlong ptr)
{
    SctpSocket *sctpSocket;
...
Java_org_atalk_sctp4j_Sctp_usrsctp_1send
...
Java_org_atalk_sctp4j_Sctp_usrsctp_1socket
