...
#include <jni.h>
/* Header for class org_atalk_impl_neomedia_codec_FFmpeg */

#ifndef _Included_org_atalk_impl_neomedia_codec_FFmpeg
#define _Included_org_atalk_impl_neomedia_codec_FFmpeg
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_atalk_impl_neomedia_codec_FFmpeg_avfilter_1unref_1buffer
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_org_atalk_impl_neomedia_codec_FFmpeg_avpicture_1get_1data0
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (III)I
 */
JNIEXPORT jint JNICALL Java_org_atalk_impl_neomedia_codec_FFmpeg_avpicture_1get_1size
