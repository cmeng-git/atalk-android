...
sh ./build-openssl4android.sh android-mips  #for mips
sh ./build-openssl4android.sh android64-mips64 #for mips64
```
...
sh ./build-curl4android.sh android-mips  #for mips
sh ./build-curl4android.sh android64-mips64 #for mips64
```
