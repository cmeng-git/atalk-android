...
#include "org_atalk_impl_neomedia_codec_audio_opus_Opus.h"

#include <stdint.h>
#include <opus.h>

JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_decode
...
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_decoder_1create
...
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_decoder_1destroy
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_decoder_1get_1nb_1samples
    (JNIEnv *env, jclass clazz, jlong decoder, jbyteArray packet, jint offset, jint length)
{
    int ret;
    if (packet) {
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_decoder_1get_1size
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encode
...
JNIEXPORT jlong JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1create
    (JNIEnv *env, jclass clazz, jint Fs, jint channels)
{
    int error;
...
JNIEXPORT void JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1destroy
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1bandwidth
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1bitrate
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
    int ret = opus_encoder_ctl(
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1complexity
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
    int ret
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1dtx
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1inband_1fec
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
    int ret
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1size
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1vbr
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1get_1vbr_1constraint
    (JNIEnv *env, jclass clazz, jlong encoder)
{
    opus_int32 x;
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1bandwidth
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1bitrate
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1complexity
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1dtx
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1force_1channels
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1inband_1fec
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1max_1bandwidth
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1packet_1loss_1perc
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1vbr
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_encoder_1set_1vbr_1constraint
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_packet_1get_1bandwidth
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_packet_1get_1nb_1channels
    (JNIEnv *env, jclass clazz, jbyteArray data, jint offset)
{
    int ret;
    ...
    if (data) {
        ...
        if (data_) {
            ret = opus_packet_get_nb_channels((unsigned char *) (data_ + offset));
            (*env)->ReleasePrimitiveArrayCritical(env, data, data_, JNI_ABORT);
        }
        else
            ret = OPUS_ALLOC_FAIL;
...
JNIEXPORT jint JNICALL
Java_org_atalk_impl_neomedia_codec_audio_opus_Opus_packet_1get_1nb_1frames
